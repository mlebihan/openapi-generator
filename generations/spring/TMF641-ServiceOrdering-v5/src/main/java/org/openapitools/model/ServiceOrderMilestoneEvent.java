...
import org.openapitools.model.ServiceOrderMilestoneEventPayload;
...
public class ServiceOrderMilestoneEvent {
  ...
  private @Nullable ServiceOrderMilestoneEventPayload event;

  public ServiceOrderMilestoneEvent() {
    super();
  }
   ...
   */
  public ServiceOrderMilestoneEvent(String atType) {
    this.atType = atType;
  }

  public ServiceOrderMilestoneEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceOrderMilestoneEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceOrderMilestoneEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceOrderMilestoneEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceOrderMilestoneEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ServiceOrderMilestoneEvent correlationId(@Nullable String correlationId) {
  ...
  public ServiceOrderMilestoneEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ServiceOrderMilestoneEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ServiceOrderMilestoneEvent description(@Nullable String description) {
  ...
  public ServiceOrderMilestoneEvent priority(@Nullable String priority) {
  ...
  public ServiceOrderMilestoneEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ServiceOrderMilestoneEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ServiceOrderMilestoneEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ServiceOrderMilestoneEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ServiceOrderMilestoneEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ServiceOrderMilestoneEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ServiceOrderMilestoneEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ServiceOrderMilestoneEvent eventId(@Nullable String eventId) {
  ...
  public ServiceOrderMilestoneEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ServiceOrderMilestoneEvent eventType(@Nullable String eventType) {
  ...
  public ServiceOrderMilestoneEvent event(@Nullable ServiceOrderMilestoneEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ServiceOrderMilestoneEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ServiceOrderMilestoneEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, serviceOrderMilestoneEvent.atType) &&
        Objects.equals(this.atBaseType, serviceOrderMilestoneEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceOrderMilestoneEvent.atSchemaLocation) &&
        Objects.equals(this.href, serviceOrderMilestoneEvent.href) &&
        Objects.equals(this.id, serviceOrderMilestoneEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, serviceOrderMilestoneEvent.timeOccurred) &&
        Objects.equals(this.source, serviceOrderMilestoneEvent.source) &&
        Objects.equals(this.reportingSystem, serviceOrderMilestoneEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, serviceOrderMilestoneEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, serviceOrderMilestoneEvent.analyticCharacteristic) &&
        ...
        Objects.equals(this.event, serviceOrderMilestoneEvent.event);
  }
