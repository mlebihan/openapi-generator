...
import org.openapitools.model.EntityRelationshipFVO;
...
public class IntentFVO implements IntentRefOrValueFVO {
  ...
  @Valid
  private List<@Valid EntityRelationshipFVO> intentRelationship = new ArrayList<>();
   ...
   */
  public IntentFVO(String atType, String name, IntentExpression expression) {
    this.atType = atType;
    this.name = name;
  ...
  public IntentFVO intentRelationship(List<@Valid EntityRelationshipFVO> intentRelationship) {
  ...
  public List<@Valid EntityRelationshipFVO> getIntentRelationship() {
    return intentRelationship;
  }

  public void setIntentRelationship(List<@Valid EntityRelationshipFVO> intentRelationship) {
    this.intentRelationship = intentRelationship;
  }
  ...
  public IntentFVO expression(IntentExpression expression) {
    this.expression = expression;
    return this;
  }
  ...
  public IntentExpression getExpression() {
    return expression;
  }

  public void setExpression(IntentExpression expression) {
    this.expression = expression;
  }
