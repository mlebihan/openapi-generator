...
import org.openapitools.model.ServiceOrderStateChangeEventPayload;
...
public class ServiceOrderStateChangeEvent {
  ...
  private @Nullable ServiceOrderStateChangeEventPayload event;

  public ServiceOrderStateChangeEvent() {
    super();
  }
   ...
   */
  public ServiceOrderStateChangeEvent(String atType) {
    this.atType = atType;
  }

  public ServiceOrderStateChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceOrderStateChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceOrderStateChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceOrderStateChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceOrderStateChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ServiceOrderStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public ServiceOrderStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ServiceOrderStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ServiceOrderStateChangeEvent description(@Nullable String description) {
  ...
  public ServiceOrderStateChangeEvent priority(@Nullable String priority) {
  ...
  public ServiceOrderStateChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ServiceOrderStateChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ServiceOrderStateChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ServiceOrderStateChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ServiceOrderStateChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ServiceOrderStateChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ServiceOrderStateChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ServiceOrderStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public ServiceOrderStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ServiceOrderStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public ServiceOrderStateChangeEvent event(@Nullable ServiceOrderStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ServiceOrderStateChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ServiceOrderStateChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, serviceOrderStateChangeEvent.atType) &&
        Objects.equals(this.atBaseType, serviceOrderStateChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceOrderStateChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, serviceOrderStateChangeEvent.href) &&
        Objects.equals(this.id, serviceOrderStateChangeEvent.id) &&
        Objects.equals(this.correlationId, serviceOrderStateChangeEvent.correlationId) &&
        Objects.equals(this.domain, serviceOrderStateChangeEvent.domain) &&
        Objects.equals(this.title, serviceOrderStateChangeEvent.title) &&
        Objects.equals(this.description, serviceOrderStateChangeEvent.description) &&
        Objects.equals(this.priority, serviceOrderStateChangeEvent.priority) &&
        Objects.equals(this.timeOccurred, serviceOrderStateChangeEvent.timeOccurred) &&
        Objects.equals(this.source, serviceOrderStateChangeEvent.source) &&
        Objects.equals(this.reportingSystem, serviceOrderStateChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, serviceOrderStateChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, serviceOrderStateChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, serviceOrderStateChangeEvent.eventId) &&
        Objects.equals(this.eventTime, serviceOrderStateChangeEvent.eventTime) &&
        Objects.equals(this.eventType, serviceOrderStateChangeEvent.eventType) &&
        Objects.equals(this.event, serviceOrderStateChangeEvent.event);
  }
