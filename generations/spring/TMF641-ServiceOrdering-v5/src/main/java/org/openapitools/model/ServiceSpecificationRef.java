...
public class ServiceSpecificationRef {
   ...
   */
  public ServiceSpecificationRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }
  ...
  public ServiceSpecificationRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, serviceSpecificationRef.atType) &&
