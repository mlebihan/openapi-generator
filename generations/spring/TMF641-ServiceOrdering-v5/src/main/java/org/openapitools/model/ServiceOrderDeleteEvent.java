...
import org.openapitools.model.ServiceOrderDeleteEventPayload;
...
public class ServiceOrderDeleteEvent {
  ...
  private @Nullable ServiceOrderDeleteEventPayload event;

  public ServiceOrderDeleteEvent() {
    super();
  }
   ...
   */
  public ServiceOrderDeleteEvent(String atType) {
    this.atType = atType;
  }

  public ServiceOrderDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceOrderDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceOrderDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceOrderDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceOrderDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ServiceOrderDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public ServiceOrderDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ServiceOrderDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ServiceOrderDeleteEvent description(@Nullable String description) {
  ...
  public ServiceOrderDeleteEvent priority(@Nullable String priority) {
  ...
  public ServiceOrderDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ServiceOrderDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ServiceOrderDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ServiceOrderDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ServiceOrderDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ServiceOrderDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ServiceOrderDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ServiceOrderDeleteEvent eventId(@Nullable String eventId) {
  ...
  public ServiceOrderDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ServiceOrderDeleteEvent eventType(@Nullable String eventType) {
  ...
  public ServiceOrderDeleteEvent event(@Nullable ServiceOrderDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ServiceOrderDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ServiceOrderDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, serviceOrderDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, serviceOrderDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceOrderDeleteEvent.atSchemaLocation) &&
        Objects.equals(this.href, serviceOrderDeleteEvent.href) &&
        Objects.equals(this.id, serviceOrderDeleteEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, serviceOrderDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, serviceOrderDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, serviceOrderDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, serviceOrderDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, serviceOrderDeleteEvent.analyticCharacteristic) &&
        ...
        Objects.equals(this.event, serviceOrderDeleteEvent.event);
  }
