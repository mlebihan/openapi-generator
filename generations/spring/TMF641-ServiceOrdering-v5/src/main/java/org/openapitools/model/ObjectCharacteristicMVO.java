...
public class ObjectCharacteristicMVO extends CharacteristicMVO {

  private @Nullable Object value;

  public ObjectCharacteristicMVO() {
    super();
  }
   ...
   */
  public ObjectCharacteristicMVO(String atType) {
    super(atType);
  }

  public ObjectCharacteristicMVO value(@Nullable Object value) {
    this.value = value;
    return this;
  }
  ...
  public ObjectCharacteristicMVO atType(String atType) {
    super.atType(atType);
    return this;
  }

  public ObjectCharacteristicMVO atBaseType(String atBaseType) {
    super.atBaseType(atBaseType);
    return this;
  }

  public ObjectCharacteristicMVO atSchemaLocation(String atSchemaLocation) {
    super.atSchemaLocation(atSchemaLocation);
    return this;
  }

  public ObjectCharacteristicMVO id(String id) {
    super.id(id);
    return this;
  }
