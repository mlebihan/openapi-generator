...
public class RelatedPartyRefOrPartyRoleRef {
  ...
  private @Nullable PartyRefOrPartyRoleRef partyOrPartyRole;
  ...
  public RelatedPartyRefOrPartyRoleRef atBaseType(@Nullable String atBaseType) {
  ...
  public RelatedPartyRefOrPartyRoleRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public RelatedPartyRefOrPartyRoleRef role(@Nullable String role) {
    this.role = role;
    return this;
  }
  ...
  public RelatedPartyRefOrPartyRoleRef partyOrPartyRole(@Nullable PartyRefOrPartyRoleRef partyOrPartyRole) {
  ...
  public @Nullable PartyRefOrPartyRoleRef getPartyOrPartyRole() {
    return partyOrPartyRole;
  }

  public void setPartyOrPartyRole(@Nullable PartyRefOrPartyRoleRef partyOrPartyRole) {
    this.partyOrPartyRole = partyOrPartyRole;
  }
