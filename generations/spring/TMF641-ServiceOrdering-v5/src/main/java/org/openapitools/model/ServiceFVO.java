...
public class ServiceFVO implements ServiceRefOrValueFVO {
   ...
   */
  public ServiceFVO(String atType, ServiceStateType state, ServiceSpecificationRef serviceSpecification, String serviceDate) {
    this.atType = atType;
    this.state = state;
  ...
  public ServiceFVO supportingService(List<@Valid ServiceRefOrValue> supportingService) {
    this.supportingService = supportingService;
    return this;
  }

  public ServiceFVO addSupportingServiceItem(ServiceRefOrValue supportingServiceItem) {
  ...
  public ServiceFVO serviceDate(String serviceDate) {
    this.serviceDate = serviceDate;
    return this;
  }
   ...
   */
  @NotNull 
  @Schema(name = "serviceDate", description = "Date when the service was created (whatever its status).", requiredMode = Schema.RequiredMode.REQUIRED)
