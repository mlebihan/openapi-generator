...
public class IntentRefMVO implements IntentRefOrValueMVO {
   ...
   */
  public IntentRefMVO(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }

  public IntentRefMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public IntentRefMVO atBaseType(@Nullable String atBaseType) {
  ...
  public IntentRefMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public IntentRefMVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public IntentRefMVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public IntentRefMVO atReferredType(@Nullable String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, intentRefMVO.atType) &&
        Objects.equals(this.atBaseType, intentRefMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, intentRefMVO.atSchemaLocation) &&
        ...
        Objects.equals(this.atReferredType, intentRefMVO.atReferredType);
  }
