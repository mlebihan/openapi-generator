...
public class AppointmentRef {
   ...
   */
  public AppointmentRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }
  ...
  public AppointmentRef atBaseType(@Nullable String atBaseType) {
  ...
  public AppointmentRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public AppointmentRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public AppointmentRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AppointmentRef atReferredType(@Nullable String atReferredType) {
  ...
  public AppointmentRef description(@Nullable String description) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, appointmentRef.atType) &&
        ...
        Objects.equals(this.name, appointmentRef.name) &&
