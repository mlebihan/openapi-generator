...
public class ServiceOrderRelationship {
   ...
   */
  public ServiceOrderRelationship(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }

  public ServiceOrderRelationship atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceOrderRelationship atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceOrderRelationship name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ServiceOrderRelationship validFor(@Nullable TimePeriod validFor) {
  ...
  public ServiceOrderRelationship relationshipType(@Nullable String relationshipType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, serviceOrderRelationship.atType) &&
        ...
        Objects.equals(this.id, serviceOrderRelationship.id) &&
        Objects.equals(this.name, serviceOrderRelationship.name) &&
        Objects.equals(this.atReferredType, serviceOrderRelationship.atReferredType) &&
        Objects.equals(this.validFor, serviceOrderRelationship.validFor) &&
