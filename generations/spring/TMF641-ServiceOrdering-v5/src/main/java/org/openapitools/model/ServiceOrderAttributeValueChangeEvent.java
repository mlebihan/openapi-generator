...
import org.openapitools.model.ServiceOrderAttributeValueChangeEventPayload;
...
public class ServiceOrderAttributeValueChangeEvent {
  ...
  private @Nullable ServiceOrderAttributeValueChangeEventPayload event;

  public ServiceOrderAttributeValueChangeEvent() {
    super();
  }
   ...
   */
  public ServiceOrderAttributeValueChangeEvent(String atType) {
    this.atType = atType;
  }

  public ServiceOrderAttributeValueChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceOrderAttributeValueChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceOrderAttributeValueChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceOrderAttributeValueChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceOrderAttributeValueChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ServiceOrderAttributeValueChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public ServiceOrderAttributeValueChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ServiceOrderAttributeValueChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ServiceOrderAttributeValueChangeEvent description(@Nullable String description) {
  ...
  public ServiceOrderAttributeValueChangeEvent priority(@Nullable String priority) {
  ...
  public ServiceOrderAttributeValueChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ServiceOrderAttributeValueChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ServiceOrderAttributeValueChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ServiceOrderAttributeValueChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ServiceOrderAttributeValueChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ServiceOrderAttributeValueChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ServiceOrderAttributeValueChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ServiceOrderAttributeValueChangeEvent eventId(@Nullable String eventId) {
  ...
  public ServiceOrderAttributeValueChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ServiceOrderAttributeValueChangeEvent eventType(@Nullable String eventType) {
  ...
  public ServiceOrderAttributeValueChangeEvent event(@Nullable ServiceOrderAttributeValueChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ServiceOrderAttributeValueChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ServiceOrderAttributeValueChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, serviceOrderAttributeValueChangeEvent.atType) &&
        Objects.equals(this.atBaseType, serviceOrderAttributeValueChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceOrderAttributeValueChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, serviceOrderAttributeValueChangeEvent.href) &&
        Objects.equals(this.id, serviceOrderAttributeValueChangeEvent.id) &&
        Objects.equals(this.correlationId, serviceOrderAttributeValueChangeEvent.correlationId) &&
        Objects.equals(this.domain, serviceOrderAttributeValueChangeEvent.domain) &&
        Objects.equals(this.title, serviceOrderAttributeValueChangeEvent.title) &&
        Objects.equals(this.description, serviceOrderAttributeValueChangeEvent.description) &&
        Objects.equals(this.priority, serviceOrderAttributeValueChangeEvent.priority) &&
        Objects.equals(this.timeOccurred, serviceOrderAttributeValueChangeEvent.timeOccurred) &&
        Objects.equals(this.source, serviceOrderAttributeValueChangeEvent.source) &&
        Objects.equals(this.reportingSystem, serviceOrderAttributeValueChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, serviceOrderAttributeValueChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, serviceOrderAttributeValueChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, serviceOrderAttributeValueChangeEvent.eventId) &&
        Objects.equals(this.eventTime, serviceOrderAttributeValueChangeEvent.eventTime) &&
        Objects.equals(this.eventType, serviceOrderAttributeValueChangeEvent.eventType) &&
        Objects.equals(this.event, serviceOrderAttributeValueChangeEvent.event);
  }
