...
public class ServiceOrderJeopardyEvent {
  ...
  public ServiceOrderJeopardyEvent() {
    super();
  }
   ...
   */
  public ServiceOrderJeopardyEvent(String atType) {
    this.atType = atType;
  }

  public ServiceOrderJeopardyEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceOrderJeopardyEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceOrderJeopardyEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceOrderJeopardyEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceOrderJeopardyEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ServiceOrderJeopardyEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ServiceOrderJeopardyEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ServiceOrderJeopardyEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ServiceOrderJeopardyEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ServiceOrderJeopardyEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ServiceOrderJeopardyEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ServiceOrderJeopardyEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, serviceOrderJeopardyEvent.atType) &&
        Objects.equals(this.atBaseType, serviceOrderJeopardyEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceOrderJeopardyEvent.atSchemaLocation) &&
        Objects.equals(this.href, serviceOrderJeopardyEvent.href) &&
        Objects.equals(this.id, serviceOrderJeopardyEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, serviceOrderJeopardyEvent.timeOccurred) &&
        Objects.equals(this.source, serviceOrderJeopardyEvent.source) &&
        Objects.equals(this.reportingSystem, serviceOrderJeopardyEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, serviceOrderJeopardyEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, serviceOrderJeopardyEvent.analyticCharacteristic) &&
        ...
        Objects.equals(this.event, serviceOrderJeopardyEvent.event);
  }
