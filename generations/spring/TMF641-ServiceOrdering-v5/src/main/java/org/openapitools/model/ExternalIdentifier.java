...
public class ExternalIdentifier {
  ...
  public ExternalIdentifier atBaseType(@Nullable String atBaseType) {
  ...
  public ExternalIdentifier atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ExternalIdentifier owner(@Nullable String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public ExternalIdentifier externalIdentifierType(@Nullable String externalIdentifierType) {
  ...
  public ExternalIdentifier id(@Nullable String id) {
    this.id = id;
    return this;
  }
