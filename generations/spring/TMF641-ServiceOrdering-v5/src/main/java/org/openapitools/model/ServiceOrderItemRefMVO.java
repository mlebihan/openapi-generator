...
public class ServiceOrderItemRefMVO {
   ...
   */
  public ServiceOrderItemRefMVO(String atType) {
    this.atType = atType;
  }

  public ServiceOrderItemRefMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceOrderItemRefMVO atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceOrderItemRefMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceOrderItemRefMVO atReferredType(@Nullable String atReferredType) {
  ...
  public ServiceOrderItemRefMVO itemId(@Nullable String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public ServiceOrderItemRefMVO serviceOrderHref(@Nullable URI serviceOrderHref) {
  ...
  public ServiceOrderItemRefMVO serviceOrderId(@Nullable String serviceOrderId) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceOrderItemRefMVO serviceOrderItemRefMVO = (ServiceOrderItemRefMVO) o;
    return Objects.equals(this.atType, serviceOrderItemRefMVO.atType) &&
        Objects.equals(this.atBaseType, serviceOrderItemRefMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceOrderItemRefMVO.atSchemaLocation) &&
        Objects.equals(this.atReferredType, serviceOrderItemRefMVO.atReferredType) &&
        Objects.equals(this.itemId, serviceOrderItemRefMVO.itemId) &&
        Objects.equals(this.serviceOrderHref, serviceOrderItemRefMVO.serviceOrderHref) &&
        Objects.equals(this.serviceOrderId, serviceOrderItemRefMVO.serviceOrderId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceOrderItemRefMVO {\n");
