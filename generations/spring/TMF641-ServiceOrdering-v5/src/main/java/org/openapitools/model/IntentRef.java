...
public class IntentRef implements IntentRefOrValue, IntentRefOrValueFVO {
   ...
   */
  public IntentRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }

  public IntentRef atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public IntentRef atBaseType(@Nullable String atBaseType) {
  ...
  public IntentRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public IntentRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public IntentRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public IntentRef atReferredType(@Nullable String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, intentRef.atType) &&
        Objects.equals(this.atBaseType, intentRef.atBaseType) &&
        Objects.equals(this.atSchemaLocation, intentRef.atSchemaLocation) &&
        Objects.equals(this.href, intentRef.href) &&
        Objects.equals(this.id, intentRef.id) &&
        Objects.equals(this.name, intentRef.name) &&
        Objects.equals(this.atReferredType, intentRef.atReferredType);
  }
