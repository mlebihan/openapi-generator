...
@Schema(name = "ServiceOrderMilestoneEventPayload", description = "ServiceOrderMilestoneEventPayload")
...
public class ServiceOrderMilestoneEventPayload {

  private @Nullable ServiceOrder serviceOrder;

  public ServiceOrderMilestoneEventPayload serviceOrder(@Nullable ServiceOrder serviceOrder) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceOrderMilestoneEventPayload serviceOrderMilestoneEventPayload = (ServiceOrderMilestoneEventPayload) o;
    return Objects.equals(this.serviceOrder, serviceOrderMilestoneEventPayload.serviceOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceOrderMilestoneEventPayload {\n");
