...
@Schema(name = "ServiceOrderCreateEventPayload", description = "ServiceOrderCreateEventPayload")
...
public class ServiceOrderCreateEventPayload {
  ...
  public ServiceOrderCreateEventPayload serviceOrder(@Nullable ServiceOrder serviceOrder) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceOrderCreateEventPayload serviceOrderCreateEventPayload = (ServiceOrderCreateEventPayload) o;
    return Objects.equals(this.serviceOrder, serviceOrderCreateEventPayload.serviceOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceOrderCreateEventPayload {\n");
