...
import org.openapitools.model.GeographicSubAddressUnitMVO;
...
public class GeographicSubAddressMVO {
  ...
  @Valid
  private List<GeographicSubAddressUnitMVO> subUnit = new ArrayList<>();

  private @Nullable String subAddressType;

  public GeographicSubAddressMVO() {
    super();
  }
   ...
   */
  public GeographicSubAddressMVO(String atType) {
    this.atType = atType;
  }

  public GeographicSubAddressMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public GeographicSubAddressMVO atBaseType(@Nullable String atBaseType) {
  ...
  public GeographicSubAddressMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public GeographicSubAddressMVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public GeographicSubAddressMVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public GeographicSubAddressMVO buildingName(@Nullable String buildingName) {
  ...
  public GeographicSubAddressMVO levelNumber(@Nullable String levelNumber) {
  ...
  public GeographicSubAddressMVO levelType(@Nullable String levelType) {
  ...
  public GeographicSubAddressMVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GeographicSubAddressMVO privateStreetName(@Nullable String privateStreetName) {
  ...
  public GeographicSubAddressMVO privateStreetNumber(@Nullable String privateStreetNumber) {
  ...
  public GeographicSubAddressMVO subUnit(List<GeographicSubAddressUnitMVO> subUnit) {
    this.subUnit = subUnit;
    return this;
  }

  public GeographicSubAddressMVO addSubUnitItem(GeographicSubAddressUnitMVO subUnitItem) {
  ...
  public List<GeographicSubAddressUnitMVO> getSubUnit() {
    return subUnit;
  }

  public void setSubUnit(List<GeographicSubAddressUnitMVO> subUnit) {
    this.subUnit = subUnit;
  }

  public GeographicSubAddressMVO subAddressType(@Nullable String subAddressType) {
  ...
  public boolean equals(Object o) {
    ...
    GeographicSubAddressMVO geographicSubAddressMVO = (GeographicSubAddressMVO) o;
    return Objects.equals(this.atType, geographicSubAddressMVO.atType) &&
        Objects.equals(this.atBaseType, geographicSubAddressMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, geographicSubAddressMVO.atSchemaLocation) &&
        Objects.equals(this.href, geographicSubAddressMVO.href) &&
        Objects.equals(this.id, geographicSubAddressMVO.id) &&
        Objects.equals(this.buildingName, geographicSubAddressMVO.buildingName) &&
        Objects.equals(this.levelNumber, geographicSubAddressMVO.levelNumber) &&
        Objects.equals(this.levelType, geographicSubAddressMVO.levelType) &&
        Objects.equals(this.name, geographicSubAddressMVO.name) &&
        Objects.equals(this.privateStreetName, geographicSubAddressMVO.privateStreetName) &&
        Objects.equals(this.privateStreetNumber, geographicSubAddressMVO.privateStreetNumber) &&
        Objects.equals(this.subUnit, geographicSubAddressMVO.subUnit) &&
        Objects.equals(this.subAddressType, geographicSubAddressMVO.subAddressType);
  }
  ...
  public String toString() {
    ...
    sb.append("class GeographicSubAddressMVO {\n");
