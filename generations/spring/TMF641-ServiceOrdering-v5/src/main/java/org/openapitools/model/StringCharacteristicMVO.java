...
public class StringCharacteristicMVO extends CharacteristicMVO {

  private @Nullable String value;

  public StringCharacteristicMVO() {
    super();
  }
   ...
   */
  public StringCharacteristicMVO(String atType) {
    super(atType);
  }

  public StringCharacteristicMVO value(@Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public StringCharacteristicMVO atType(String atType) {
    super.atType(atType);
    return this;
  }

  public StringCharacteristicMVO atBaseType(String atBaseType) {
    super.atBaseType(atBaseType);
    return this;
  }

  public StringCharacteristicMVO atSchemaLocation(String atSchemaLocation) {
    super.atSchemaLocation(atSchemaLocation);
    return this;
  }

  public StringCharacteristicMVO id(String id) {
    super.id(id);
    return this;
  }
