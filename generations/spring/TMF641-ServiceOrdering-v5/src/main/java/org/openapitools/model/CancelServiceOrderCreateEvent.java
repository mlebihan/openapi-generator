...
import org.openapitools.model.CancelServiceOrderCreateEventPayload;
...
public class CancelServiceOrderCreateEvent {
  ...
  private @Nullable CancelServiceOrderCreateEventPayload event;

  public CancelServiceOrderCreateEvent() {
    super();
  }
   ...
   */
  public CancelServiceOrderCreateEvent(String atType) {
    this.atType = atType;
  }

  public CancelServiceOrderCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public CancelServiceOrderCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public CancelServiceOrderCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CancelServiceOrderCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CancelServiceOrderCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CancelServiceOrderCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public CancelServiceOrderCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CancelServiceOrderCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CancelServiceOrderCreateEvent description(@Nullable String description) {
  ...
  public CancelServiceOrderCreateEvent priority(@Nullable String priority) {
  ...
  public CancelServiceOrderCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public CancelServiceOrderCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public CancelServiceOrderCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public CancelServiceOrderCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public CancelServiceOrderCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public CancelServiceOrderCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public CancelServiceOrderCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public CancelServiceOrderCreateEvent eventId(@Nullable String eventId) {
  ...
  public CancelServiceOrderCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public CancelServiceOrderCreateEvent eventType(@Nullable String eventType) {
  ...
  public CancelServiceOrderCreateEvent event(@Nullable CancelServiceOrderCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable CancelServiceOrderCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable CancelServiceOrderCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    CancelServiceOrderCreateEvent cancelServiceOrderCreateEvent = (CancelServiceOrderCreateEvent) o;
    return Objects.equals(this.atType, cancelServiceOrderCreateEvent.atType) &&
        Objects.equals(this.atBaseType, cancelServiceOrderCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, cancelServiceOrderCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, cancelServiceOrderCreateEvent.href) &&
        Objects.equals(this.id, cancelServiceOrderCreateEvent.id) &&
        Objects.equals(this.correlationId, cancelServiceOrderCreateEvent.correlationId) &&
        Objects.equals(this.domain, cancelServiceOrderCreateEvent.domain) &&
        Objects.equals(this.title, cancelServiceOrderCreateEvent.title) &&
        Objects.equals(this.description, cancelServiceOrderCreateEvent.description) &&
        Objects.equals(this.priority, cancelServiceOrderCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, cancelServiceOrderCreateEvent.timeOccurred) &&
        Objects.equals(this.source, cancelServiceOrderCreateEvent.source) &&
        Objects.equals(this.reportingSystem, cancelServiceOrderCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, cancelServiceOrderCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, cancelServiceOrderCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, cancelServiceOrderCreateEvent.eventId) &&
        Objects.equals(this.eventTime, cancelServiceOrderCreateEvent.eventTime) &&
        Objects.equals(this.eventType, cancelServiceOrderCreateEvent.eventType) &&
        Objects.equals(this.event, cancelServiceOrderCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelServiceOrderCreateEvent {\n");
