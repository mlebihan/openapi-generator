...
@Schema(name = "ServiceOrderAttributeValueChangeEventPayload", description = "ServiceOrderAttributeValueChangeEventPayload")
...
public class ServiceOrderAttributeValueChangeEventPayload {

  private @Nullable ServiceOrder serviceOrder;

  public ServiceOrderAttributeValueChangeEventPayload serviceOrder(@Nullable ServiceOrder serviceOrder) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceOrderAttributeValueChangeEventPayload serviceOrderAttributeValueChangeEventPayload = (ServiceOrderAttributeValueChangeEventPayload) o;
    return Objects.equals(this.serviceOrder, serviceOrderAttributeValueChangeEventPayload.serviceOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceOrderAttributeValueChangeEventPayload {\n");
