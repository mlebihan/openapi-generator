...
public class AttachmentRefMVO implements AttachmentRefOrValueMVO {
   ...
   */
  public AttachmentRefMVO(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }

  public AttachmentRefMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public AttachmentRefMVO atBaseType(@Nullable String atBaseType) {
  ...
  public AttachmentRefMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public AttachmentRefMVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public AttachmentRefMVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AttachmentRefMVO atReferredType(@Nullable String atReferredType) {
  ...
  public AttachmentRefMVO description(@Nullable String description) {
  ...
  public AttachmentRefMVO url(@Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, attachmentRefMVO.atType) &&
        Objects.equals(this.atBaseType, attachmentRefMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, attachmentRefMVO.atSchemaLocation) &&
        ...
        Objects.equals(this.atReferredType, attachmentRefMVO.atReferredType) &&
