...
/**
 * CancelServiceOrderStateChangeEvent Payload structure
 */

@Schema(name = "CancelServiceOrderStateChangeEventPayload", description = "CancelServiceOrderStateChangeEvent Payload structure")
...
public class CancelServiceOrderStateChangeEventPayload {
  ...
  public CancelServiceOrderStateChangeEventPayload cancelServiceOrder(@Nullable CancelServiceOrder cancelServiceOrder) {
  ...
  public boolean equals(Object o) {
    ...
    CancelServiceOrderStateChangeEventPayload cancelServiceOrderStateChangeEventPayload = (CancelServiceOrderStateChangeEventPayload) o;
    return Objects.equals(this.cancelServiceOrder, cancelServiceOrderStateChangeEventPayload.cancelServiceOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelServiceOrderStateChangeEventPayload {\n");
