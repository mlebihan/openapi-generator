...
import org.openapitools.model.ServiceOrderCreateEventPayload;
...
public class ServiceOrderCreateEvent {
  ...
  private @Nullable ServiceOrderCreateEventPayload event;

  public ServiceOrderCreateEvent() {
    super();
  }
   ...
   */
  public ServiceOrderCreateEvent(String atType) {
    this.atType = atType;
  }

  public ServiceOrderCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceOrderCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceOrderCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceOrderCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceOrderCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ServiceOrderCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public ServiceOrderCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ServiceOrderCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ServiceOrderCreateEvent description(@Nullable String description) {
  ...
  public ServiceOrderCreateEvent priority(@Nullable String priority) {
  ...
  public ServiceOrderCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ServiceOrderCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ServiceOrderCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ServiceOrderCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ServiceOrderCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ServiceOrderCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ServiceOrderCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ServiceOrderCreateEvent eventId(@Nullable String eventId) {
  ...
  public ServiceOrderCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ServiceOrderCreateEvent eventType(@Nullable String eventType) {
  ...
  public ServiceOrderCreateEvent event(@Nullable ServiceOrderCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ServiceOrderCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ServiceOrderCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServiceOrderCreateEvent serviceOrderCreateEvent = (ServiceOrderCreateEvent) o;
    return Objects.equals(this.atType, serviceOrderCreateEvent.atType) &&
        Objects.equals(this.atBaseType, serviceOrderCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceOrderCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, serviceOrderCreateEvent.href) &&
        Objects.equals(this.id, serviceOrderCreateEvent.id) &&
        Objects.equals(this.correlationId, serviceOrderCreateEvent.correlationId) &&
        Objects.equals(this.domain, serviceOrderCreateEvent.domain) &&
        Objects.equals(this.title, serviceOrderCreateEvent.title) &&
        Objects.equals(this.description, serviceOrderCreateEvent.description) &&
        Objects.equals(this.priority, serviceOrderCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, serviceOrderCreateEvent.timeOccurred) &&
        Objects.equals(this.source, serviceOrderCreateEvent.source) &&
        Objects.equals(this.reportingSystem, serviceOrderCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, serviceOrderCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, serviceOrderCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, serviceOrderCreateEvent.eventId) &&
        Objects.equals(this.eventTime, serviceOrderCreateEvent.eventTime) &&
        Objects.equals(this.eventType, serviceOrderCreateEvent.eventType) &&
        Objects.equals(this.event, serviceOrderCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceOrderCreateEvent {\n");
