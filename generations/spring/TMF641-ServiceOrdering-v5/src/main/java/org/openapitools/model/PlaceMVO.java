...
@Schema(name = "Place_MVO", description = "Place reference.")
...
public class PlaceMVO {
  ...
  public PlaceMVO atBaseType(@Nullable String atBaseType) {
  ...
  public PlaceMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PlaceMVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PlaceMVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
