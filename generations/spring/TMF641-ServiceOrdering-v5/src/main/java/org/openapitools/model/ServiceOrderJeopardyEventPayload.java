...
@Schema(name = "ServiceOrderJeopardyEventPayload", description = "ServiceOrderJeopardyEventPayload")
...
public class ServiceOrderJeopardyEventPayload {

  private @Nullable ServiceOrder serviceOrder;

  public ServiceOrderJeopardyEventPayload serviceOrder(@Nullable ServiceOrder serviceOrder) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceOrderJeopardyEventPayload serviceOrderJeopardyEventPayload = (ServiceOrderJeopardyEventPayload) o;
    return Objects.equals(this.serviceOrder, serviceOrderJeopardyEventPayload.serviceOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceOrderJeopardyEventPayload {\n");
