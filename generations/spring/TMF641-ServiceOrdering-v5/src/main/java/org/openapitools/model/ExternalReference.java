...
public class ExternalReference {
   ...
   */
  public ExternalReference(String atType) {
    this.atType = atType;
  }
  ...
  public ExternalReference atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ExternalReference href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ExternalReference name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, externalReference.atType) &&
        ...
        Objects.equals(this.id, externalReference.id);
  }
