...
public class ServiceRef {
  ...
  public ServiceRef href(@Nullable URI href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ServiceRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
