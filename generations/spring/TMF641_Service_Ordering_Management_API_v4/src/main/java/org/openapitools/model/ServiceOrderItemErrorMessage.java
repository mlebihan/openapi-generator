...
@Schema(name = "ServiceOrderItemErrorMessage", description = "AServiceOrderItemErrorMessage represents an error that causes a status change in a service order item.")
...
public class ServiceOrderItemErrorMessage {
  ...
  public ServiceOrderItemErrorMessage code(@Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public ServiceOrderItemErrorMessage message(@Nullable String message) {
  ...
  public ServiceOrderItemErrorMessage reason(@Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public ServiceOrderItemErrorMessage referenceError(@Nullable URI referenceError) {
  ...
  public ServiceOrderItemErrorMessage status(@Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public ServiceOrderItemErrorMessage timestamp(@Nullable OffsetDateTime timestamp) {
  ...
  public ServiceOrderItemErrorMessage atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceOrderItemErrorMessage atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ServiceOrderItemErrorMessage atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, serviceOrderItemErrorMessage.code) &&
        ...
        Objects.equals(this.atBaseType, serviceOrderItemErrorMessage.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceOrderItemErrorMessage.atSchemaLocation) &&
        Objects.equals(this.atType, serviceOrderItemErrorMessage.atType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, message, reason, referenceError, status, timestamp, atBaseType, atSchemaLocation, atType);
  }
