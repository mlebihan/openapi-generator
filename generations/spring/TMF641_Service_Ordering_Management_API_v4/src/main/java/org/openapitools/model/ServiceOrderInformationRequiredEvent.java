...
@Schema(name = "ServiceOrderInformationRequiredEvent", description = "The notification data structure")
...
public class ServiceOrderInformationRequiredEvent {
  ...
  public ServiceOrderInformationRequiredEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ServiceOrderInformationRequiredEvent fieldPath(@Nullable String fieldPath) {
