...
@Schema(name = "ServiceOrderMilestoneEvent", description = "The notification data structure")
...
public class ServiceOrderMilestoneEvent {
  ...
  public ServiceOrderMilestoneEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
