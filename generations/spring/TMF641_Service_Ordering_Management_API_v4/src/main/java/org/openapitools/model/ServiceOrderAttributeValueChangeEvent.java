...
@Schema(name = "ServiceOrderAttributeValueChangeEvent", description = "The notification data structure")
...
public class ServiceOrderAttributeValueChangeEvent {
  ...
  public ServiceOrderAttributeValueChangeEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ServiceOrderAttributeValueChangeEvent fieldPath(@Nullable String fieldPath) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventId, serviceOrderAttributeValueChangeEvent.eventId) &&
        ...
        Objects.equals(this.timeOcurred, serviceOrderAttributeValueChangeEvent.timeOcurred) &&
        Objects.equals(this.fieldPath, serviceOrderAttributeValueChangeEvent.fieldPath) &&
