...
public class EnumConverterConfiguration {
    ...
    @Bean(name = "org.openapitools.configuration.EnumConverterConfiguration.serviceOrderItemStateTypeConverter")
    Converter<String, ServiceOrderItemStateType> serviceOrderItemStateTypeConverter() {
        return new Converter<String, ServiceOrderItemStateType>() {
            @Override
            public ServiceOrderItemStateType convert(String source) {
                return ServiceOrderItemStateType.fromValue(source);
            }
        };
    }
