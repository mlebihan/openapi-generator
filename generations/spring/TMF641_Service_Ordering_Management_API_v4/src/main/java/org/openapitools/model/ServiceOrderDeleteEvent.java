...
@Schema(name = "ServiceOrderDeleteEvent", description = "The notification data structure")
...
public class ServiceOrderDeleteEvent {
  ...
  public ServiceOrderDeleteEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
