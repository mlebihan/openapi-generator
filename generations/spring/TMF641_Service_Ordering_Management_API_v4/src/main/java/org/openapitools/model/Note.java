...
public class Note {
  ...
  @Schema(name = "id", example = "", description = "Identifier of the note within its containing entity", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("id")
  ...
  @Schema(name = "author", example = "", description = "Author of the note", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("author")
   ...
   */
  @NotNull 
  @Schema(name = "text", example = "", description = "Text of the note", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("text")
