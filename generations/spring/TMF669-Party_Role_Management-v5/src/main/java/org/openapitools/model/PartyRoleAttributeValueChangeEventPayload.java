...
/**
 * PartyRoleAttributeValueChangeEventPayload generic structure
 */

@Schema(name = "PartyRoleAttributeValueChangeEventPayload", description = "PartyRoleAttributeValueChangeEventPayload generic structure")
...
public class PartyRoleAttributeValueChangeEventPayload {
  ...
  public PartyRoleAttributeValueChangeEventPayload partyRole(@Nullable PartyRole partyRole) {
