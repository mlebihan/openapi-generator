...
public class OtherNameOrganization {
  ...
  public OtherNameOrganization atBaseType(@Nullable String atBaseType) {
  ...
  public OtherNameOrganization atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public OtherNameOrganization tradingName(@Nullable String tradingName) {
  ...
  public OtherNameOrganization nameType(@Nullable String nameType) {
  ...
  public OtherNameOrganization name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OtherNameOrganization validFor(@Nullable TimePeriod validFor) {
