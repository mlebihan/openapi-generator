...
public class CharacteristicSpecificationMVO {
   ...
   */
  public CharacteristicSpecificationMVO(String atType) {
    this.atType = atType;
  }
  ...
  public CharacteristicSpecificationMVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CharacteristicSpecificationMVO valueType(@Nullable String valueType) {
