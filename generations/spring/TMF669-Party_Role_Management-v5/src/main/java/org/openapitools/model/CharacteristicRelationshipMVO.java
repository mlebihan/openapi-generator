...
public class CharacteristicRelationshipMVO {
   ...
   */
  public CharacteristicRelationshipMVO(String atType) {
    this.atType = atType;
  }

  public CharacteristicRelationshipMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public CharacteristicRelationshipMVO atBaseType(@Nullable String atBaseType) {
  ...
  public CharacteristicRelationshipMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CharacteristicRelationshipMVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CharacteristicRelationshipMVO relationshipType(@Nullable String relationshipType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, characteristicRelationshipMVO.atType) &&
        Objects.equals(this.atBaseType, characteristicRelationshipMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, characteristicRelationshipMVO.atSchemaLocation) &&
        Objects.equals(this.id, characteristicRelationshipMVO.id) &&
