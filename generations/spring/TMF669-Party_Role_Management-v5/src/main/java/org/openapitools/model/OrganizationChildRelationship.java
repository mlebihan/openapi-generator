...
public class OrganizationChildRelationship {
  ...
  public OrganizationChildRelationship atBaseType(@Nullable String atBaseType) {
  ...
  public OrganizationChildRelationship atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public OrganizationChildRelationship relationshipType(@Nullable String relationshipType) {
  ...
  public OrganizationChildRelationship organization(@Nullable OrganizationRef organization) {
