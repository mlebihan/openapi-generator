...
import org.openapitools.model.PartyRoleDeleteEventPayload;
...
public class PartyRoleDeleteEvent {
  ...
  private @Nullable PartyRoleDeleteEventPayload event;
   ...
   */
  public PartyRoleDeleteEvent(String atType) {
    this.atType = atType;
  }

  public PartyRoleDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public PartyRoleDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public PartyRoleDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PartyRoleDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PartyRoleDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PartyRoleDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public PartyRoleDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public PartyRoleDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public PartyRoleDeleteEvent description(@Nullable String description) {
  ...
  public PartyRoleDeleteEvent priority(@Nullable String priority) {
  ...
  public PartyRoleDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public PartyRoleDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public PartyRoleDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public PartyRoleDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public PartyRoleDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public PartyRoleDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public PartyRoleDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public PartyRoleDeleteEvent eventId(@Nullable String eventId) {
  ...
  public PartyRoleDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public PartyRoleDeleteEvent eventType(@Nullable String eventType) {
  ...
  public PartyRoleDeleteEvent event(@Nullable PartyRoleDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable PartyRoleDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable PartyRoleDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, partyRoleDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, partyRoleDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, partyRoleDeleteEvent.atSchemaLocation) &&
        Objects.equals(this.href, partyRoleDeleteEvent.href) &&
        Objects.equals(this.id, partyRoleDeleteEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, partyRoleDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, partyRoleDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, partyRoleDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, partyRoleDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, partyRoleDeleteEvent.analyticCharacteristic) &&
