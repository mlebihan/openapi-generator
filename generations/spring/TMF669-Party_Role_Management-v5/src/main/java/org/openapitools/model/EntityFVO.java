...
public class EntityFVO {
   ...
   */
  public EntityFVO(String atType) {
    this.atType = atType;
  }
  ...
  public EntityFVO atBaseType(@Nullable String atBaseType) {
  ...
  public EntityFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public EntityFVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
