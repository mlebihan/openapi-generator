...
public class ConstraintRef {
   ...
   */
  public ConstraintRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }
  ...
  public ConstraintRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ConstraintRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, constraintRef.atType) &&
