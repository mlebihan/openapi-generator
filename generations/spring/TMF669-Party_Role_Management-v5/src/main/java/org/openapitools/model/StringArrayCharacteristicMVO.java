...
public class StringArrayCharacteristicMVO extends CharacteristicMVO {

  @Valid
  private List<String> value = new ArrayList<>();

  public StringArrayCharacteristicMVO() {
    super();
  }
   ...
   */
  public StringArrayCharacteristicMVO(List<String> value, String atType) {
    super(atType);
    this.value = value;
  }
  ...
  public StringArrayCharacteristicMVO atType(String atType) {
    super.atType(atType);
    return this;
  }

  public StringArrayCharacteristicMVO atBaseType(String atBaseType) {
    super.atBaseType(atBaseType);
    return this;
  }

  public StringArrayCharacteristicMVO atSchemaLocation(String atSchemaLocation) {
    super.atSchemaLocation(atSchemaLocation);
    return this;
  }

  public StringArrayCharacteristicMVO id(String id) {
    super.id(id);
    return this;
  }
