...
public class AgreementSpecificationRef {
   ...
   */
  public AgreementSpecificationRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }
  ...
  public AgreementSpecificationRef atBaseType(@Nullable String atBaseType) {
  ...
  public AgreementSpecificationRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public AgreementSpecificationRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public AgreementSpecificationRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AgreementSpecificationRef atReferredType(@Nullable String atReferredType) {
  ...
  public AgreementSpecificationRef description(@Nullable String description) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, agreementSpecificationRef.atType) &&
