...
public class IndividualIdentificationFVO {
  ...
  public IndividualIdentificationFVO atBaseType(@Nullable String atBaseType) {
  ...
  public IndividualIdentificationFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public IndividualIdentificationFVO identificationId(@Nullable String identificationId) {
  ...
  public IndividualIdentificationFVO issuingAuthority(@Nullable String issuingAuthority) {
  ...
  public IndividualIdentificationFVO issuingDate(@Nullable OffsetDateTime issuingDate) {
  ...
  public IndividualIdentificationFVO identificationType(@Nullable String identificationType) {
  ...
  public IndividualIdentificationFVO validFor(@Nullable TimePeriod validFor) {
  ...
  public IndividualIdentificationFVO attachment(@Nullable AttachmentRefOrValueFVO attachment) {
