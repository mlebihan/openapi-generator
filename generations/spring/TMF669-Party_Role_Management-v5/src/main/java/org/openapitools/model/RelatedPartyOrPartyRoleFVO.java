...
import org.openapitools.model.PartyOrPartyRoleFVO;
...
public class RelatedPartyOrPartyRoleFVO {
  ...
  private @Nullable PartyOrPartyRoleFVO partyOrPartyRole;
  ...
  public RelatedPartyOrPartyRoleFVO atBaseType(@Nullable String atBaseType) {
  ...
  public RelatedPartyOrPartyRoleFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public RelatedPartyOrPartyRoleFVO partyOrPartyRole(@Nullable PartyOrPartyRoleFVO partyOrPartyRole) {
  ...
  public @Nullable PartyOrPartyRoleFVO getPartyOrPartyRole() {
    return partyOrPartyRole;
  }

  public void setPartyOrPartyRole(@Nullable PartyOrPartyRoleFVO partyOrPartyRole) {
    this.partyOrPartyRole = partyOrPartyRole;
  }
