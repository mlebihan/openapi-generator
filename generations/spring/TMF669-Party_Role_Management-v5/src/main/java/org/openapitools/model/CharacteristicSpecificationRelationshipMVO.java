...
public class CharacteristicSpecificationRelationshipMVO {
  ...
  public CharacteristicSpecificationRelationshipMVO() {
    super();
  }
   ...
   */
  public CharacteristicSpecificationRelationshipMVO(String atType) {
    this.atType = atType;
  }
  ...
  public CharacteristicSpecificationRelationshipMVO atBaseType(@Nullable String atBaseType) {
  ...
  public CharacteristicSpecificationRelationshipMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CharacteristicSpecificationRelationshipMVO relationshipType(@Nullable String relationshipType) {
  ...
  public CharacteristicSpecificationRelationshipMVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CharacteristicSpecificationRelationshipMVO characteristicSpecificationId(@Nullable String characteristicSpecificationId) {
  ...
  public CharacteristicSpecificationRelationshipMVO parentSpecificationHref(@Nullable URI parentSpecificationHref) {
  ...
  public CharacteristicSpecificationRelationshipMVO validFor(@Nullable TimePeriod validFor) {
  ...
  public CharacteristicSpecificationRelationshipMVO parentSpecificationId(@Nullable String parentSpecificationId) {
