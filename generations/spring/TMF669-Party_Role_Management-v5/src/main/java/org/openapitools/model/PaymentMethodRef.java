...
public class PaymentMethodRef {
  ...
  public PaymentMethodRef atBaseType(@Nullable String atBaseType) {
  ...
  public PaymentMethodRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PaymentMethodRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PaymentMethodRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PaymentMethodRef atReferredType(@Nullable String atReferredType) {
