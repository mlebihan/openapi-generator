...
import org.openapitools.model.PartyRoleAttributeValueChangeEventPayload;
...
public class PartyRoleAttributeValueChangeEvent {
  ...
  private @Nullable PartyRoleAttributeValueChangeEventPayload event;
   ...
   */
  public PartyRoleAttributeValueChangeEvent(String atType) {
    this.atType = atType;
  }

  public PartyRoleAttributeValueChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public PartyRoleAttributeValueChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public PartyRoleAttributeValueChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PartyRoleAttributeValueChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PartyRoleAttributeValueChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PartyRoleAttributeValueChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public PartyRoleAttributeValueChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public PartyRoleAttributeValueChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public PartyRoleAttributeValueChangeEvent description(@Nullable String description) {
  ...
  public PartyRoleAttributeValueChangeEvent priority(@Nullable String priority) {
  ...
  public PartyRoleAttributeValueChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public PartyRoleAttributeValueChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public PartyRoleAttributeValueChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public PartyRoleAttributeValueChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public PartyRoleAttributeValueChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public PartyRoleAttributeValueChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public PartyRoleAttributeValueChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public PartyRoleAttributeValueChangeEvent eventId(@Nullable String eventId) {
  ...
  public PartyRoleAttributeValueChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public PartyRoleAttributeValueChangeEvent eventType(@Nullable String eventType) {
  ...
  public PartyRoleAttributeValueChangeEvent event(@Nullable PartyRoleAttributeValueChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable PartyRoleAttributeValueChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable PartyRoleAttributeValueChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, partyRoleAttributeValueChangeEvent.atType) &&
        Objects.equals(this.atBaseType, partyRoleAttributeValueChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, partyRoleAttributeValueChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, partyRoleAttributeValueChangeEvent.href) &&
        Objects.equals(this.id, partyRoleAttributeValueChangeEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, partyRoleAttributeValueChangeEvent.timeOccurred) &&
        Objects.equals(this.source, partyRoleAttributeValueChangeEvent.source) &&
        Objects.equals(this.reportingSystem, partyRoleAttributeValueChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, partyRoleAttributeValueChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, partyRoleAttributeValueChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, partyRoleAttributeValueChangeEvent.eventId) &&
