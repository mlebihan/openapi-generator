...
public class ContactMediumFVO {
  ...
  public ContactMediumFVO atBaseType(@Nullable String atBaseType) {
  ...
  public ContactMediumFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ContactMediumFVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ContactMediumFVO preferred(@Nullable Boolean preferred) {
  ...
  public ContactMediumFVO contactType(@Nullable String contactType) {
  ...
  public ContactMediumFVO validFor(@Nullable TimePeriod validFor) {
