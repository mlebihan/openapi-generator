...
public class PartyRoleSpecificationRefMVO {
  ...
  public PartyRoleSpecificationRefMVO atBaseType(@Nullable String atBaseType) {
  ...
  public PartyRoleSpecificationRefMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PartyRoleSpecificationRefMVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PartyRoleSpecificationRefMVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PartyRoleSpecificationRefMVO atReferredType(@Nullable String atReferredType) {
