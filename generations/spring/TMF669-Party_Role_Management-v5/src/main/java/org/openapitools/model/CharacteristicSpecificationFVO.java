...
import org.openapitools.model.CharacteristicSpecificationRelationshipFVO;
...
/**
 * CharacteristicSpecificationFVO
 */
...
public class CharacteristicSpecificationFVO {
  ...
  @Valid
  private List<CharacteristicSpecificationRelationshipFVO> charSpecRelationship = new ArrayList<>();

  @Valid
  private List<CharacteristicValueSpecificationFVO> characteristicValueSpecification = new ArrayList<>();

  public CharacteristicSpecificationFVO() {
    super();
  }
   ...
   */
  public CharacteristicSpecificationFVO(String atType, String name, String valueType) {
    this.atType = atType;
    this.name = name;
    this.valueType = valueType;
  }

  public CharacteristicSpecificationFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public CharacteristicSpecificationFVO atBaseType(@Nullable String atBaseType) {
  ...
  public CharacteristicSpecificationFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CharacteristicSpecificationFVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CharacteristicSpecificationFVO name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CharacteristicSpecificationFVO valueType(String valueType) {
    this.valueType = valueType;
    return this;
  }
   ...
   */
  @NotNull 
  @Schema(name = "valueType", description = "A kind of value that the characteristic can take on, such as numeric, text and so forth", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public CharacteristicSpecificationFVO description(@Nullable String description) {
  ...
  public CharacteristicSpecificationFVO configurable(@Nullable Boolean configurable) {
  ...
  public CharacteristicSpecificationFVO validFor(@Nullable TimePeriod validFor) {
  ...
  public CharacteristicSpecificationFVO minCardinality(@Nullable Integer minCardinality) {
  ...
  public CharacteristicSpecificationFVO maxCardinality(@Nullable Integer maxCardinality) {
  ...
  public CharacteristicSpecificationFVO isUnique(@Nullable Boolean isUnique) {
  ...
  public CharacteristicSpecificationFVO regex(@Nullable String regex) {
    this.regex = regex;
    return this;
  }
  ...
  public CharacteristicSpecificationFVO extensible(@Nullable Boolean extensible) {
  ...
  public CharacteristicSpecificationFVO atValueSchemaLocation(@Nullable String atValueSchemaLocation) {
  ...
  public CharacteristicSpecificationFVO charSpecRelationship(List<CharacteristicSpecificationRelationshipFVO> charSpecRelationship) {
    this.charSpecRelationship = charSpecRelationship;
    return this;
  }

  public CharacteristicSpecificationFVO addCharSpecRelationshipItem(CharacteristicSpecificationRelationshipFVO charSpecRelationshipItem) {
  ...
  public List<CharacteristicSpecificationRelationshipFVO> getCharSpecRelationship() {
    return charSpecRelationship;
  }

  public void setCharSpecRelationship(List<CharacteristicSpecificationRelationshipFVO> charSpecRelationship) {
    this.charSpecRelationship = charSpecRelationship;
  }

  public CharacteristicSpecificationFVO characteristicValueSpecification(List<CharacteristicValueSpecificationFVO> characteristicValueSpecification) {
    this.characteristicValueSpecification = characteristicValueSpecification;
    return this;
  }

  public CharacteristicSpecificationFVO addCharacteristicValueSpecificationItem(CharacteristicValueSpecificationFVO characteristicValueSpecificationItem) {
  ...
  public List<CharacteristicValueSpecificationFVO> getCharacteristicValueSpecification() {
    return characteristicValueSpecification;
  }

  public void setCharacteristicValueSpecification(List<CharacteristicValueSpecificationFVO> characteristicValueSpecification) {
    this.characteristicValueSpecification = characteristicValueSpecification;
  }
  ...
  public boolean equals(Object o) {
    ...
    CharacteristicSpecificationFVO characteristicSpecificationFVO = (CharacteristicSpecificationFVO) o;
    return Objects.equals(this.atType, characteristicSpecificationFVO.atType) &&
        Objects.equals(this.atBaseType, characteristicSpecificationFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, characteristicSpecificationFVO.atSchemaLocation) &&
        Objects.equals(this.id, characteristicSpecificationFVO.id) &&
        Objects.equals(this.name, characteristicSpecificationFVO.name) &&
        Objects.equals(this.valueType, characteristicSpecificationFVO.valueType) &&
        Objects.equals(this.description, characteristicSpecificationFVO.description) &&
        Objects.equals(this.configurable, characteristicSpecificationFVO.configurable) &&
        Objects.equals(this.validFor, characteristicSpecificationFVO.validFor) &&
        Objects.equals(this.minCardinality, characteristicSpecificationFVO.minCardinality) &&
        Objects.equals(this.maxCardinality, characteristicSpecificationFVO.maxCardinality) &&
        Objects.equals(this.isUnique, characteristicSpecificationFVO.isUnique) &&
        Objects.equals(this.regex, characteristicSpecificationFVO.regex) &&
        Objects.equals(this.extensible, characteristicSpecificationFVO.extensible) &&
        Objects.equals(this.atValueSchemaLocation, characteristicSpecificationFVO.atValueSchemaLocation) &&
        Objects.equals(this.charSpecRelationship, characteristicSpecificationFVO.charSpecRelationship) &&
        Objects.equals(this.characteristicValueSpecification, characteristicSpecificationFVO.characteristicValueSpecification);
  }
  ...
  public String toString() {
    ...
    sb.append("class CharacteristicSpecificationFVO {\n");
