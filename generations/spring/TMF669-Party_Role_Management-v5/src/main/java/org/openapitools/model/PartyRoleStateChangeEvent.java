...
public class PartyRoleStateChangeEvent {
  ...
  public PartyRoleStateChangeEvent() {
    super();
  }
   ...
   */
  public PartyRoleStateChangeEvent(String atType) {
    this.atType = atType;
  }

  public PartyRoleStateChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public PartyRoleStateChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public PartyRoleStateChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PartyRoleStateChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PartyRoleStateChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PartyRoleStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public PartyRoleStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public PartyRoleStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public PartyRoleStateChangeEvent description(@Nullable String description) {
  ...
  public PartyRoleStateChangeEvent priority(@Nullable String priority) {
  ...
  public PartyRoleStateChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public PartyRoleStateChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public PartyRoleStateChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public PartyRoleStateChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public PartyRoleStateChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public PartyRoleStateChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public PartyRoleStateChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public PartyRoleStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public PartyRoleStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public PartyRoleStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public PartyRoleStateChangeEvent event(@Nullable PartyRoleStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable PartyRoleStateChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable PartyRoleStateChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, partyRoleStateChangeEvent.atType) &&
        Objects.equals(this.atBaseType, partyRoleStateChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, partyRoleStateChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, partyRoleStateChangeEvent.href) &&
        Objects.equals(this.id, partyRoleStateChangeEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, partyRoleStateChangeEvent.timeOccurred) &&
        Objects.equals(this.source, partyRoleStateChangeEvent.source) &&
        Objects.equals(this.reportingSystem, partyRoleStateChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, partyRoleStateChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, partyRoleStateChangeEvent.analyticCharacteristic) &&
