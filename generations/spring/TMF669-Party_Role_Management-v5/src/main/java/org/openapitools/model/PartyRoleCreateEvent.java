...
import org.openapitools.model.PartyRoleCreateEventPayload;
...
public class PartyRoleCreateEvent {
  ...
  private @Nullable PartyRoleCreateEventPayload event;
   ...
   */
  public PartyRoleCreateEvent(String atType) {
    this.atType = atType;
  }

  public PartyRoleCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public PartyRoleCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public PartyRoleCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PartyRoleCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PartyRoleCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PartyRoleCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public PartyRoleCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public PartyRoleCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public PartyRoleCreateEvent description(@Nullable String description) {
  ...
  public PartyRoleCreateEvent priority(@Nullable String priority) {
  ...
  public PartyRoleCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public PartyRoleCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public PartyRoleCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public PartyRoleCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public PartyRoleCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public PartyRoleCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public PartyRoleCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public PartyRoleCreateEvent eventId(@Nullable String eventId) {
  ...
  public PartyRoleCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public PartyRoleCreateEvent eventType(@Nullable String eventType) {
  ...
  public PartyRoleCreateEvent event(@Nullable PartyRoleCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable PartyRoleCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable PartyRoleCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    PartyRoleCreateEvent partyRoleCreateEvent = (PartyRoleCreateEvent) o;
    return Objects.equals(this.atType, partyRoleCreateEvent.atType) &&
        Objects.equals(this.atBaseType, partyRoleCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, partyRoleCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, partyRoleCreateEvent.href) &&
        Objects.equals(this.id, partyRoleCreateEvent.id) &&
        Objects.equals(this.correlationId, partyRoleCreateEvent.correlationId) &&
        Objects.equals(this.domain, partyRoleCreateEvent.domain) &&
        Objects.equals(this.title, partyRoleCreateEvent.title) &&
        Objects.equals(this.description, partyRoleCreateEvent.description) &&
        Objects.equals(this.priority, partyRoleCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, partyRoleCreateEvent.timeOccurred) &&
        Objects.equals(this.source, partyRoleCreateEvent.source) &&
        Objects.equals(this.reportingSystem, partyRoleCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, partyRoleCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, partyRoleCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, partyRoleCreateEvent.eventId) &&
        Objects.equals(this.eventTime, partyRoleCreateEvent.eventTime) &&
        Objects.equals(this.eventType, partyRoleCreateEvent.eventType) &&
        Objects.equals(this.event, partyRoleCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class PartyRoleCreateEvent {\n");
