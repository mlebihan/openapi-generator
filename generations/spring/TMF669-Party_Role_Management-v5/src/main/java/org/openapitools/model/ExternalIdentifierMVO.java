...
public class ExternalIdentifierMVO {
  ...
  private @Nullable String externalIdentifierType;
  ...
  public ExternalIdentifierMVO atBaseType(@Nullable String atBaseType) {
  ...
  public ExternalIdentifierMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ExternalIdentifierMVO owner(@Nullable String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public ExternalIdentifierMVO externalIdentifierType(@Nullable String externalIdentifierType) {
  ...
  public @Nullable String getExternalIdentifierType() {
    return externalIdentifierType;
  }

  public void setExternalIdentifierType(@Nullable String externalIdentifierType) {
    this.externalIdentifierType = externalIdentifierType;
  }

  public ExternalIdentifierMVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
