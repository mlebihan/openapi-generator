...
import org.openapitools.model.EntityRefFVO;
...
public class EventFVO {
  ...
  private @Nullable EntityRefFVO source;

  private @Nullable EntityRefFVO reportingSystem;

  @Valid
  private List<RelatedPartyRefOrPartyRoleRefFVO> relatedParty = new ArrayList<>();

  @Valid
  private List<CharacteristicFVO> analyticCharacteristic = new ArrayList<>();
   ...
   */
  public EventFVO(String atType, String eventId, OffsetDateTime eventTime, String eventType, Object event) {
    this.atType = atType;
  ...
  public EventFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public EventFVO atBaseType(@Nullable String atBaseType) {
  ...
  public EventFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public EventFVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public EventFVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public EventFVO correlationId(@Nullable String correlationId) {
  ...
  public EventFVO domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public EventFVO title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public EventFVO description(@Nullable String description) {
  ...
  public EventFVO priority(@Nullable String priority) {
  ...
  public EventFVO timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public EventFVO source(@Nullable EntityRefFVO source) {
    this.source = source;
    return this;
  }
  ...
  @JsonProperty("source")
  public @Nullable EntityRefFVO getSource() {
    return source;
  }

  public void setSource(@Nullable EntityRefFVO source) {
    this.source = source;
  }

  public EventFVO reportingSystem(@Nullable EntityRefFVO reportingSystem) {
  ...
  public @Nullable EntityRefFVO getReportingSystem() {
    return reportingSystem;
  }

  public void setReportingSystem(@Nullable EntityRefFVO reportingSystem) {
    this.reportingSystem = reportingSystem;
  }

  public EventFVO relatedParty(List<RelatedPartyRefOrPartyRoleRefFVO> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public EventFVO addRelatedPartyItem(RelatedPartyRefOrPartyRoleRefFVO relatedPartyItem) {
  ...
  public EventFVO analyticCharacteristic(List<CharacteristicFVO> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public EventFVO addAnalyticCharacteristicItem(CharacteristicFVO analyticCharacteristicItem) {
  ...
  public List<CharacteristicFVO> getAnalyticCharacteristic() {
    return analyticCharacteristic;
  }

  public void setAnalyticCharacteristic(List<CharacteristicFVO> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
  }

  public EventFVO eventId(String eventId) {
    this.eventId = eventId;
    return this;
  }
  ...
  public EventFVO eventTime(OffsetDateTime eventTime) {
    this.eventTime = eventTime;
    return this;
  }
  ...
  public EventFVO eventType(String eventType) {
    this.eventType = eventType;
    return this;
  }
  ...
  public EventFVO event(Object event) {
    this.event = event;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EventFVO eventFVO = (EventFVO) o;
    return Objects.equals(this.atType, eventFVO.atType) &&
        Objects.equals(this.atBaseType, eventFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, eventFVO.atSchemaLocation) &&
        Objects.equals(this.href, eventFVO.href) &&
        Objects.equals(this.id, eventFVO.id) &&
        Objects.equals(this.correlationId, eventFVO.correlationId) &&
        Objects.equals(this.domain, eventFVO.domain) &&
        Objects.equals(this.title, eventFVO.title) &&
        Objects.equals(this.description, eventFVO.description) &&
        Objects.equals(this.priority, eventFVO.priority) &&
        Objects.equals(this.timeOccurred, eventFVO.timeOccurred) &&
        Objects.equals(this.source, eventFVO.source) &&
        Objects.equals(this.reportingSystem, eventFVO.reportingSystem) &&
        Objects.equals(this.relatedParty, eventFVO.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, eventFVO.analyticCharacteristic) &&
        Objects.equals(this.eventId, eventFVO.eventId) &&
        Objects.equals(this.eventTime, eventFVO.eventTime) &&
        Objects.equals(this.eventType, eventFVO.eventType) &&
        Objects.equals(this.event, eventFVO.event);
  }
