...
/**
 * PartyRoleDeleteEventPayload generic structure
 */

@Schema(name = "PartyRoleDeleteEventPayload", description = "PartyRoleDeleteEventPayload generic structure")
...
public class PartyRoleDeleteEventPayload {
  ...
  public PartyRoleDeleteEventPayload partyRole(@Nullable PartyRole partyRole) {
