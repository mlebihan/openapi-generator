...
/**
 * PartyRoleCreateEventPayload generic structure
 */

@Schema(name = "PartyRoleCreateEventPayload", description = "PartyRoleCreateEventPayload generic structure")
...
public class PartyRoleCreateEventPayload {
  ...
  public PartyRoleCreateEventPayload partyRole(@Nullable PartyRole partyRole) {
