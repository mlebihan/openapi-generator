...
/**
 * PartyRoleStateChangeEventPayload generic structure
 */

@Schema(name = "PartyRoleStateChangeEventPayload", description = "PartyRoleStateChangeEventPayload generic structure")
...
public class PartyRoleStateChangeEventPayload {
  ...
  public PartyRoleStateChangeEventPayload partyRole(@Nullable PartyRole partyRole) {
