...
public class OrganizationIdentificationFVO {
  ...
  public OrganizationIdentificationFVO atBaseType(@Nullable String atBaseType) {
  ...
  public OrganizationIdentificationFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public OrganizationIdentificationFVO identificationId(@Nullable String identificationId) {
  ...
  public OrganizationIdentificationFVO issuingAuthority(@Nullable String issuingAuthority) {
  ...
  public OrganizationIdentificationFVO issuingDate(@Nullable OffsetDateTime issuingDate) {
  ...
  public OrganizationIdentificationFVO identificationType(@Nullable String identificationType) {
  ...
  public OrganizationIdentificationFVO validFor(@Nullable TimePeriod validFor) {
  ...
  public OrganizationIdentificationFVO attachment(@Nullable AttachmentRefOrValueFVO attachment) {
