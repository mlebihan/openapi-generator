...
import org.openapitools.model.CheckCredentialStateChangeEventPayload;
...
/**
 * CheckCredentialStateChangeEvent
 */
...
public class CheckCredentialStateChangeEvent {
  ...
  private @Nullable CheckCredentialStateChangeEventPayload event;

  public CheckCredentialStateChangeEvent() {
    super();
  }
   ...
   */
  public CheckCredentialStateChangeEvent(String atType) {
    this.atType = atType;
  }

  public CheckCredentialStateChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public CheckCredentialStateChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public CheckCredentialStateChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CheckCredentialStateChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CheckCredentialStateChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CheckCredentialStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public CheckCredentialStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CheckCredentialStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CheckCredentialStateChangeEvent description(@Nullable String description) {
  ...
  public CheckCredentialStateChangeEvent priority(@Nullable String priority) {
  ...
  public CheckCredentialStateChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public CheckCredentialStateChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public CheckCredentialStateChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public CheckCredentialStateChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public CheckCredentialStateChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public CheckCredentialStateChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public CheckCredentialStateChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public CheckCredentialStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public CheckCredentialStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public CheckCredentialStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public CheckCredentialStateChangeEvent event(@Nullable CheckCredentialStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable CheckCredentialStateChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable CheckCredentialStateChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckCredentialStateChangeEvent checkCredentialStateChangeEvent = (CheckCredentialStateChangeEvent) o;
    return Objects.equals(this.atType, checkCredentialStateChangeEvent.atType) &&
        Objects.equals(this.atBaseType, checkCredentialStateChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, checkCredentialStateChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, checkCredentialStateChangeEvent.href) &&
        Objects.equals(this.id, checkCredentialStateChangeEvent.id) &&
        Objects.equals(this.correlationId, checkCredentialStateChangeEvent.correlationId) &&
        Objects.equals(this.domain, checkCredentialStateChangeEvent.domain) &&
        Objects.equals(this.title, checkCredentialStateChangeEvent.title) &&
        Objects.equals(this.description, checkCredentialStateChangeEvent.description) &&
        Objects.equals(this.priority, checkCredentialStateChangeEvent.priority) &&
        Objects.equals(this.timeOccurred, checkCredentialStateChangeEvent.timeOccurred) &&
        Objects.equals(this.source, checkCredentialStateChangeEvent.source) &&
        Objects.equals(this.reportingSystem, checkCredentialStateChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, checkCredentialStateChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, checkCredentialStateChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, checkCredentialStateChangeEvent.eventId) &&
        Objects.equals(this.eventTime, checkCredentialStateChangeEvent.eventTime) &&
        Objects.equals(this.eventType, checkCredentialStateChangeEvent.eventType) &&
        Objects.equals(this.event, checkCredentialStateChangeEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class CheckCredentialStateChangeEvent {\n");
