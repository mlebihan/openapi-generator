...
public class PartyRef implements PartyRefOrPartyRoleRef, SecurityPrincipalRef {
   ...
   */
  public PartyRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }

  public PartyRef atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public PartyRef atBaseType(@Nullable String atBaseType) {
  ...
  public PartyRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PartyRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PartyRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PartyRef atReferredType(@Nullable String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, partyRef.atType) &&
        Objects.equals(this.atBaseType, partyRef.atBaseType) &&
        Objects.equals(this.atSchemaLocation, partyRef.atSchemaLocation) &&
        Objects.equals(this.href, partyRef.href) &&
        Objects.equals(this.id, partyRef.id) &&
        Objects.equals(this.name, partyRef.name) &&
        Objects.equals(this.atReferredType, partyRef.atReferredType);
  }
