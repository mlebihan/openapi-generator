...
public class AttachmentRef implements AttachmentRefOrValue, AttachmentRefOrValueFVO {
  ...
  public AttachmentRef atBaseType(@Nullable String atBaseType) {
  ...
  public AttachmentRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public AttachmentRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public AttachmentRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AttachmentRef atReferredType(@Nullable String atReferredType) {
  ...
  public AttachmentRef description(@Nullable String description) {
  ...
  public AttachmentRef url(@Nullable String url) {
    this.url = url;
    return this;
  }
