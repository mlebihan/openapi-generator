...
import org.openapitools.model.DigitalIdentityStateChangeEventPayload;
...
public class DigitalIdentityStateChangeEvent {
  ...
  private @Nullable DigitalIdentityStateChangeEventPayload event;

  public DigitalIdentityStateChangeEvent() {
    super();
  }
   ...
   */
  public DigitalIdentityStateChangeEvent(String atType) {
    this.atType = atType;
  }

  public DigitalIdentityStateChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public DigitalIdentityStateChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public DigitalIdentityStateChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public DigitalIdentityStateChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public DigitalIdentityStateChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public DigitalIdentityStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public DigitalIdentityStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public DigitalIdentityStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public DigitalIdentityStateChangeEvent description(@Nullable String description) {
  ...
  public DigitalIdentityStateChangeEvent priority(@Nullable String priority) {
  ...
  public DigitalIdentityStateChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public DigitalIdentityStateChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public DigitalIdentityStateChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public DigitalIdentityStateChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public DigitalIdentityStateChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public DigitalIdentityStateChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public DigitalIdentityStateChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public DigitalIdentityStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public DigitalIdentityStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public DigitalIdentityStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public DigitalIdentityStateChangeEvent event(@Nullable DigitalIdentityStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable DigitalIdentityStateChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable DigitalIdentityStateChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    DigitalIdentityStateChangeEvent digitalIdentityStateChangeEvent = (DigitalIdentityStateChangeEvent) o;
    return Objects.equals(this.atType, digitalIdentityStateChangeEvent.atType) &&
        Objects.equals(this.atBaseType, digitalIdentityStateChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, digitalIdentityStateChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, digitalIdentityStateChangeEvent.href) &&
        Objects.equals(this.id, digitalIdentityStateChangeEvent.id) &&
        Objects.equals(this.correlationId, digitalIdentityStateChangeEvent.correlationId) &&
        Objects.equals(this.domain, digitalIdentityStateChangeEvent.domain) &&
        Objects.equals(this.title, digitalIdentityStateChangeEvent.title) &&
        Objects.equals(this.description, digitalIdentityStateChangeEvent.description) &&
        Objects.equals(this.priority, digitalIdentityStateChangeEvent.priority) &&
        Objects.equals(this.timeOccurred, digitalIdentityStateChangeEvent.timeOccurred) &&
        Objects.equals(this.source, digitalIdentityStateChangeEvent.source) &&
        Objects.equals(this.reportingSystem, digitalIdentityStateChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, digitalIdentityStateChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, digitalIdentityStateChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, digitalIdentityStateChangeEvent.eventId) &&
        Objects.equals(this.eventTime, digitalIdentityStateChangeEvent.eventTime) &&
        Objects.equals(this.eventType, digitalIdentityStateChangeEvent.eventType) &&
        Objects.equals(this.event, digitalIdentityStateChangeEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class DigitalIdentityStateChangeEvent {\n");
