...
/**
 * DigitalIdentityDeleteEventPayload generic structure
 */

@Schema(name = "DigitalIdentityDeleteEventPayload", description = "DigitalIdentityDeleteEventPayload generic structure")
...
public class DigitalIdentityDeleteEventPayload {

  private @Nullable DigitalIdentity digitalIdentity;

  public DigitalIdentityDeleteEventPayload digitalIdentity(@Nullable DigitalIdentity digitalIdentity) {
  ...
  public boolean equals(Object o) {
    ...
    DigitalIdentityDeleteEventPayload digitalIdentityDeleteEventPayload = (DigitalIdentityDeleteEventPayload) o;
    return Objects.equals(this.digitalIdentity, digitalIdentityDeleteEventPayload.digitalIdentity);
  }
  ...
  public String toString() {
    ...
    sb.append("class DigitalIdentityDeleteEventPayload {\n");
