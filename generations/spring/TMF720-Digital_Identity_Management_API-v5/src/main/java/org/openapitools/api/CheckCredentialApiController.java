...
import org.openapitools.model.CheckCredentialFVO;
import org.openapitools.model.CheckCredentialRES;
...
public class CheckCredentialApiController implements CheckCredentialApi {

    private final NativeWebRequest request;

    @Autowired
    public CheckCredentialApiController(NativeWebRequest request) {
