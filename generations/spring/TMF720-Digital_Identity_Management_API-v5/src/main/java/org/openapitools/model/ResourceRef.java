...
public class ResourceRef implements SecurityPrincipalRef {
   ...
   */
  public ResourceRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }
  ...
  public ResourceRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, resourceRef.atType) &&
