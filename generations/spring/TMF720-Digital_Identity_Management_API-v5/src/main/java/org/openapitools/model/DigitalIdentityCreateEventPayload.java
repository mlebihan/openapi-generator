...
/**
 * DigitalIdentityCreateEventPayload generic structure
 */

@Schema(name = "DigitalIdentityCreateEventPayload", description = "DigitalIdentityCreateEventPayload generic structure")
...
public class DigitalIdentityCreateEventPayload {

  private @Nullable DigitalIdentity digitalIdentity;

  public DigitalIdentityCreateEventPayload digitalIdentity(@Nullable DigitalIdentity digitalIdentity) {
  ...
  public boolean equals(Object o) {
    ...
    DigitalIdentityCreateEventPayload digitalIdentityCreateEventPayload = (DigitalIdentityCreateEventPayload) o;
    return Objects.equals(this.digitalIdentity, digitalIdentityCreateEventPayload.digitalIdentity);
  }
  ...
  public String toString() {
    ...
    sb.append("class DigitalIdentityCreateEventPayload {\n");
