...
import org.openapitools.model.CredentialStateChangeEventPayload;
...
public class CredentialStateChangeEvent {
  ...
  private @Nullable CredentialStateChangeEventPayload event;

  public CredentialStateChangeEvent() {
    super();
  }
   ...
   */
  public CredentialStateChangeEvent(String atType) {
    this.atType = atType;
  }

  public CredentialStateChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public CredentialStateChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public CredentialStateChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CredentialStateChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CredentialStateChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CredentialStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public CredentialStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CredentialStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CredentialStateChangeEvent description(@Nullable String description) {
  ...
  public CredentialStateChangeEvent priority(@Nullable String priority) {
  ...
  public CredentialStateChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public CredentialStateChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public CredentialStateChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public CredentialStateChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public CredentialStateChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public CredentialStateChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public CredentialStateChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public CredentialStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public CredentialStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public CredentialStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public CredentialStateChangeEvent event(@Nullable CredentialStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable CredentialStateChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable CredentialStateChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    CredentialStateChangeEvent credentialStateChangeEvent = (CredentialStateChangeEvent) o;
    return Objects.equals(this.atType, credentialStateChangeEvent.atType) &&
        Objects.equals(this.atBaseType, credentialStateChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, credentialStateChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, credentialStateChangeEvent.href) &&
        Objects.equals(this.id, credentialStateChangeEvent.id) &&
        Objects.equals(this.correlationId, credentialStateChangeEvent.correlationId) &&
        Objects.equals(this.domain, credentialStateChangeEvent.domain) &&
        Objects.equals(this.title, credentialStateChangeEvent.title) &&
        Objects.equals(this.description, credentialStateChangeEvent.description) &&
        Objects.equals(this.priority, credentialStateChangeEvent.priority) &&
        Objects.equals(this.timeOccurred, credentialStateChangeEvent.timeOccurred) &&
        Objects.equals(this.source, credentialStateChangeEvent.source) &&
        Objects.equals(this.reportingSystem, credentialStateChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, credentialStateChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, credentialStateChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, credentialStateChangeEvent.eventId) &&
        Objects.equals(this.eventTime, credentialStateChangeEvent.eventTime) &&
        Objects.equals(this.eventType, credentialStateChangeEvent.eventType) &&
        Objects.equals(this.event, credentialStateChangeEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class CredentialStateChangeEvent {\n");
