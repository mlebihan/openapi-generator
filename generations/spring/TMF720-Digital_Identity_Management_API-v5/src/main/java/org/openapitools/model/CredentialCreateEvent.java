...
import org.openapitools.model.CredentialCreateEventPayload;
...
public class CredentialCreateEvent {
  ...
  private @Nullable CredentialCreateEventPayload event;

  public CredentialCreateEvent() {
    super();
  }
   ...
   */
  public CredentialCreateEvent(String atType) {
    this.atType = atType;
  }

  public CredentialCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public CredentialCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public CredentialCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CredentialCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CredentialCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CredentialCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public CredentialCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CredentialCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CredentialCreateEvent description(@Nullable String description) {
  ...
  public CredentialCreateEvent priority(@Nullable String priority) {
  ...
  public CredentialCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public CredentialCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public CredentialCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public CredentialCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public CredentialCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public CredentialCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public CredentialCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public CredentialCreateEvent eventId(@Nullable String eventId) {
  ...
  public CredentialCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public CredentialCreateEvent eventType(@Nullable String eventType) {
  ...
  public CredentialCreateEvent event(@Nullable CredentialCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable CredentialCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable CredentialCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    CredentialCreateEvent credentialCreateEvent = (CredentialCreateEvent) o;
    return Objects.equals(this.atType, credentialCreateEvent.atType) &&
        Objects.equals(this.atBaseType, credentialCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, credentialCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, credentialCreateEvent.href) &&
        Objects.equals(this.id, credentialCreateEvent.id) &&
        Objects.equals(this.correlationId, credentialCreateEvent.correlationId) &&
        Objects.equals(this.domain, credentialCreateEvent.domain) &&
        Objects.equals(this.title, credentialCreateEvent.title) &&
        Objects.equals(this.description, credentialCreateEvent.description) &&
        Objects.equals(this.priority, credentialCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, credentialCreateEvent.timeOccurred) &&
        Objects.equals(this.source, credentialCreateEvent.source) &&
        Objects.equals(this.reportingSystem, credentialCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, credentialCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, credentialCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, credentialCreateEvent.eventId) &&
        Objects.equals(this.eventTime, credentialCreateEvent.eventTime) &&
        Objects.equals(this.eventType, credentialCreateEvent.eventType) &&
        Objects.equals(this.event, credentialCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class CredentialCreateEvent {\n");
