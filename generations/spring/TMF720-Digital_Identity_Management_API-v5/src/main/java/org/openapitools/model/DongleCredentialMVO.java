...
public class DongleCredentialMVO extends CredentialMVO {
   ...
   */
  public DongleCredentialMVO(String atType) {
    super(atType);
  }

  public DongleCredentialMVO securityKeyId(@Nullable String securityKeyId) {
  ...
  public DongleCredentialMVO securityKeyType(@Nullable String securityKeyType) {
  ...
  public DongleCredentialMVO securityKeyProvider(@Nullable String securityKeyProvider) {
  ...
  public DongleCredentialMVO atType(String atType) {
    super.atType(atType);
    return this;
  }

  public DongleCredentialMVO atBaseType(String atBaseType) {
    super.atBaseType(atBaseType);
    return this;
  }

  public DongleCredentialMVO atSchemaLocation(String atSchemaLocation) {
    super.atSchemaLocation(atSchemaLocation);
    return this;
  }

  public DongleCredentialMVO href(String href) {
    super.href(href);
    return this;
  }

  public DongleCredentialMVO id(String id) {
    super.id(id);
    return this;
  }

  public DongleCredentialMVO relatedContactMedium(List<RelatedContactMedium> relatedContactMedium) {
    super.relatedContactMedium(relatedContactMedium);
    return this;
  }

  public DongleCredentialMVO addRelatedContactMediumItem(RelatedContactMedium relatedContactMediumItem) {
    super.addRelatedContactMediumItem(relatedContactMediumItem);
    return this;
  }

  public DongleCredentialMVO digitalIdentity(DigitalIdentityRef digitalIdentity) {
    super.digitalIdentity(digitalIdentity);
    return this;
  }

  public DongleCredentialMVO lastUpdate(OffsetDateTime lastUpdate) {
  ...
  public boolean equals(Object o) {
    ...
    DongleCredentialMVO dongleCredentialMVO = (DongleCredentialMVO) o;
    return Objects.equals(this.securityKeyId, dongleCredentialMVO.securityKeyId) &&
        Objects.equals(this.securityKeyType, dongleCredentialMVO.securityKeyType) &&
        Objects.equals(this.securityKeyProvider, dongleCredentialMVO.securityKeyProvider) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class DongleCredentialMVO {\n");
