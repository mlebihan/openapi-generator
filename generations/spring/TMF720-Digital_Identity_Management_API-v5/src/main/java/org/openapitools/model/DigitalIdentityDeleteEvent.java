...
import org.openapitools.model.DigitalIdentityDeleteEventPayload;
...
public class DigitalIdentityDeleteEvent {
  ...
  private @Nullable DigitalIdentityDeleteEventPayload event;

  public DigitalIdentityDeleteEvent() {
    super();
  }
   ...
   */
  public DigitalIdentityDeleteEvent(String atType) {
    this.atType = atType;
  }

  public DigitalIdentityDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public DigitalIdentityDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public DigitalIdentityDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public DigitalIdentityDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public DigitalIdentityDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public DigitalIdentityDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public DigitalIdentityDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public DigitalIdentityDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public DigitalIdentityDeleteEvent description(@Nullable String description) {
  ...
  public DigitalIdentityDeleteEvent priority(@Nullable String priority) {
  ...
  public DigitalIdentityDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public DigitalIdentityDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public DigitalIdentityDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public DigitalIdentityDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public DigitalIdentityDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public DigitalIdentityDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public DigitalIdentityDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public DigitalIdentityDeleteEvent eventId(@Nullable String eventId) {
  ...
  public DigitalIdentityDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public DigitalIdentityDeleteEvent eventType(@Nullable String eventType) {
  ...
  public DigitalIdentityDeleteEvent event(@Nullable DigitalIdentityDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable DigitalIdentityDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable DigitalIdentityDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    DigitalIdentityDeleteEvent digitalIdentityDeleteEvent = (DigitalIdentityDeleteEvent) o;
    return Objects.equals(this.atType, digitalIdentityDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, digitalIdentityDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, digitalIdentityDeleteEvent.atSchemaLocation) &&
        Objects.equals(this.href, digitalIdentityDeleteEvent.href) &&
        Objects.equals(this.id, digitalIdentityDeleteEvent.id) &&
        Objects.equals(this.correlationId, digitalIdentityDeleteEvent.correlationId) &&
        Objects.equals(this.domain, digitalIdentityDeleteEvent.domain) &&
        Objects.equals(this.title, digitalIdentityDeleteEvent.title) &&
        Objects.equals(this.description, digitalIdentityDeleteEvent.description) &&
        Objects.equals(this.priority, digitalIdentityDeleteEvent.priority) &&
        Objects.equals(this.timeOccurred, digitalIdentityDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, digitalIdentityDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, digitalIdentityDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, digitalIdentityDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, digitalIdentityDeleteEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, digitalIdentityDeleteEvent.eventId) &&
        Objects.equals(this.eventTime, digitalIdentityDeleteEvent.eventTime) &&
        Objects.equals(this.eventType, digitalIdentityDeleteEvent.eventType) &&
        Objects.equals(this.event, digitalIdentityDeleteEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class DigitalIdentityDeleteEvent {\n");
