...
import org.openapitools.model.CredentialDeleteEventPayload;
...
public class CredentialDeleteEvent {
  ...
  private @Nullable CredentialDeleteEventPayload event;

  public CredentialDeleteEvent() {
    super();
  }
   ...
   */
  public CredentialDeleteEvent(String atType) {
    this.atType = atType;
  }

  public CredentialDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public CredentialDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public CredentialDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CredentialDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CredentialDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CredentialDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public CredentialDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CredentialDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CredentialDeleteEvent description(@Nullable String description) {
  ...
  public CredentialDeleteEvent priority(@Nullable String priority) {
  ...
  public CredentialDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public CredentialDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public CredentialDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public CredentialDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public CredentialDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public CredentialDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public CredentialDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public CredentialDeleteEvent eventId(@Nullable String eventId) {
  ...
  public CredentialDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public CredentialDeleteEvent eventType(@Nullable String eventType) {
  ...
  public CredentialDeleteEvent event(@Nullable CredentialDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable CredentialDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable CredentialDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    CredentialDeleteEvent credentialDeleteEvent = (CredentialDeleteEvent) o;
    return Objects.equals(this.atType, credentialDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, credentialDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, credentialDeleteEvent.atSchemaLocation) &&
        Objects.equals(this.href, credentialDeleteEvent.href) &&
        Objects.equals(this.id, credentialDeleteEvent.id) &&
        Objects.equals(this.correlationId, credentialDeleteEvent.correlationId) &&
        Objects.equals(this.domain, credentialDeleteEvent.domain) &&
        Objects.equals(this.title, credentialDeleteEvent.title) &&
        Objects.equals(this.description, credentialDeleteEvent.description) &&
        Objects.equals(this.priority, credentialDeleteEvent.priority) &&
        Objects.equals(this.timeOccurred, credentialDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, credentialDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, credentialDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, credentialDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, credentialDeleteEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, credentialDeleteEvent.eventId) &&
        Objects.equals(this.eventTime, credentialDeleteEvent.eventTime) &&
        Objects.equals(this.eventType, credentialDeleteEvent.eventType) &&
        Objects.equals(this.event, credentialDeleteEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class CredentialDeleteEvent {\n");
