...
import org.openapitools.model.CheckCredentialCreateEventPayload;
...
public class CheckCredentialCreateEvent {
  ...
  private @Nullable CheckCredentialCreateEventPayload event;

  public CheckCredentialCreateEvent() {
    super();
  }
   ...
   */
  public CheckCredentialCreateEvent(String atType) {
    this.atType = atType;
  }

  public CheckCredentialCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public CheckCredentialCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public CheckCredentialCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CheckCredentialCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CheckCredentialCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CheckCredentialCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public CheckCredentialCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CheckCredentialCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CheckCredentialCreateEvent description(@Nullable String description) {
  ...
  public CheckCredentialCreateEvent priority(@Nullable String priority) {
  ...
  public CheckCredentialCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public CheckCredentialCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public CheckCredentialCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public CheckCredentialCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public CheckCredentialCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public CheckCredentialCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public CheckCredentialCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public CheckCredentialCreateEvent eventId(@Nullable String eventId) {
  ...
  public CheckCredentialCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public CheckCredentialCreateEvent eventType(@Nullable String eventType) {
  ...
  public CheckCredentialCreateEvent event(@Nullable CheckCredentialCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable CheckCredentialCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable CheckCredentialCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckCredentialCreateEvent checkCredentialCreateEvent = (CheckCredentialCreateEvent) o;
    return Objects.equals(this.atType, checkCredentialCreateEvent.atType) &&
        Objects.equals(this.atBaseType, checkCredentialCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, checkCredentialCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, checkCredentialCreateEvent.href) &&
        Objects.equals(this.id, checkCredentialCreateEvent.id) &&
        Objects.equals(this.correlationId, checkCredentialCreateEvent.correlationId) &&
        Objects.equals(this.domain, checkCredentialCreateEvent.domain) &&
        Objects.equals(this.title, checkCredentialCreateEvent.title) &&
        Objects.equals(this.description, checkCredentialCreateEvent.description) &&
        Objects.equals(this.priority, checkCredentialCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, checkCredentialCreateEvent.timeOccurred) &&
        Objects.equals(this.source, checkCredentialCreateEvent.source) &&
        Objects.equals(this.reportingSystem, checkCredentialCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, checkCredentialCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, checkCredentialCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, checkCredentialCreateEvent.eventId) &&
        Objects.equals(this.eventTime, checkCredentialCreateEvent.eventTime) &&
        Objects.equals(this.eventType, checkCredentialCreateEvent.eventType) &&
        Objects.equals(this.event, checkCredentialCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class CheckCredentialCreateEvent {\n");
