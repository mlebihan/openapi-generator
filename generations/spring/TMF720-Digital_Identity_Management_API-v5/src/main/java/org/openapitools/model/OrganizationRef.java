...
public class OrganizationRef implements SecurityPrincipalRef {
  ...
  public OrganizationRef atBaseType(@Nullable String atBaseType) {
  ...
  public OrganizationRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public OrganizationRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public OrganizationRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OrganizationRef atReferredType(@Nullable String atReferredType) {
