...
public class RelatedResourceOrderItemMVO {
  ...
  public RelatedResourceOrderItemMVO() {
    super();
  }
   ...
   */
  public RelatedResourceOrderItemMVO(String atType) {
    this.atType = atType;
  }

  public RelatedResourceOrderItemMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public RelatedResourceOrderItemMVO atBaseType(@Nullable String atBaseType) {
  ...
  public RelatedResourceOrderItemMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public RelatedResourceOrderItemMVO atReferredType(@Nullable String atReferredType) {
  ...
  public RelatedResourceOrderItemMVO resourceOrderHref(@Nullable String resourceOrderHref) {
  ...
  public RelatedResourceOrderItemMVO resourceOrderId(@Nullable String resourceOrderId) {
  ...
  public RelatedResourceOrderItemMVO itemAction(@Nullable OrderItemActionType itemAction) {
  ...
  public RelatedResourceOrderItemMVO itemId(@Nullable String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public RelatedResourceOrderItemMVO role(@Nullable String role) {
    this.role = role;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RelatedResourceOrderItemMVO relatedResourceOrderItemMVO = (RelatedResourceOrderItemMVO) o;
    return Objects.equals(this.atType, relatedResourceOrderItemMVO.atType) &&
        Objects.equals(this.atBaseType, relatedResourceOrderItemMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, relatedResourceOrderItemMVO.atSchemaLocation) &&
        Objects.equals(this.atReferredType, relatedResourceOrderItemMVO.atReferredType) &&
        Objects.equals(this.resourceOrderHref, relatedResourceOrderItemMVO.resourceOrderHref) &&
        Objects.equals(this.resourceOrderId, relatedResourceOrderItemMVO.resourceOrderId) &&
        Objects.equals(this.itemAction, relatedResourceOrderItemMVO.itemAction) &&
        Objects.equals(this.itemId, relatedResourceOrderItemMVO.itemId) &&
        Objects.equals(this.role, relatedResourceOrderItemMVO.role);
  }
  ...
  public String toString() {
    ...
    sb.append("class RelatedResourceOrderItemMVO {\n");
