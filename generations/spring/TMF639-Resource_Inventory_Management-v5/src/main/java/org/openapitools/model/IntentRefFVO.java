...
public class IntentRefFVO {
   ...
   */
  public IntentRefFVO(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }

  public IntentRefFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public IntentRefFVO atBaseType(@Nullable String atBaseType) {
  ...
  public IntentRefFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public IntentRefFVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public IntentRefFVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public IntentRefFVO atReferredType(@Nullable String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, intentRefFVO.atType) &&
        Objects.equals(this.atBaseType, intentRefFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, intentRefFVO.atSchemaLocation) &&
        ...
        Objects.equals(this.atReferredType, intentRefFVO.atReferredType);
  }
