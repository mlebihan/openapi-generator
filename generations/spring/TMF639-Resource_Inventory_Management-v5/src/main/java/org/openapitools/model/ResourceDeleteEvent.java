...
import org.openapitools.model.ResourceDeleteEventPayload;
...
public class ResourceDeleteEvent {
  ...
  private @Nullable ResourceDeleteEventPayload event;
   ...
   */
  public ResourceDeleteEvent(String atType) {
    this.atType = atType;
  }

  public ResourceDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ResourceDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ResourceDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public ResourceDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ResourceDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ResourceDeleteEvent description(@Nullable String description) {
  ...
  public ResourceDeleteEvent priority(@Nullable String priority) {
  ...
  public ResourceDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ResourceDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ResourceDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ResourceDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ResourceDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ResourceDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ResourceDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ResourceDeleteEvent eventId(@Nullable String eventId) {
  ...
  public ResourceDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ResourceDeleteEvent eventType(@Nullable String eventType) {
  ...
  public ResourceDeleteEvent event(@Nullable ResourceDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ResourceDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ResourceDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResourceDeleteEvent resourceDeleteEvent = (ResourceDeleteEvent) o;
    return Objects.equals(this.atType, resourceDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, resourceDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceDeleteEvent.atSchemaLocation) &&
        Objects.equals(this.href, resourceDeleteEvent.href) &&
        Objects.equals(this.id, resourceDeleteEvent.id) &&
        Objects.equals(this.correlationId, resourceDeleteEvent.correlationId) &&
        Objects.equals(this.domain, resourceDeleteEvent.domain) &&
        Objects.equals(this.title, resourceDeleteEvent.title) &&
        Objects.equals(this.description, resourceDeleteEvent.description) &&
        Objects.equals(this.priority, resourceDeleteEvent.priority) &&
        Objects.equals(this.timeOccurred, resourceDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, resourceDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, resourceDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, resourceDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, resourceDeleteEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, resourceDeleteEvent.eventId) &&
        Objects.equals(this.eventTime, resourceDeleteEvent.eventTime) &&
        Objects.equals(this.eventType, resourceDeleteEvent.eventType) &&
        Objects.equals(this.event, resourceDeleteEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceDeleteEvent {\n");
