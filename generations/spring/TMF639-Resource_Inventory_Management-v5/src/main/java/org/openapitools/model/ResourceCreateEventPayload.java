...
/**
 * ResourceCreateEventPayload generic structure
 */

@Schema(name = "ResourceCreateEventPayload", description = "ResourceCreateEventPayload generic structure")
...
public class ResourceCreateEventPayload {
  ...
  public ResourceCreateEventPayload resource(@Nullable Resource resource) {
