...
import org.openapitools.model.ResourceAttributeValueChangeEventPayload;
...
public class ResourceAttributeValueChangeEvent {
  ...
  private @Nullable ResourceAttributeValueChangeEventPayload event;

  public ResourceAttributeValueChangeEvent() {
    super();
  }
   ...
   */
  public ResourceAttributeValueChangeEvent(String atType) {
    this.atType = atType;
  }

  public ResourceAttributeValueChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ResourceAttributeValueChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceAttributeValueChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceAttributeValueChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceAttributeValueChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ResourceAttributeValueChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public ResourceAttributeValueChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ResourceAttributeValueChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ResourceAttributeValueChangeEvent description(@Nullable String description) {
  ...
  public ResourceAttributeValueChangeEvent priority(@Nullable String priority) {
  ...
  public ResourceAttributeValueChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ResourceAttributeValueChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ResourceAttributeValueChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ResourceAttributeValueChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ResourceAttributeValueChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ResourceAttributeValueChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ResourceAttributeValueChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ResourceAttributeValueChangeEvent eventId(@Nullable String eventId) {
  ...
  public ResourceAttributeValueChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ResourceAttributeValueChangeEvent eventType(@Nullable String eventType) {
  ...
  public ResourceAttributeValueChangeEvent event(@Nullable ResourceAttributeValueChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ResourceAttributeValueChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ResourceAttributeValueChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, resourceAttributeValueChangeEvent.atType) &&
        Objects.equals(this.atBaseType, resourceAttributeValueChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceAttributeValueChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, resourceAttributeValueChangeEvent.href) &&
        Objects.equals(this.id, resourceAttributeValueChangeEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, resourceAttributeValueChangeEvent.timeOccurred) &&
        Objects.equals(this.source, resourceAttributeValueChangeEvent.source) &&
        Objects.equals(this.reportingSystem, resourceAttributeValueChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, resourceAttributeValueChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, resourceAttributeValueChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, resourceAttributeValueChangeEvent.eventId) &&
