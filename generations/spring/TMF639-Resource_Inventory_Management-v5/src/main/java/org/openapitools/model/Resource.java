...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = ResourceRES.class, name = "Resource_RES")
})
...
public class Resource implements ResourceRefOrValue {
  ...
  @Valid
  private List<@Valid ResourceRefOrValue> supportingResource = new ArrayList<>();
  ...
  private @Nullable IntentRef intent;
  ...
  public Resource atBaseType(@Nullable String atBaseType) {
  ...
  public Resource atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public Resource href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public Resource id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Resource category(@Nullable String category) {
  ...
  public Resource description(@Nullable String description) {
  ...
  public Resource endOperatingDate(@Nullable OffsetDateTime endOperatingDate) {
  ...
  public Resource administrativeState(@Nullable ResourceAdministrativeStateType administrativeState) {
  ...
  public Resource operationalState(@Nullable ResourceOperationalStateType operationalState) {
  ...
  public Resource resourceStatus(@Nullable ResourceStatusType resourceStatus) {
  ...
  public Resource usageState(@Nullable ResourceUsageStateType usageState) {
  ...
  public Resource validFor(@Nullable TimePeriod validFor) {
  ...
  public Resource supportingResource(List<@Valid ResourceRefOrValue> supportingResource) {
  ...
  public List<@Valid ResourceRefOrValue> getSupportingResource() {
    return supportingResource;
  }

  public void setSupportingResource(List<@Valid ResourceRefOrValue> supportingResource) {
    this.supportingResource = supportingResource;
  }
  ...
  public Resource resourceSpecification(@Nullable ResourceSpecificationRef resourceSpecification) {
  ...
  public Resource startOperatingDate(@Nullable OffsetDateTime startOperatingDate) {
  ...
  public Resource resourceVersion(@Nullable String resourceVersion) {
  ...
  public Resource intent(@Nullable IntentRef intent) {
    this.intent = intent;
    return this;
  }
  ...
  @JsonProperty("intent")
  public @Nullable IntentRef getIntent() {
    return intent;
  }

  public void setIntent(@Nullable IntentRef intent) {
    this.intent = intent;
  }
