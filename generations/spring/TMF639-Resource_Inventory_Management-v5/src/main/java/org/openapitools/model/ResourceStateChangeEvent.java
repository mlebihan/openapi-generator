...
import org.openapitools.model.ResourceStateChangeEventPayload;
...
public class ResourceStateChangeEvent {
  ...
  private @Nullable ResourceStateChangeEventPayload event;
   ...
   */
  public ResourceStateChangeEvent(String atType) {
    this.atType = atType;
  }

  public ResourceStateChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ResourceStateChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceStateChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceStateChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceStateChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ResourceStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public ResourceStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ResourceStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ResourceStateChangeEvent description(@Nullable String description) {
  ...
  public ResourceStateChangeEvent priority(@Nullable String priority) {
  ...
  public ResourceStateChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ResourceStateChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ResourceStateChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ResourceStateChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ResourceStateChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ResourceStateChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ResourceStateChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ResourceStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public ResourceStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ResourceStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public ResourceStateChangeEvent event(@Nullable ResourceStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ResourceStateChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ResourceStateChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResourceStateChangeEvent resourceStateChangeEvent = (ResourceStateChangeEvent) o;
    return Objects.equals(this.atType, resourceStateChangeEvent.atType) &&
        Objects.equals(this.atBaseType, resourceStateChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceStateChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, resourceStateChangeEvent.href) &&
        Objects.equals(this.id, resourceStateChangeEvent.id) &&
        Objects.equals(this.correlationId, resourceStateChangeEvent.correlationId) &&
        Objects.equals(this.domain, resourceStateChangeEvent.domain) &&
        Objects.equals(this.title, resourceStateChangeEvent.title) &&
        Objects.equals(this.description, resourceStateChangeEvent.description) &&
        Objects.equals(this.priority, resourceStateChangeEvent.priority) &&
        Objects.equals(this.timeOccurred, resourceStateChangeEvent.timeOccurred) &&
        Objects.equals(this.source, resourceStateChangeEvent.source) &&
        Objects.equals(this.reportingSystem, resourceStateChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, resourceStateChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, resourceStateChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, resourceStateChangeEvent.eventId) &&
        Objects.equals(this.eventTime, resourceStateChangeEvent.eventTime) &&
        Objects.equals(this.eventType, resourceStateChangeEvent.eventType) &&
        Objects.equals(this.event, resourceStateChangeEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceStateChangeEvent {\n");
