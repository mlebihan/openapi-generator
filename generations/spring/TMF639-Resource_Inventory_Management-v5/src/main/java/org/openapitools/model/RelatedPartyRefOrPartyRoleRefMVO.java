...
import org.openapitools.model.PartyRefOrPartyRoleRefMVO;
...
public class RelatedPartyRefOrPartyRoleRefMVO {
  ...
  private @Nullable PartyRefOrPartyRoleRefMVO partyOrPartyRole;
   ...
   */
  public RelatedPartyRefOrPartyRoleRefMVO(String atType) {
    this.atType = atType;
  }
  ...
  public RelatedPartyRefOrPartyRoleRefMVO atBaseType(@Nullable String atBaseType) {
  ...
  public RelatedPartyRefOrPartyRoleRefMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public RelatedPartyRefOrPartyRoleRefMVO role(@Nullable String role) {
    this.role = role;
    return this;
  }
  ...
  public RelatedPartyRefOrPartyRoleRefMVO partyOrPartyRole(@Nullable PartyRefOrPartyRoleRefMVO partyOrPartyRole) {
  ...
  public @Nullable PartyRefOrPartyRoleRefMVO getPartyOrPartyRole() {
    return partyOrPartyRole;
  }

  public void setPartyOrPartyRole(@Nullable PartyRefOrPartyRoleRefMVO partyOrPartyRole) {
    this.partyOrPartyRole = partyOrPartyRole;
  }
