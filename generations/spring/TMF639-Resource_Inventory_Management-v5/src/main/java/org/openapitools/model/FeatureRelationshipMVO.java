...
public class FeatureRelationshipMVO {
   ...
   */
  public FeatureRelationshipMVO(String atType) {
    this.atType = atType;
  }

  public FeatureRelationshipMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public FeatureRelationshipMVO atBaseType(@Nullable String atBaseType) {
  ...
  public FeatureRelationshipMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public FeatureRelationshipMVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public FeatureRelationshipMVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public FeatureRelationshipMVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public FeatureRelationshipMVO atReferredType(@Nullable String atReferredType) {
  ...
  public FeatureRelationshipMVO relationshipType(@Nullable RelationshipTypeEnum relationshipType) {
  ...
  public FeatureRelationshipMVO validFor(@Nullable TimePeriod validFor) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, featureRelationshipMVO.atType) &&
        Objects.equals(this.atBaseType, featureRelationshipMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, featureRelationshipMVO.atSchemaLocation) &&
        ...
        Objects.equals(this.atReferredType, featureRelationshipMVO.atReferredType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, href, id, name, atReferredType, relationshipType, validFor);
  }
