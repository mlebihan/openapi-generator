...
public class HubFVO {
  ...
  public HubFVO atBaseType(@Nullable String atBaseType) {
  ...
  public HubFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public HubFVO query(@Nullable String query) {
    this.query = query;
    return this;
  }
