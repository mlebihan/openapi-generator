...
public class EntityRefMVO {
  ...
  public EntityRefMVO atBaseType(@Nullable String atBaseType) {
  ...
  public EntityRefMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public EntityRefMVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public EntityRefMVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public EntityRefMVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public EntityRefMVO atReferredType(@Nullable String atReferredType) {
