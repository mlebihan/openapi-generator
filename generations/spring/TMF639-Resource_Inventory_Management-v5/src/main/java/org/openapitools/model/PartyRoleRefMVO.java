...
public class PartyRoleRefMVO implements PartyRefOrPartyRoleRefMVO {
   ...
   */
  public PartyRoleRefMVO(String atType) {
    this.atType = atType;
  }
  ...
  public PartyRoleRefMVO atBaseType(@Nullable String atBaseType) {
  ...
  public PartyRoleRefMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PartyRoleRefMVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PartyRoleRefMVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PartyRoleRefMVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PartyRoleRefMVO atReferredType(@Nullable String atReferredType) {
  ...
  public PartyRoleRefMVO partyId(@Nullable String partyId) {
  ...
  public PartyRoleRefMVO partyName(@Nullable String partyName) {
