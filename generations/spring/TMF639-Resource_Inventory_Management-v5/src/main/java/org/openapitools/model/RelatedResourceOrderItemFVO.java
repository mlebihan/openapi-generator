...
public class RelatedResourceOrderItemFVO {
   ...
   */
  public RelatedResourceOrderItemFVO(String atType) {
    this.atType = atType;
  }

  public RelatedResourceOrderItemFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public RelatedResourceOrderItemFVO atBaseType(@Nullable String atBaseType) {
  ...
  public RelatedResourceOrderItemFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public RelatedResourceOrderItemFVO atReferredType(@Nullable String atReferredType) {
  ...
  public RelatedResourceOrderItemFVO resourceOrderHref(@Nullable String resourceOrderHref) {
  ...
  public RelatedResourceOrderItemFVO resourceOrderId(@Nullable String resourceOrderId) {
  ...
  public RelatedResourceOrderItemFVO itemAction(@Nullable OrderItemActionType itemAction) {
  ...
  public RelatedResourceOrderItemFVO itemId(@Nullable String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public RelatedResourceOrderItemFVO role(@Nullable String role) {
    this.role = role;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, relatedResourceOrderItemFVO.atType) &&
        Objects.equals(this.atBaseType, relatedResourceOrderItemFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, relatedResourceOrderItemFVO.atSchemaLocation) &&
        Objects.equals(this.atReferredType, relatedResourceOrderItemFVO.atReferredType) &&
