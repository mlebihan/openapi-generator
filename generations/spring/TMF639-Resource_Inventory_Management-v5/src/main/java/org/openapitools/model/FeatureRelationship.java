...
public class FeatureRelationship {
   ...
   */
  public FeatureRelationship(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }
  ...
  public FeatureRelationship atBaseType(@Nullable String atBaseType) {
  ...
  public FeatureRelationship atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public FeatureRelationship href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public FeatureRelationship name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public FeatureRelationship atReferredType(@Nullable String atReferredType) {
  ...
  public FeatureRelationship relationshipType(@Nullable RelationshipTypeEnum relationshipType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, featureRelationship.atType) &&
        ...
        Objects.equals(this.atReferredType, featureRelationship.atReferredType) &&
