...
import org.openapitools.model.ResourceCreateEventPayload;
...
public class ResourceCreateEvent {
  ...
  private @Nullable ResourceCreateEventPayload event;

  public ResourceCreateEvent() {
    super();
  }
   ...
   */
  public ResourceCreateEvent(String atType) {
    this.atType = atType;
  }

  public ResourceCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ResourceCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ResourceCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public ResourceCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ResourceCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ResourceCreateEvent description(@Nullable String description) {
  ...
  public ResourceCreateEvent priority(@Nullable String priority) {
  ...
  public ResourceCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ResourceCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ResourceCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ResourceCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ResourceCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ResourceCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ResourceCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ResourceCreateEvent eventId(@Nullable String eventId) {
  ...
  public ResourceCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ResourceCreateEvent eventType(@Nullable String eventType) {
  ...
  public ResourceCreateEvent event(@Nullable ResourceCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ResourceCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ResourceCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, resourceCreateEvent.atType) &&
        Objects.equals(this.atBaseType, resourceCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, resourceCreateEvent.href) &&
        Objects.equals(this.id, resourceCreateEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, resourceCreateEvent.timeOccurred) &&
        Objects.equals(this.source, resourceCreateEvent.source) &&
        Objects.equals(this.reportingSystem, resourceCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, resourceCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, resourceCreateEvent.analyticCharacteristic) &&
        ...
        Objects.equals(this.event, resourceCreateEvent.event);
  }
