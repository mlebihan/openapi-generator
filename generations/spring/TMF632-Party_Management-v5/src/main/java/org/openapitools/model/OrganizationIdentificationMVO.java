...
public class OrganizationIdentificationMVO {
  ...
  public OrganizationIdentificationMVO() {
    super();
  }
   ...
   */
  public OrganizationIdentificationMVO(String atType) {
    this.atType = atType;
  }

  public OrganizationIdentificationMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public OrganizationIdentificationMVO atBaseType(@Nullable String atBaseType) {
  ...
  public OrganizationIdentificationMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public OrganizationIdentificationMVO identificationId(@Nullable String identificationId) {
  ...
  public OrganizationIdentificationMVO issuingAuthority(@Nullable String issuingAuthority) {
  ...
  public OrganizationIdentificationMVO issuingDate(@Nullable OffsetDateTime issuingDate) {
  ...
  public OrganizationIdentificationMVO identificationType(@Nullable String identificationType) {
  ...
  public OrganizationIdentificationMVO validFor(@Nullable TimePeriod validFor) {
  ...
  public OrganizationIdentificationMVO attachment(@Nullable AttachmentRefOrValueMVO attachment) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, organizationIdentificationMVO.atType) &&
        Objects.equals(this.atBaseType, organizationIdentificationMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, organizationIdentificationMVO.atSchemaLocation) &&
        Objects.equals(this.identificationId, organizationIdentificationMVO.identificationId) &&
