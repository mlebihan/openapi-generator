...
public class PartyRefFVO implements PartyOrPartyRoleFVO {
   ...
   */
  public PartyRefFVO(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }

  public PartyRefFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public PartyRefFVO atBaseType(@Nullable String atBaseType) {
  ...
  public PartyRefFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PartyRefFVO id(String id) {
    this.id = id;
    return this;
  }
  ...
  public PartyRefFVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PartyRefFVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PartyRefFVO atReferredType(@Nullable String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, partyRefFVO.atType) &&
        Objects.equals(this.atBaseType, partyRefFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, partyRefFVO.atSchemaLocation) &&
        Objects.equals(this.id, partyRefFVO.id) &&
        Objects.equals(this.href, partyRefFVO.href) &&
        Objects.equals(this.name, partyRefFVO.name) &&
        Objects.equals(this.atReferredType, partyRefFVO.atReferredType);
  }
