...
@Schema(name = "IndividualStateChangeEventPayload", description = "IndividualStateChangeEventPayload generic structure")
...
public class IndividualStateChangeEventPayload {
  ...
  public IndividualStateChangeEventPayload individual(@Nullable Individual individual) {
