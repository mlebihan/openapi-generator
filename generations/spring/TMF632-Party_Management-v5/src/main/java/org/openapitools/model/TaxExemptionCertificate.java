...
import org.openapitools.model.TaxDefinition;
...
public class TaxExemptionCertificate {
  ...
  public TaxExemptionCertificate atBaseType(@Nullable String atBaseType) {
  ...
  public TaxExemptionCertificate atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public TaxExemptionCertificate id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public TaxExemptionCertificate validFor(@Nullable TimePeriod validFor) {
  ...
  public TaxExemptionCertificate certificateNumber(@Nullable String certificateNumber) {
  ...
  public TaxExemptionCertificate issuingJurisdiction(@Nullable String issuingJurisdiction) {
  ...
  public TaxExemptionCertificate reason(@Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public TaxExemptionCertificate attachment(@Nullable AttachmentRefOrValue attachment) {
