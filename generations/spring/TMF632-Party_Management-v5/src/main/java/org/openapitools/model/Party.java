...
public class Party {
  ...
  public Party atBaseType(@Nullable String atBaseType) {
  ...
  public Party atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public Party href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public Party id(@Nullable String id) {
    this.id = id;
    return this;
  }
