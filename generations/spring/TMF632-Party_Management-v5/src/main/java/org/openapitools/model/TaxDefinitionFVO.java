...
public class TaxDefinitionFVO {
   ...
   */
  public TaxDefinitionFVO(String atType) {
    this.atType = atType;
  }

  public TaxDefinitionFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public TaxDefinitionFVO atBaseType(@Nullable String atBaseType) {
  ...
  public TaxDefinitionFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public TaxDefinitionFVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public TaxDefinitionFVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public TaxDefinitionFVO validFor(@Nullable TimePeriod validFor) {
  ...
  public TaxDefinitionFVO jurisdictionName(@Nullable String jurisdictionName) {
  ...
  public TaxDefinitionFVO jurisdictionLevel(@Nullable String jurisdictionLevel) {
  ...
  public TaxDefinitionFVO taxType(@Nullable String taxType) {
  ...
  public boolean equals(Object o) {
    ...
    TaxDefinitionFVO taxDefinitionFVO = (TaxDefinitionFVO) o;
    return Objects.equals(this.atType, taxDefinitionFVO.atType) &&
        Objects.equals(this.atBaseType, taxDefinitionFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, taxDefinitionFVO.atSchemaLocation) &&
        Objects.equals(this.id, taxDefinitionFVO.id) &&
        Objects.equals(this.name, taxDefinitionFVO.name) &&
        Objects.equals(this.validFor, taxDefinitionFVO.validFor) &&
        Objects.equals(this.jurisdictionName, taxDefinitionFVO.jurisdictionName) &&
        Objects.equals(this.jurisdictionLevel, taxDefinitionFVO.jurisdictionLevel) &&
        Objects.equals(this.taxType, taxDefinitionFVO.taxType);
  }
  ...
  public String toString() {
    ...
    sb.append("class TaxDefinitionFVO {\n");
