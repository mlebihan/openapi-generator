...
public class OrganizationParentRelationship {
  ...
  private @Nullable OrganizationRef organization;
  ...
  public OrganizationParentRelationship atBaseType(@Nullable String atBaseType) {
  ...
  public OrganizationParentRelationship atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public OrganizationParentRelationship relationshipType(@Nullable String relationshipType) {
  ...
  public OrganizationParentRelationship organization(@Nullable OrganizationRef organization) {
  ...
  public @Nullable OrganizationRef getOrganization() {
    return organization;
  }

  public void setOrganization(@Nullable OrganizationRef organization) {
    this.organization = organization;
  }
