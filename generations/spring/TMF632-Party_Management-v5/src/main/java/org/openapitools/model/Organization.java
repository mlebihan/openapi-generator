...
public class Organization extends Party implements PartyOrPartyRole, PatchOrganization200Response {
  ...
  private @Nullable OrganizationParentRelationship organizationParentRelationship;
  ...
  public Organization isLegalEntity(@Nullable Boolean isLegalEntity) {
  ...
  public Organization isHeadOffice(@Nullable Boolean isHeadOffice) {
  ...
  public Organization organizationType(@Nullable String organizationType) {
  ...
  public Organization existsDuring(@Nullable TimePeriod existsDuring) {
  ...
  public Organization nameType(@Nullable String nameType) {
  ...
  public Organization status(@Nullable OrganizationStateType status) {
    this.status = status;
    return this;
  }
  ...
  public Organization organizationParentRelationship(@Nullable OrganizationParentRelationship organizationParentRelationship) {
  ...
  public @Nullable OrganizationParentRelationship getOrganizationParentRelationship() {
    return organizationParentRelationship;
  }

  public void setOrganizationParentRelationship(@Nullable OrganizationParentRelationship organizationParentRelationship) {
    this.organizationParentRelationship = organizationParentRelationship;
  }

  public Organization tradingName(@Nullable String tradingName) {
