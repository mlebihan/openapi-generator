...
public class BaseEvent {
  ...
  public BaseEvent atBaseType(@Nullable String atBaseType) {
  ...
  public BaseEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public BaseEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public BaseEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public BaseEvent event(@Nullable Object event) {
    this.event = event;
    return this;
  }
  ...
  public BaseEvent eventId(@Nullable String eventId) {
  ...
  public BaseEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public BaseEvent eventType(@Nullable String eventType) {
  ...
  public BaseEvent correlationId(@Nullable String correlationId) {
  ...
  public BaseEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public BaseEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public BaseEvent description(@Nullable String description) {
  ...
  public BaseEvent priority(@Nullable String priority) {
  ...
  public BaseEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
