...
public class EventFVO {
  ...
  public EventFVO relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public EventFVO addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
