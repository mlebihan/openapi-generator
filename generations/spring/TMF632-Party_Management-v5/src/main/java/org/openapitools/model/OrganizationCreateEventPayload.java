...
@Schema(name = "OrganizationCreateEventPayload", description = "OrganizationCreateEventPayload generic structure")
...
public class OrganizationCreateEventPayload {
  ...
  public OrganizationCreateEventPayload organization(@Nullable Organization organization) {
