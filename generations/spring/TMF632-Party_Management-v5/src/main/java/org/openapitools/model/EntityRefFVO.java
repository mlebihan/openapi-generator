...
public class EntityRefFVO {
   ...
   */
  public EntityRefFVO(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }
  ...
  public EntityRefFVO atBaseType(@Nullable String atBaseType) {
  ...
  public EntityRefFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public EntityRefFVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public EntityRefFVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public EntityRefFVO atReferredType(@Nullable String atReferredType) {
