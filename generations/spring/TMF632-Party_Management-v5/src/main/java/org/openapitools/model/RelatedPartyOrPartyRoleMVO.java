...
import org.openapitools.model.PartyOrPartyRoleMVO;
...
public class RelatedPartyOrPartyRoleMVO {
  ...
  private @Nullable PartyOrPartyRoleMVO partyOrPartyRole;
   ...
   */
  public RelatedPartyOrPartyRoleMVO(String atType, String role) {
    this.atType = atType;
    this.role = role;
  }

  public RelatedPartyOrPartyRoleMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public RelatedPartyOrPartyRoleMVO atBaseType(@Nullable String atBaseType) {
  ...
  public RelatedPartyOrPartyRoleMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public RelatedPartyOrPartyRoleMVO partyOrPartyRole(@Nullable PartyOrPartyRoleMVO partyOrPartyRole) {
  ...
  public @Nullable PartyOrPartyRoleMVO getPartyOrPartyRole() {
    return partyOrPartyRole;
  }

  public void setPartyOrPartyRole(@Nullable PartyOrPartyRoleMVO partyOrPartyRole) {
    this.partyOrPartyRole = partyOrPartyRole;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, relatedPartyOrPartyRoleMVO.atType) &&
        Objects.equals(this.atBaseType, relatedPartyOrPartyRoleMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, relatedPartyOrPartyRoleMVO.atSchemaLocation) &&
        Objects.equals(this.role, relatedPartyOrPartyRoleMVO.role) &&
