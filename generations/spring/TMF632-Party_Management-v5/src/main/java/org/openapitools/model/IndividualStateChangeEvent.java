...
import org.openapitools.model.IndividualStateChangeEventPayload;
...
public class IndividualStateChangeEvent {
  ...
  private @Nullable IndividualStateChangeEventPayload event;

  public IndividualStateChangeEvent() {
    super();
  }
   ...
   */
  public IndividualStateChangeEvent(String atType) {
    this.atType = atType;
  }

  public IndividualStateChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public IndividualStateChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public IndividualStateChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public IndividualStateChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public IndividualStateChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public IndividualStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public IndividualStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public IndividualStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public IndividualStateChangeEvent description(@Nullable String description) {
  ...
  public IndividualStateChangeEvent priority(@Nullable String priority) {
  ...
  public IndividualStateChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public IndividualStateChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public IndividualStateChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public IndividualStateChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public IndividualStateChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public IndividualStateChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public IndividualStateChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public IndividualStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public IndividualStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public IndividualStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public IndividualStateChangeEvent event(@Nullable IndividualStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable IndividualStateChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable IndividualStateChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    IndividualStateChangeEvent individualStateChangeEvent = (IndividualStateChangeEvent) o;
    return Objects.equals(this.atType, individualStateChangeEvent.atType) &&
        Objects.equals(this.atBaseType, individualStateChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, individualStateChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, individualStateChangeEvent.href) &&
        Objects.equals(this.id, individualStateChangeEvent.id) &&
        Objects.equals(this.correlationId, individualStateChangeEvent.correlationId) &&
        Objects.equals(this.domain, individualStateChangeEvent.domain) &&
        Objects.equals(this.title, individualStateChangeEvent.title) &&
        Objects.equals(this.description, individualStateChangeEvent.description) &&
        Objects.equals(this.priority, individualStateChangeEvent.priority) &&
        Objects.equals(this.timeOccurred, individualStateChangeEvent.timeOccurred) &&
        Objects.equals(this.source, individualStateChangeEvent.source) &&
        Objects.equals(this.reportingSystem, individualStateChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, individualStateChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, individualStateChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, individualStateChangeEvent.eventId) &&
        Objects.equals(this.eventTime, individualStateChangeEvent.eventTime) &&
        Objects.equals(this.eventType, individualStateChangeEvent.eventType) &&
        Objects.equals(this.event, individualStateChangeEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class IndividualStateChangeEvent {\n");
