...
public class IndividualCreateEvent {
  ...
  private @Nullable IndividualCreateEventPayload event;
  ...
  public IndividualCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public IndividualCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public IndividualCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public IndividualCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public IndividualCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public IndividualCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public IndividualCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public IndividualCreateEvent description(@Nullable String description) {
  ...
  public IndividualCreateEvent priority(@Nullable String priority) {
  ...
  public IndividualCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public IndividualCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public IndividualCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public IndividualCreateEvent eventId(@Nullable String eventId) {
  ...
  public IndividualCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public IndividualCreateEvent eventType(@Nullable String eventType) {
  ...
  public IndividualCreateEvent event(@Nullable IndividualCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable IndividualCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable IndividualCreateEventPayload event) {
    this.event = event;
  }
