...
public class CreditProfileFVO {
  ...
  public CreditProfileFVO atBaseType(@Nullable String atBaseType) {
  ...
  public CreditProfileFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CreditProfileFVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CreditProfileFVO creditProfileDate(@Nullable OffsetDateTime creditProfileDate) {
  ...
  public CreditProfileFVO creditRiskRating(@Nullable Integer creditRiskRating) {
  ...
  public CreditProfileFVO creditScore(@Nullable Integer creditScore) {
  ...
  public CreditProfileFVO validFor(@Nullable TimePeriod validFor) {
