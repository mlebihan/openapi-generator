...
public class OtherNameOrganizationFVO {
  ...
  public OtherNameOrganizationFVO atBaseType(@Nullable String atBaseType) {
  ...
  public OtherNameOrganizationFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public OtherNameOrganizationFVO tradingName(@Nullable String tradingName) {
  ...
  public OtherNameOrganizationFVO nameType(@Nullable String nameType) {
  ...
  public OtherNameOrganizationFVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OtherNameOrganizationFVO validFor(@Nullable TimePeriod validFor) {
