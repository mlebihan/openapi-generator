...
import org.openapitools.model.OrganizationCreateEventPayload;
...
public class OrganizationCreateEvent {
  ...
  private @Nullable OrganizationCreateEventPayload event;
   ...
   */
  public OrganizationCreateEvent(String atType) {
    this.atType = atType;
  }

  public OrganizationCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public OrganizationCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public OrganizationCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public OrganizationCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public OrganizationCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public OrganizationCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public OrganizationCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public OrganizationCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public OrganizationCreateEvent description(@Nullable String description) {
  ...
  public OrganizationCreateEvent priority(@Nullable String priority) {
  ...
  public OrganizationCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public OrganizationCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public OrganizationCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public OrganizationCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public OrganizationCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public OrganizationCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public OrganizationCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public OrganizationCreateEvent eventId(@Nullable String eventId) {
  ...
  public OrganizationCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public OrganizationCreateEvent eventType(@Nullable String eventType) {
  ...
  public OrganizationCreateEvent event(@Nullable OrganizationCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable OrganizationCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable OrganizationCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, organizationCreateEvent.atType) &&
        Objects.equals(this.atBaseType, organizationCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, organizationCreateEvent.atSchemaLocation) &&
        ...
        Objects.equals(this.timeOccurred, organizationCreateEvent.timeOccurred) &&
        Objects.equals(this.source, organizationCreateEvent.source) &&
        Objects.equals(this.reportingSystem, organizationCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, organizationCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, organizationCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, organizationCreateEvent.eventId) &&
