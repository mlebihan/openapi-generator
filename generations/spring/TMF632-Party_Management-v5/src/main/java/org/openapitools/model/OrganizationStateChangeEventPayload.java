...
/**
 * OrganizationStateChangeEventPayload generic structure
 */

@Schema(name = "OrganizationStateChangeEventPayload", description = "OrganizationStateChangeEventPayload generic structure")
...
public class OrganizationStateChangeEventPayload {
  ...
  public OrganizationStateChangeEventPayload organization(@Nullable Organization organization) {
