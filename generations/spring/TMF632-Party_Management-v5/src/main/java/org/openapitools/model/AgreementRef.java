...
public class AgreementRef {
  ...
  public AgreementRef atBaseType(@Nullable String atBaseType) {
  ...
  public AgreementRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public AgreementRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public AgreementRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AgreementRef atReferredType(@Nullable String atReferredType) {
