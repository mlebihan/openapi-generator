...
import org.openapitools.model.OrganizationDeleteEventPayload;
...
public class OrganizationDeleteEvent {
  ...
  private @Nullable OrganizationDeleteEventPayload event;
   ...
   */
  public OrganizationDeleteEvent(String atType) {
    this.atType = atType;
  }

  public OrganizationDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public OrganizationDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public OrganizationDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public OrganizationDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public OrganizationDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public OrganizationDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public OrganizationDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public OrganizationDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public OrganizationDeleteEvent description(@Nullable String description) {
  ...
  public OrganizationDeleteEvent priority(@Nullable String priority) {
  ...
  public OrganizationDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public OrganizationDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public OrganizationDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public OrganizationDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public OrganizationDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public OrganizationDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public OrganizationDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public OrganizationDeleteEvent eventId(@Nullable String eventId) {
  ...
  public OrganizationDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public OrganizationDeleteEvent eventType(@Nullable String eventType) {
  ...
  public OrganizationDeleteEvent event(@Nullable OrganizationDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable OrganizationDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable OrganizationDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, organizationDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, organizationDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, organizationDeleteEvent.atSchemaLocation) &&
        ...
        Objects.equals(this.timeOccurred, organizationDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, organizationDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, organizationDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, organizationDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, organizationDeleteEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, organizationDeleteEvent.eventId) &&
