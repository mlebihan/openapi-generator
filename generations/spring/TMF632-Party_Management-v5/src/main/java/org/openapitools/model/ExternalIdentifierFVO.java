...
public class ExternalIdentifierFVO {
  ...
  public ExternalIdentifierFVO atBaseType(@Nullable String atBaseType) {
  ...
  public ExternalIdentifierFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ExternalIdentifierFVO owner(@Nullable String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public ExternalIdentifierFVO externalIdentifierType(@Nullable String externalIdentifierType) {
