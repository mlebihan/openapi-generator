...
public class TaxDefinitionMVO {
  ...
  public TaxDefinitionMVO atBaseType(@Nullable String atBaseType) {
  ...
  public TaxDefinitionMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public TaxDefinitionMVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public TaxDefinitionMVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public TaxDefinitionMVO validFor(@Nullable TimePeriod validFor) {
  ...
  public TaxDefinitionMVO jurisdictionName(@Nullable String jurisdictionName) {
  ...
  public TaxDefinitionMVO jurisdictionLevel(@Nullable String jurisdictionLevel) {
  ...
  public TaxDefinitionMVO taxType(@Nullable String taxType) {
