...
public class PartyFVO {
  ...
  @Valid
  private List<PartyCreditProfileFVO> creditRating = new ArrayList<>();
  ...
  public PartyFVO atBaseType(@Nullable String atBaseType) {
  ...
  public PartyFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PartyFVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
