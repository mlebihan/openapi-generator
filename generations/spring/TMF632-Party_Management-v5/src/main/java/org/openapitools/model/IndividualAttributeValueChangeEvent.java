...
import org.openapitools.model.IndividualAttributeValueChangeEventPayload;
...
public class IndividualAttributeValueChangeEvent {
  ...
  private @Nullable IndividualAttributeValueChangeEventPayload event;
   ...
   */
  public IndividualAttributeValueChangeEvent(String atType) {
    this.atType = atType;
  }

  public IndividualAttributeValueChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public IndividualAttributeValueChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public IndividualAttributeValueChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public IndividualAttributeValueChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public IndividualAttributeValueChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public IndividualAttributeValueChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public IndividualAttributeValueChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public IndividualAttributeValueChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public IndividualAttributeValueChangeEvent description(@Nullable String description) {
  ...
  public IndividualAttributeValueChangeEvent priority(@Nullable String priority) {
  ...
  public IndividualAttributeValueChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public IndividualAttributeValueChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public IndividualAttributeValueChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public IndividualAttributeValueChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public IndividualAttributeValueChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public IndividualAttributeValueChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public IndividualAttributeValueChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public IndividualAttributeValueChangeEvent eventId(@Nullable String eventId) {
  ...
  public IndividualAttributeValueChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public IndividualAttributeValueChangeEvent eventType(@Nullable String eventType) {
  ...
  public IndividualAttributeValueChangeEvent event(@Nullable IndividualAttributeValueChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable IndividualAttributeValueChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable IndividualAttributeValueChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, individualAttributeValueChangeEvent.atType) &&
        Objects.equals(this.atBaseType, individualAttributeValueChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, individualAttributeValueChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, individualAttributeValueChangeEvent.href) &&
        Objects.equals(this.id, individualAttributeValueChangeEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, individualAttributeValueChangeEvent.timeOccurred) &&
        Objects.equals(this.source, individualAttributeValueChangeEvent.source) &&
        Objects.equals(this.reportingSystem, individualAttributeValueChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, individualAttributeValueChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, individualAttributeValueChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, individualAttributeValueChangeEvent.eventId) &&
