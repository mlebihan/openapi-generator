...
public class GeographicAddressContactMediumMVO extends ContactMediumMVO {
  ...
  private @Nullable GeographicAddressRefMVO geographicAddress;
  ...
  public GeographicAddressContactMediumMVO city(@Nullable String city) {
    this.city = city;
    return this;
  }
  ...
  public GeographicAddressContactMediumMVO country(@Nullable String country) {
  ...
  public GeographicAddressContactMediumMVO postCode(@Nullable String postCode) {
  ...
  public GeographicAddressContactMediumMVO stateOrProvince(@Nullable String stateOrProvince) {
  ...
  public GeographicAddressContactMediumMVO street1(@Nullable String street1) {
  ...
  public GeographicAddressContactMediumMVO street2(@Nullable String street2) {
  ...
  public GeographicAddressContactMediumMVO geographicAddress(@Nullable GeographicAddressRefMVO geographicAddress) {
  ...
  public @Nullable GeographicAddressRefMVO getGeographicAddress() {
    return geographicAddress;
  }

  public void setGeographicAddress(@Nullable GeographicAddressRefMVO geographicAddress) {
    this.geographicAddress = geographicAddress;
  }
