...
public class OrganizationAttributeValueChangeEvent {
  ...
  private @Nullable OrganizationAttributeValueChangeEventPayload event;
  ...
  public OrganizationAttributeValueChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public OrganizationAttributeValueChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public OrganizationAttributeValueChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public OrganizationAttributeValueChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public OrganizationAttributeValueChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public OrganizationAttributeValueChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public OrganizationAttributeValueChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public OrganizationAttributeValueChangeEvent description(@Nullable String description) {
  ...
  public OrganizationAttributeValueChangeEvent priority(@Nullable String priority) {
  ...
  public OrganizationAttributeValueChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public OrganizationAttributeValueChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public OrganizationAttributeValueChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public OrganizationAttributeValueChangeEvent eventId(@Nullable String eventId) {
  ...
  public OrganizationAttributeValueChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public OrganizationAttributeValueChangeEvent eventType(@Nullable String eventType) {
  ...
  public OrganizationAttributeValueChangeEvent event(@Nullable OrganizationAttributeValueChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable OrganizationAttributeValueChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable OrganizationAttributeValueChangeEventPayload event) {
    this.event = event;
  }
