...
public class OrganizationChildRelationshipMVO {
  ...
  public OrganizationChildRelationshipMVO() {
    super();
  }
   ...
   */
  public OrganizationChildRelationshipMVO(String atType) {
    this.atType = atType;
  }

  public OrganizationChildRelationshipMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public OrganizationChildRelationshipMVO atBaseType(@Nullable String atBaseType) {
  ...
  public OrganizationChildRelationshipMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public OrganizationChildRelationshipMVO relationshipType(@Nullable String relationshipType) {
  ...
  public OrganizationChildRelationshipMVO organization(@Nullable OrganizationRefMVO organization) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, organizationChildRelationshipMVO.atType) &&
        Objects.equals(this.atBaseType, organizationChildRelationshipMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, organizationChildRelationshipMVO.atSchemaLocation) &&
        Objects.equals(this.relationshipType, organizationChildRelationshipMVO.relationshipType) &&
