...
import org.openapitools.model.IndividualDeleteEventPayload;
...
public class IndividualDeleteEvent {
  ...
  private @Nullable IndividualDeleteEventPayload event;
   ...
   */
  public IndividualDeleteEvent(String atType) {
    this.atType = atType;
  }

  public IndividualDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public IndividualDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public IndividualDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public IndividualDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public IndividualDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public IndividualDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public IndividualDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public IndividualDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public IndividualDeleteEvent description(@Nullable String description) {
  ...
  public IndividualDeleteEvent priority(@Nullable String priority) {
  ...
  public IndividualDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public IndividualDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public IndividualDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public IndividualDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public IndividualDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public IndividualDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public IndividualDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public IndividualDeleteEvent eventId(@Nullable String eventId) {
  ...
  public IndividualDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public IndividualDeleteEvent eventType(@Nullable String eventType) {
  ...
  public IndividualDeleteEvent event(@Nullable IndividualDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable IndividualDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable IndividualDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    IndividualDeleteEvent individualDeleteEvent = (IndividualDeleteEvent) o;
    return Objects.equals(this.atType, individualDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, individualDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, individualDeleteEvent.atSchemaLocation) &&
        Objects.equals(this.href, individualDeleteEvent.href) &&
        Objects.equals(this.id, individualDeleteEvent.id) &&
        Objects.equals(this.correlationId, individualDeleteEvent.correlationId) &&
        Objects.equals(this.domain, individualDeleteEvent.domain) &&
        Objects.equals(this.title, individualDeleteEvent.title) &&
        Objects.equals(this.description, individualDeleteEvent.description) &&
        Objects.equals(this.priority, individualDeleteEvent.priority) &&
        Objects.equals(this.timeOccurred, individualDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, individualDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, individualDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, individualDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, individualDeleteEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, individualDeleteEvent.eventId) &&
        Objects.equals(this.eventTime, individualDeleteEvent.eventTime) &&
        Objects.equals(this.eventType, individualDeleteEvent.eventType) &&
        Objects.equals(this.event, individualDeleteEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class IndividualDeleteEvent {\n");
