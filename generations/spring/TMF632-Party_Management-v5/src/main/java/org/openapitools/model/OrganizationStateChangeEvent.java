...
import org.openapitools.model.OrganizationStateChangeEventPayload;
...
public class OrganizationStateChangeEvent {
  ...
  private @Nullable OrganizationStateChangeEventPayload event;

  public OrganizationStateChangeEvent() {
    super();
  }
   ...
   */
  public OrganizationStateChangeEvent(String atType) {
    this.atType = atType;
  }

  public OrganizationStateChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public OrganizationStateChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public OrganizationStateChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public OrganizationStateChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public OrganizationStateChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public OrganizationStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public OrganizationStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public OrganizationStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public OrganizationStateChangeEvent description(@Nullable String description) {
  ...
  public OrganizationStateChangeEvent priority(@Nullable String priority) {
  ...
  public OrganizationStateChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public OrganizationStateChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public OrganizationStateChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public OrganizationStateChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public OrganizationStateChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public OrganizationStateChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public OrganizationStateChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public OrganizationStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public OrganizationStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public OrganizationStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public OrganizationStateChangeEvent event(@Nullable OrganizationStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable OrganizationStateChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable OrganizationStateChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, organizationStateChangeEvent.atType) &&
        Objects.equals(this.atBaseType, organizationStateChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, organizationStateChangeEvent.atSchemaLocation) &&
        ...
        Objects.equals(this.timeOccurred, organizationStateChangeEvent.timeOccurred) &&
        Objects.equals(this.source, organizationStateChangeEvent.source) &&
        Objects.equals(this.reportingSystem, organizationStateChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, organizationStateChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, organizationStateChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, organizationStateChangeEvent.eventId) &&
