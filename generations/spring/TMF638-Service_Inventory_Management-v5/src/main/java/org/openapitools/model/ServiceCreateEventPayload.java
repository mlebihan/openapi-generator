...
@Schema(name = "ServiceCreateEventPayload", description = "ServiceCreateEventPayload generic structure")
...
public class ServiceCreateEventPayload {
  ...
  public ServiceCreateEventPayload service(@Nullable Service service) {
