...
public class ServiceRelationship {
   ...
   */
  public ServiceRelationship(String atType) {
    this.atType = atType;
  }
  ...
  public ServiceRelationship atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceRelationship relationshipType(@Nullable String relationshipType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, serviceRelationship.atType) &&
