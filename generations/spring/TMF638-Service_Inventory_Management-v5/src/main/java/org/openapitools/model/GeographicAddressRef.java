...
@Schema(name = "GeographicAddressRef", description = "Reference to a Geographic Address.")
...
public class GeographicAddressRef {
   ...
   */
  public GeographicAddressRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }

  public GeographicAddressRef atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public GeographicAddressRef atBaseType(@Nullable String atBaseType) {
  ...
  public GeographicAddressRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public GeographicAddressRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public GeographicAddressRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GeographicAddressRef atReferredType(@Nullable String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, geographicAddressRef.atType) &&
        Objects.equals(this.atBaseType, geographicAddressRef.atBaseType) &&
        Objects.equals(this.atSchemaLocation, geographicAddressRef.atSchemaLocation) &&
        Objects.equals(this.href, geographicAddressRef.href) &&
        Objects.equals(this.id, geographicAddressRef.id) &&
        Objects.equals(this.name, geographicAddressRef.name) &&
        Objects.equals(this.atReferredType, geographicAddressRef.atReferredType);
  }
