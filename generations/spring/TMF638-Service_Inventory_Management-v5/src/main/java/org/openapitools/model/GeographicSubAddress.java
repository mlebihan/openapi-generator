...
import org.openapitools.model.GeographicSubAddressUnit;
...
public class GeographicSubAddress {
   ...
   */
  public GeographicSubAddress(String atType) {
    this.atType = atType;
  }
  ...
  public GeographicSubAddress atBaseType(@Nullable String atBaseType) {
  ...
  public GeographicSubAddress atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public GeographicSubAddress href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public GeographicSubAddress id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public GeographicSubAddress buildingName(@Nullable String buildingName) {
  ...
  public GeographicSubAddress levelNumber(@Nullable String levelNumber) {
  ...
  public GeographicSubAddress levelType(@Nullable String levelType) {
  ...
  public GeographicSubAddress name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GeographicSubAddress privateStreetName(@Nullable String privateStreetName) {
  ...
  public GeographicSubAddress privateStreetNumber(@Nullable String privateStreetNumber) {
  ...
  public GeographicSubAddress subAddressType(@Nullable String subAddressType) {
