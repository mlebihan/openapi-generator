...
public class GeographicSubAddressUnitFVO {
  ...
  public GeographicSubAddressUnitFVO() {
    super();
  }
   ...
   */
  public GeographicSubAddressUnitFVO(String atType, String subUnitNumber, String subUnitType) {
    this.atType = atType;
    this.subUnitNumber = subUnitNumber;
    this.subUnitType = subUnitType;
  }

  public GeographicSubAddressUnitFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public GeographicSubAddressUnitFVO atBaseType(@Nullable String atBaseType) {
  ...
  public GeographicSubAddressUnitFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public GeographicSubAddressUnitFVO subUnitNumber(String subUnitNumber) {
    this.subUnitNumber = subUnitNumber;
    return this;
  }
  ...
  public GeographicSubAddressUnitFVO subUnitType(String subUnitType) {
    this.subUnitType = subUnitType;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GeographicSubAddressUnitFVO geographicSubAddressUnitFVO = (GeographicSubAddressUnitFVO) o;
    return Objects.equals(this.atType, geographicSubAddressUnitFVO.atType) &&
        Objects.equals(this.atBaseType, geographicSubAddressUnitFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, geographicSubAddressUnitFVO.atSchemaLocation) &&
        Objects.equals(this.subUnitNumber, geographicSubAddressUnitFVO.subUnitNumber) &&
        Objects.equals(this.subUnitType, geographicSubAddressUnitFVO.subUnitType);
  }
  ...
  public String toString() {
    ...
    sb.append("class GeographicSubAddressUnitFVO {\n");
