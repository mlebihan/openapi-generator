...
public class ServiceRef implements ServiceRefOrValue, ServiceRefOrValueFVO, ServiceRefOrValueMVO {
  ...
  public ServiceRef atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ServiceRef atReferredType(@Nullable String atReferredType) {
