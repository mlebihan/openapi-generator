...
import org.openapitools.model.ServiceAttributeValueChangeEventPayload;
...
public class ServiceAttributeValueChangeEvent {
  ...
  private @Nullable ServiceAttributeValueChangeEventPayload event;

  public ServiceAttributeValueChangeEvent() {
    super();
  }
   ...
   */
  public ServiceAttributeValueChangeEvent(String atType) {
    this.atType = atType;
  }

  public ServiceAttributeValueChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceAttributeValueChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceAttributeValueChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceAttributeValueChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceAttributeValueChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ServiceAttributeValueChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public ServiceAttributeValueChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ServiceAttributeValueChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ServiceAttributeValueChangeEvent description(@Nullable String description) {
  ...
  public ServiceAttributeValueChangeEvent priority(@Nullable String priority) {
  ...
  public ServiceAttributeValueChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ServiceAttributeValueChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ServiceAttributeValueChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ServiceAttributeValueChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ServiceAttributeValueChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ServiceAttributeValueChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ServiceAttributeValueChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ServiceAttributeValueChangeEvent eventId(@Nullable String eventId) {
  ...
  public ServiceAttributeValueChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ServiceAttributeValueChangeEvent eventType(@Nullable String eventType) {
  ...
  public ServiceAttributeValueChangeEvent event(@Nullable ServiceAttributeValueChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ServiceAttributeValueChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ServiceAttributeValueChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, serviceAttributeValueChangeEvent.atType) &&
        Objects.equals(this.atBaseType, serviceAttributeValueChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceAttributeValueChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, serviceAttributeValueChangeEvent.href) &&
        Objects.equals(this.id, serviceAttributeValueChangeEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, serviceAttributeValueChangeEvent.timeOccurred) &&
        Objects.equals(this.source, serviceAttributeValueChangeEvent.source) &&
        Objects.equals(this.reportingSystem, serviceAttributeValueChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, serviceAttributeValueChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, serviceAttributeValueChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, serviceAttributeValueChangeEvent.eventId) &&
