...
/**
 * A uni-directional relationship from this entity to a target entity instance
 */

@Schema(name = "EntityRelationship", description = "A uni-directional relationship from this entity to a target entity instance")
