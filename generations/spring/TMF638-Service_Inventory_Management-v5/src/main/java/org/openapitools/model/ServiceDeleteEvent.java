...
import org.openapitools.model.ServiceDeleteEventPayload;
...
public class ServiceDeleteEvent {
  ...
  private @Nullable ServiceDeleteEventPayload event;
   ...
   */
  public ServiceDeleteEvent(String atType) {
    this.atType = atType;
  }

  public ServiceDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ServiceDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public ServiceDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ServiceDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ServiceDeleteEvent description(@Nullable String description) {
  ...
  public ServiceDeleteEvent priority(@Nullable String priority) {
  ...
  public ServiceDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ServiceDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ServiceDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ServiceDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ServiceDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ServiceDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ServiceDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ServiceDeleteEvent eventId(@Nullable String eventId) {
  ...
  public ServiceDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ServiceDeleteEvent eventType(@Nullable String eventType) {
  ...
  public ServiceDeleteEvent event(@Nullable ServiceDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ServiceDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ServiceDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, serviceDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, serviceDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceDeleteEvent.atSchemaLocation) &&
        Objects.equals(this.href, serviceDeleteEvent.href) &&
        Objects.equals(this.id, serviceDeleteEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, serviceDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, serviceDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, serviceDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, serviceDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, serviceDeleteEvent.analyticCharacteristic) &&
        ...
        Objects.equals(this.event, serviceDeleteEvent.event);
  }
