...
public interface HubApi {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "Notified", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Hub.class), examples = {
                    @ExampleObject(
                        name = "",
                        value = "{\"@type\":\"Hub\",\"callback\":\"https://host/tmf-api/specificAPIName/v5/listener/specificEventListener\"}"
                    )
                })
     ...
     * This operation removes the subscription to receive Events.
     *
    ...
    String PATH_HUB_GET = "/hub/{id}";
    /**
     * GET /hub/{id} : Retrieve a subscription (hub)
     * This operation retrieves the subscription to receive Events.
     *
     * @param id Identifier of the Resource (required)
