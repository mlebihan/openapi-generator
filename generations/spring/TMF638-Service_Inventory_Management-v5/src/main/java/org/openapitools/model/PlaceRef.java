...
@Schema(name = "PlaceRef", description = "Place reference.")
...
public class PlaceRef implements PlaceRefOrValue, PlaceRefOrValueFVO {
   ...
   */
  public PlaceRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }
  ...
  public PlaceRef atBaseType(@Nullable String atBaseType) {
  ...
  public PlaceRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PlaceRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PlaceRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PlaceRef atReferredType(@Nullable String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, placeRef.atType) &&
