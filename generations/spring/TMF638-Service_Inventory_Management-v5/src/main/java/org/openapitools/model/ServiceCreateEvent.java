...
import org.openapitools.model.ServiceCreateEventPayload;
...
public class ServiceCreateEvent {
  ...
  private @Nullable ServiceCreateEventPayload event;

  public ServiceCreateEvent() {
    super();
  }
   ...
   */
  public ServiceCreateEvent(String atType) {
    this.atType = atType;
  }

  public ServiceCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ServiceCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ServiceCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public ServiceCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ServiceCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ServiceCreateEvent description(@Nullable String description) {
  ...
  public ServiceCreateEvent priority(@Nullable String priority) {
  ...
  public ServiceCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ServiceCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ServiceCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ServiceCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ServiceCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ServiceCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ServiceCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ServiceCreateEvent eventId(@Nullable String eventId) {
  ...
  public ServiceCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ServiceCreateEvent eventType(@Nullable String eventType) {
  ...
  public ServiceCreateEvent event(@Nullable ServiceCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ServiceCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ServiceCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, serviceCreateEvent.atType) &&
        Objects.equals(this.atBaseType, serviceCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, serviceCreateEvent.href) &&
        Objects.equals(this.id, serviceCreateEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, serviceCreateEvent.timeOccurred) &&
        Objects.equals(this.source, serviceCreateEvent.source) &&
        Objects.equals(this.reportingSystem, serviceCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, serviceCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, serviceCreateEvent.analyticCharacteristic) &&
        ...
        Objects.equals(this.event, serviceCreateEvent.event);
  }
