...
public class HourPeriod {
   ...
   */
  public HourPeriod(String atType) {
    this.atType = atType;
  }

  public HourPeriod atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public HourPeriod atBaseType(@Nullable String atBaseType) {
  ...
  public HourPeriod atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public HourPeriod endHour(@Nullable String endHour) {
  ...
  public HourPeriod startHour(@Nullable String startHour) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, hourPeriod.atType) &&
        Objects.equals(this.atBaseType, hourPeriod.atBaseType) &&
        Objects.equals(this.atSchemaLocation, hourPeriod.atSchemaLocation) &&
        Objects.equals(this.endHour, hourPeriod.endHour) &&
