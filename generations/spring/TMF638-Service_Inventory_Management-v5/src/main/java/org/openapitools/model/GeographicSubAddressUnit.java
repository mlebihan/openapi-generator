...
public class GeographicSubAddressUnit {
   ...
   */
  public GeographicSubAddressUnit(String atType) {
    this.atType = atType;
  }
  ...
  public GeographicSubAddressUnit atBaseType(@Nullable String atBaseType) {
  ...
  public GeographicSubAddressUnit atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public GeographicSubAddressUnit subUnitNumber(@Nullable String subUnitNumber) {
  ...
  public GeographicSubAddressUnit subUnitType(@Nullable String subUnitType) {
