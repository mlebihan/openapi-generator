...
public class CalendarPeriod {
   ...
   */
  public CalendarPeriod(String atType) {
    this.atType = atType;
  }
  ...
  public CalendarPeriod atBaseType(@Nullable String atBaseType) {
  ...
  public CalendarPeriod atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CalendarPeriod day(@Nullable String day) {
    this.day = day;
    return this;
  }
  ...
  public CalendarPeriod timeZone(@Nullable String timeZone) {
  ...
  public CalendarPeriod status(@Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  @Schema(name = "status", description = "Indication of the availability of the calendar period (e.g.: available, booked, etc.)", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("status")
