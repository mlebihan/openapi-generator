...
@Schema(name = "ServiceAttributeValueChangeEventPayload", description = "ServiceAttributeValueChangeEventPayload generic structure")
...
public class ServiceAttributeValueChangeEventPayload {
  ...
  public ServiceAttributeValueChangeEventPayload service(@Nullable Service service) {
