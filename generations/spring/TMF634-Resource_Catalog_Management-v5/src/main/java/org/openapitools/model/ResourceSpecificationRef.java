...
public class ResourceSpecificationRef {
   ...
   */
  public ResourceSpecificationRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }
  ...
  public ResourceSpecificationRef atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceSpecificationRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceSpecificationRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceSpecificationRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ResourceSpecificationRef atReferredType(@Nullable String atReferredType) {
  ...
  public ResourceSpecificationRef version(@Nullable String version) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, resourceSpecificationRef.atType) &&
