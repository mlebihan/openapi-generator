...
import org.openapitools.model.ImportJobDeleteEventPayload;
...
public class ImportJobDeleteEvent {
  ...
  private @Nullable ImportJobDeleteEventPayload event;

  public ImportJobDeleteEvent() {
    super();
  }
   ...
   */
  public ImportJobDeleteEvent(String atType) {
    this.atType = atType;
  }

  public ImportJobDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ImportJobDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ImportJobDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ImportJobDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ImportJobDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ImportJobDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public ImportJobDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ImportJobDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ImportJobDeleteEvent description(@Nullable String description) {
  ...
  public ImportJobDeleteEvent priority(@Nullable String priority) {
  ...
  public ImportJobDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ImportJobDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ImportJobDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ImportJobDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ImportJobDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ImportJobDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ImportJobDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ImportJobDeleteEvent eventId(@Nullable String eventId) {
  ...
  public ImportJobDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ImportJobDeleteEvent eventType(@Nullable String eventType) {
  ...
  public ImportJobDeleteEvent event(@Nullable ImportJobDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ImportJobDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ImportJobDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportJobDeleteEvent importJobDeleteEvent = (ImportJobDeleteEvent) o;
    return Objects.equals(this.atType, importJobDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, importJobDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, importJobDeleteEvent.atSchemaLocation) &&
        Objects.equals(this.href, importJobDeleteEvent.href) &&
        Objects.equals(this.id, importJobDeleteEvent.id) &&
        Objects.equals(this.correlationId, importJobDeleteEvent.correlationId) &&
        Objects.equals(this.domain, importJobDeleteEvent.domain) &&
        Objects.equals(this.title, importJobDeleteEvent.title) &&
        Objects.equals(this.description, importJobDeleteEvent.description) &&
        Objects.equals(this.priority, importJobDeleteEvent.priority) &&
        Objects.equals(this.timeOccurred, importJobDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, importJobDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, importJobDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, importJobDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, importJobDeleteEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, importJobDeleteEvent.eventId) &&
        Objects.equals(this.eventTime, importJobDeleteEvent.eventTime) &&
        Objects.equals(this.eventType, importJobDeleteEvent.eventType) &&
        Objects.equals(this.event, importJobDeleteEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportJobDeleteEvent {\n");
