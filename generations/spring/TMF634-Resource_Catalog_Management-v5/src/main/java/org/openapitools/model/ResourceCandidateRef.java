...
public class ResourceCandidateRef {
   ...
   */
  public ResourceCandidateRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }
  ...
  public ResourceCandidateRef atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceCandidateRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceCandidateRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceCandidateRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ResourceCandidateRef atReferredType(@Nullable String atReferredType) {
  ...
  public ResourceCandidateRef version(@Nullable String version) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, resourceCandidateRef.atType) &&
