...
/**
 * ResourceCatalogCreateEventPayload generic structure
 */

@Schema(name = "ResourceCatalogCreateEventPayload", description = "ResourceCatalogCreateEventPayload generic structure")
...
public class ResourceCatalogCreateEventPayload {
  ...
  public ResourceCatalogCreateEventPayload resourceCatalog(@Nullable ResourceCatalog resourceCatalog) {
