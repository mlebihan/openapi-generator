...
import org.openapitools.model.ImportJobStateChangeEventPayload;
...
public class ImportJobStateChangeEvent {
  ...
  private @Nullable ImportJobStateChangeEventPayload event;

  public ImportJobStateChangeEvent() {
    super();
  }
   ...
   */
  public ImportJobStateChangeEvent(String atType) {
    this.atType = atType;
  }

  public ImportJobStateChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ImportJobStateChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ImportJobStateChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ImportJobStateChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ImportJobStateChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ImportJobStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public ImportJobStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ImportJobStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ImportJobStateChangeEvent description(@Nullable String description) {
  ...
  public ImportJobStateChangeEvent priority(@Nullable String priority) {
  ...
  public ImportJobStateChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ImportJobStateChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ImportJobStateChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ImportJobStateChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ImportJobStateChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ImportJobStateChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ImportJobStateChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ImportJobStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public ImportJobStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ImportJobStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public ImportJobStateChangeEvent event(@Nullable ImportJobStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ImportJobStateChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ImportJobStateChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportJobStateChangeEvent importJobStateChangeEvent = (ImportJobStateChangeEvent) o;
    return Objects.equals(this.atType, importJobStateChangeEvent.atType) &&
        Objects.equals(this.atBaseType, importJobStateChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, importJobStateChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, importJobStateChangeEvent.href) &&
        Objects.equals(this.id, importJobStateChangeEvent.id) &&
        Objects.equals(this.correlationId, importJobStateChangeEvent.correlationId) &&
        Objects.equals(this.domain, importJobStateChangeEvent.domain) &&
        Objects.equals(this.title, importJobStateChangeEvent.title) &&
        Objects.equals(this.description, importJobStateChangeEvent.description) &&
        Objects.equals(this.priority, importJobStateChangeEvent.priority) &&
        Objects.equals(this.timeOccurred, importJobStateChangeEvent.timeOccurred) &&
        Objects.equals(this.source, importJobStateChangeEvent.source) &&
        Objects.equals(this.reportingSystem, importJobStateChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, importJobStateChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, importJobStateChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, importJobStateChangeEvent.eventId) &&
        Objects.equals(this.eventTime, importJobStateChangeEvent.eventTime) &&
        Objects.equals(this.eventType, importJobStateChangeEvent.eventType) &&
        Objects.equals(this.event, importJobStateChangeEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportJobStateChangeEvent {\n");
