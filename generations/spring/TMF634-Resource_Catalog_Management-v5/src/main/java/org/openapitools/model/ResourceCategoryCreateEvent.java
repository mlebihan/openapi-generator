...
import org.openapitools.model.ResourceCategoryCreateEventPayload;
...
public class ResourceCategoryCreateEvent {
  ...
  private @Nullable ResourceCategoryCreateEventPayload event;

  public ResourceCategoryCreateEvent() {
    super();
  }
   ...
   */
  public ResourceCategoryCreateEvent(String atType) {
    this.atType = atType;
  }

  public ResourceCategoryCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ResourceCategoryCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceCategoryCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceCategoryCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceCategoryCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ResourceCategoryCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public ResourceCategoryCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ResourceCategoryCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ResourceCategoryCreateEvent description(@Nullable String description) {
  ...
  public ResourceCategoryCreateEvent priority(@Nullable String priority) {
  ...
  public ResourceCategoryCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ResourceCategoryCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ResourceCategoryCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ResourceCategoryCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ResourceCategoryCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ResourceCategoryCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ResourceCategoryCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ResourceCategoryCreateEvent eventId(@Nullable String eventId) {
  ...
  public ResourceCategoryCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ResourceCategoryCreateEvent eventType(@Nullable String eventType) {
  ...
  public ResourceCategoryCreateEvent event(@Nullable ResourceCategoryCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ResourceCategoryCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ResourceCategoryCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResourceCategoryCreateEvent resourceCategoryCreateEvent = (ResourceCategoryCreateEvent) o;
    return Objects.equals(this.atType, resourceCategoryCreateEvent.atType) &&
        Objects.equals(this.atBaseType, resourceCategoryCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceCategoryCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, resourceCategoryCreateEvent.href) &&
        Objects.equals(this.id, resourceCategoryCreateEvent.id) &&
        Objects.equals(this.correlationId, resourceCategoryCreateEvent.correlationId) &&
        Objects.equals(this.domain, resourceCategoryCreateEvent.domain) &&
        Objects.equals(this.title, resourceCategoryCreateEvent.title) &&
        Objects.equals(this.description, resourceCategoryCreateEvent.description) &&
        Objects.equals(this.priority, resourceCategoryCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, resourceCategoryCreateEvent.timeOccurred) &&
        Objects.equals(this.source, resourceCategoryCreateEvent.source) &&
        Objects.equals(this.reportingSystem, resourceCategoryCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, resourceCategoryCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, resourceCategoryCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, resourceCategoryCreateEvent.eventId) &&
        Objects.equals(this.eventTime, resourceCategoryCreateEvent.eventTime) &&
        Objects.equals(this.eventType, resourceCategoryCreateEvent.eventType) &&
        Objects.equals(this.event, resourceCategoryCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceCategoryCreateEvent {\n");
