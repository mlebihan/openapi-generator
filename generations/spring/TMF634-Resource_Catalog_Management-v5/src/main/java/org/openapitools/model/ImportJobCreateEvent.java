...
import org.openapitools.model.ImportJobCreateEventPayload;
...
public class ImportJobCreateEvent {
  ...
  private @Nullable ImportJobCreateEventPayload event;

  public ImportJobCreateEvent() {
    super();
  }
   ...
   */
  public ImportJobCreateEvent(String atType) {
    this.atType = atType;
  }

  public ImportJobCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ImportJobCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ImportJobCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ImportJobCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ImportJobCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ImportJobCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public ImportJobCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ImportJobCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ImportJobCreateEvent description(@Nullable String description) {
  ...
  public ImportJobCreateEvent priority(@Nullable String priority) {
  ...
  public ImportJobCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ImportJobCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ImportJobCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ImportJobCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ImportJobCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ImportJobCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ImportJobCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ImportJobCreateEvent eventId(@Nullable String eventId) {
  ...
  public ImportJobCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ImportJobCreateEvent eventType(@Nullable String eventType) {
  ...
  public ImportJobCreateEvent event(@Nullable ImportJobCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ImportJobCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ImportJobCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportJobCreateEvent importJobCreateEvent = (ImportJobCreateEvent) o;
    return Objects.equals(this.atType, importJobCreateEvent.atType) &&
        Objects.equals(this.atBaseType, importJobCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, importJobCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, importJobCreateEvent.href) &&
        Objects.equals(this.id, importJobCreateEvent.id) &&
        Objects.equals(this.correlationId, importJobCreateEvent.correlationId) &&
        Objects.equals(this.domain, importJobCreateEvent.domain) &&
        Objects.equals(this.title, importJobCreateEvent.title) &&
        Objects.equals(this.description, importJobCreateEvent.description) &&
        Objects.equals(this.priority, importJobCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, importJobCreateEvent.timeOccurred) &&
        Objects.equals(this.source, importJobCreateEvent.source) &&
        Objects.equals(this.reportingSystem, importJobCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, importJobCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, importJobCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, importJobCreateEvent.eventId) &&
        Objects.equals(this.eventTime, importJobCreateEvent.eventTime) &&
        Objects.equals(this.eventType, importJobCreateEvent.eventType) &&
        Objects.equals(this.event, importJobCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportJobCreateEvent {\n");
