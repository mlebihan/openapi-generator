...
import org.openapitools.model.ExportJobCreateEventPayload;
...
public class ExportJobCreateEvent {
  ...
  private @Nullable ExportJobCreateEventPayload event;

  public ExportJobCreateEvent() {
    super();
  }
   ...
   */
  public ExportJobCreateEvent(String atType) {
    this.atType = atType;
  }

  public ExportJobCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ExportJobCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ExportJobCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ExportJobCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ExportJobCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ExportJobCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public ExportJobCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ExportJobCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ExportJobCreateEvent description(@Nullable String description) {
  ...
  public ExportJobCreateEvent priority(@Nullable String priority) {
  ...
  public ExportJobCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ExportJobCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ExportJobCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ExportJobCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ExportJobCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ExportJobCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ExportJobCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ExportJobCreateEvent eventId(@Nullable String eventId) {
  ...
  public ExportJobCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ExportJobCreateEvent eventType(@Nullable String eventType) {
  ...
  public ExportJobCreateEvent event(@Nullable ExportJobCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ExportJobCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ExportJobCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportJobCreateEvent exportJobCreateEvent = (ExportJobCreateEvent) o;
    return Objects.equals(this.atType, exportJobCreateEvent.atType) &&
        Objects.equals(this.atBaseType, exportJobCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, exportJobCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, exportJobCreateEvent.href) &&
        Objects.equals(this.id, exportJobCreateEvent.id) &&
        Objects.equals(this.correlationId, exportJobCreateEvent.correlationId) &&
        Objects.equals(this.domain, exportJobCreateEvent.domain) &&
        Objects.equals(this.title, exportJobCreateEvent.title) &&
        Objects.equals(this.description, exportJobCreateEvent.description) &&
        Objects.equals(this.priority, exportJobCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, exportJobCreateEvent.timeOccurred) &&
        Objects.equals(this.source, exportJobCreateEvent.source) &&
        Objects.equals(this.reportingSystem, exportJobCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, exportJobCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, exportJobCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, exportJobCreateEvent.eventId) &&
        Objects.equals(this.eventTime, exportJobCreateEvent.eventTime) &&
        Objects.equals(this.eventType, exportJobCreateEvent.eventType) &&
        Objects.equals(this.event, exportJobCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportJobCreateEvent {\n");
