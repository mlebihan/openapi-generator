...
public class CharacteristicRelationshipFVO {
  ...
  public CharacteristicRelationshipFVO atBaseType(@Nullable String atBaseType) {
  ...
  public CharacteristicRelationshipFVO atSchemaLocation(@Nullable String atSchemaLocation) {
