...
/**
 * ResourceCandidateCreateEventPayload generic structure
 */

@Schema(name = "ResourceCandidateCreateEventPayload", description = "ResourceCandidateCreateEventPayload generic structure")
...
public class ResourceCandidateCreateEventPayload {

  private @Nullable ResourceCandidate resourceCandidate;

  public ResourceCandidateCreateEventPayload resourceCandidate(@Nullable ResourceCandidate resourceCandidate) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceCandidateCreateEventPayload resourceCandidateCreateEventPayload = (ResourceCandidateCreateEventPayload) o;
    return Objects.equals(this.resourceCandidate, resourceCandidateCreateEventPayload.resourceCandidate);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceCandidateCreateEventPayload {\n");
