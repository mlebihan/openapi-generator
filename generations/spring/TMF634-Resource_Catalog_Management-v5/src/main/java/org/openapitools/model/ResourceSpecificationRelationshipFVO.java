...
public class ResourceSpecificationRelationshipFVO {
  ...
  @Valid
  private List<CharacteristicSpecificationFVO> characteristic = new ArrayList<>();

  private @Nullable TimePeriod validFor;

  public ResourceSpecificationRelationshipFVO() {
    super();
  }
   ...
   */
  public ResourceSpecificationRelationshipFVO(String atType) {
    this.atType = atType;
  }

  public ResourceSpecificationRelationshipFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ResourceSpecificationRelationshipFVO atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceSpecificationRelationshipFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceSpecificationRelationshipFVO relationshipType(@Nullable String relationshipType) {
  ...
  public ResourceSpecificationRelationshipFVO role(@Nullable String role) {
    this.role = role;
    return this;
  }
  ...
  public ResourceSpecificationRelationshipFVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ResourceSpecificationRelationshipFVO href(@Nullable URI href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceSpecificationRelationshipFVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ResourceSpecificationRelationshipFVO defaultQuantity(@Nullable Integer defaultQuantity) {
  ...
  public ResourceSpecificationRelationshipFVO maximumQuantity(@Nullable Integer maximumQuantity) {
  ...
  public ResourceSpecificationRelationshipFVO minimumQuantity(@Nullable Integer minimumQuantity) {
  ...
  public ResourceSpecificationRelationshipFVO characteristic(List<CharacteristicSpecificationFVO> characteristic) {
    this.characteristic = characteristic;
    return this;
  }

  public ResourceSpecificationRelationshipFVO addCharacteristicItem(CharacteristicSpecificationFVO characteristicItem) {
  ...
  public ResourceSpecificationRelationshipFVO validFor(@Nullable TimePeriod validFor) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceSpecificationRelationshipFVO resourceSpecificationRelationshipFVO = (ResourceSpecificationRelationshipFVO) o;
    return Objects.equals(this.atType, resourceSpecificationRelationshipFVO.atType) &&
        Objects.equals(this.atBaseType, resourceSpecificationRelationshipFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceSpecificationRelationshipFVO.atSchemaLocation) &&
        Objects.equals(this.relationshipType, resourceSpecificationRelationshipFVO.relationshipType) &&
        Objects.equals(this.role, resourceSpecificationRelationshipFVO.role) &&
        Objects.equals(this.id, resourceSpecificationRelationshipFVO.id) &&
        Objects.equals(this.href, resourceSpecificationRelationshipFVO.href) &&
        Objects.equals(this.name, resourceSpecificationRelationshipFVO.name) &&
        Objects.equals(this.defaultQuantity, resourceSpecificationRelationshipFVO.defaultQuantity) &&
        Objects.equals(this.maximumQuantity, resourceSpecificationRelationshipFVO.maximumQuantity) &&
        Objects.equals(this.minimumQuantity, resourceSpecificationRelationshipFVO.minimumQuantity) &&
        Objects.equals(this.characteristic, resourceSpecificationRelationshipFVO.characteristic) &&
        Objects.equals(this.validFor, resourceSpecificationRelationshipFVO.validFor);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceSpecificationRelationshipFVO {\n");
