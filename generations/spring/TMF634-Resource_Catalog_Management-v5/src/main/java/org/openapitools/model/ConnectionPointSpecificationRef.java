...
public class ConnectionPointSpecificationRef {
   ...
   */
  public ConnectionPointSpecificationRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }
  ...
  public ConnectionPointSpecificationRef atBaseType(@Nullable String atBaseType) {
  ...
  public ConnectionPointSpecificationRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ConnectionPointSpecificationRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ConnectionPointSpecificationRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ConnectionPointSpecificationRef atReferredType(@Nullable String atReferredType) {
  ...
  public ConnectionPointSpecificationRef version(@Nullable String version) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, connectionPointSpecificationRef.atType) &&
        ...
        Objects.equals(this.id, connectionPointSpecificationRef.id) &&
