...
@Schema(name = "ImportJobStateChangeEventPayload", description = "ImportJobStateChangeEventPayload generic structure")
...
public class ImportJobStateChangeEventPayload {
  ...
  public ImportJobStateChangeEventPayload importJob(@Nullable ImportJob importJob) {
