...
import org.openapitools.model.CharacteristicSpecificationRelationshipMVO;
...
public class CharacteristicSpecificationMVO {
  ...
  @Valid
  private List<CharacteristicSpecificationRelationshipMVO> charSpecRelationship = new ArrayList<>();

  @Valid
  private List<CharacteristicValueSpecificationMVO> characteristicValueSpecification = new ArrayList<>();

  public CharacteristicSpecificationMVO() {
    super();
  }
   ...
   */
  public CharacteristicSpecificationMVO(String atType, String name, String valueType) {
    this.atType = atType;
    this.name = name;
  ...
  public CharacteristicSpecificationMVO atBaseType(@Nullable String atBaseType) {
  ...
  public CharacteristicSpecificationMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CharacteristicSpecificationMVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CharacteristicSpecificationMVO description(@Nullable String description) {
  ...
  public CharacteristicSpecificationMVO configurable(@Nullable Boolean configurable) {
  ...
  public CharacteristicSpecificationMVO validFor(@Nullable TimePeriod validFor) {
  ...
  public CharacteristicSpecificationMVO minCardinality(@Nullable Integer minCardinality) {
  ...
  public CharacteristicSpecificationMVO maxCardinality(@Nullable Integer maxCardinality) {
  ...
  public CharacteristicSpecificationMVO isUnique(@Nullable Boolean isUnique) {
  ...
  public CharacteristicSpecificationMVO regex(@Nullable String regex) {
    this.regex = regex;
    return this;
  }
  ...
  public CharacteristicSpecificationMVO extensible(@Nullable Boolean extensible) {
  ...
  public CharacteristicSpecificationMVO atValueSchemaLocation(@Nullable String atValueSchemaLocation) {
