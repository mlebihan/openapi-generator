...
@Schema(name = "ResourceGraphSpecificationRef", description = "Resource graph specification reference.")
...
public class ResourceGraphSpecificationRef {
  ...
  public ResourceGraphSpecificationRef() {
    super();
  }
   ...
   */
  public ResourceGraphSpecificationRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }

  public ResourceGraphSpecificationRef atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ResourceGraphSpecificationRef atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceGraphSpecificationRef atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceGraphSpecificationRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceGraphSpecificationRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ResourceGraphSpecificationRef atReferredType(@Nullable String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, resourceGraphSpecificationRef.atType) &&
        Objects.equals(this.atBaseType, resourceGraphSpecificationRef.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceGraphSpecificationRef.atSchemaLocation) &&
        Objects.equals(this.href, resourceGraphSpecificationRef.href) &&
        Objects.equals(this.id, resourceGraphSpecificationRef.id) &&
        Objects.equals(this.name, resourceGraphSpecificationRef.name) &&
        Objects.equals(this.atReferredType, resourceGraphSpecificationRef.atReferredType);
  }
