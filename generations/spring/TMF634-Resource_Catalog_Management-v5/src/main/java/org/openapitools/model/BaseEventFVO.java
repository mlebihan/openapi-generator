...
public class BaseEventFVO {
   ...
   */
  public BaseEventFVO(String atType) {
    this.atType = atType;
  }

  public BaseEventFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public BaseEventFVO atBaseType(@Nullable String atBaseType) {
  ...
  public BaseEventFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public BaseEventFVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public BaseEventFVO event(@Nullable Object event) {
    this.event = event;
    return this;
  }
  ...
  public BaseEventFVO eventId(@Nullable String eventId) {
  ...
  public BaseEventFVO eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public BaseEventFVO eventType(@Nullable String eventType) {
  ...
  public BaseEventFVO correlationId(@Nullable String correlationId) {
  ...
  public BaseEventFVO domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public BaseEventFVO title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public BaseEventFVO description(@Nullable String description) {
  ...
  public BaseEventFVO priority(@Nullable String priority) {
  ...
  public BaseEventFVO timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public boolean equals(Object o) {
    ...
    BaseEventFVO baseEventFVO = (BaseEventFVO) o;
    return Objects.equals(this.atType, baseEventFVO.atType) &&
        Objects.equals(this.atBaseType, baseEventFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, baseEventFVO.atSchemaLocation) &&
        Objects.equals(this.id, baseEventFVO.id) &&
        Objects.equals(this.event, baseEventFVO.event) &&
        Objects.equals(this.eventId, baseEventFVO.eventId) &&
        Objects.equals(this.eventTime, baseEventFVO.eventTime) &&
        Objects.equals(this.eventType, baseEventFVO.eventType) &&
        Objects.equals(this.correlationId, baseEventFVO.correlationId) &&
        Objects.equals(this.domain, baseEventFVO.domain) &&
        Objects.equals(this.title, baseEventFVO.title) &&
        Objects.equals(this.description, baseEventFVO.description) &&
        Objects.equals(this.priority, baseEventFVO.priority) &&
        Objects.equals(this.timeOcurred, baseEventFVO.timeOcurred);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, id, event, eventId, eventTime, eventType, correlationId, domain, title, description, priority, timeOcurred);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BaseEventFVO {\n");
