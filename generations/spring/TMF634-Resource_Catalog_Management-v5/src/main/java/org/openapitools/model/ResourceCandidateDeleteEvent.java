...
import org.openapitools.model.ResourceCandidateDeleteEventPayload;
...
public class ResourceCandidateDeleteEvent {
  ...
  private @Nullable ResourceCandidateDeleteEventPayload event;

  public ResourceCandidateDeleteEvent() {
    super();
  }
   ...
   */
  public ResourceCandidateDeleteEvent(String atType) {
    this.atType = atType;
  }

  public ResourceCandidateDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ResourceCandidateDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceCandidateDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceCandidateDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceCandidateDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ResourceCandidateDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public ResourceCandidateDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ResourceCandidateDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ResourceCandidateDeleteEvent description(@Nullable String description) {
  ...
  public ResourceCandidateDeleteEvent priority(@Nullable String priority) {
  ...
  public ResourceCandidateDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ResourceCandidateDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ResourceCandidateDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ResourceCandidateDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ResourceCandidateDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ResourceCandidateDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ResourceCandidateDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ResourceCandidateDeleteEvent eventId(@Nullable String eventId) {
  ...
  public ResourceCandidateDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ResourceCandidateDeleteEvent eventType(@Nullable String eventType) {
  ...
  public ResourceCandidateDeleteEvent event(@Nullable ResourceCandidateDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ResourceCandidateDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ResourceCandidateDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, resourceCandidateDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, resourceCandidateDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceCandidateDeleteEvent.atSchemaLocation) &&
        Objects.equals(this.href, resourceCandidateDeleteEvent.href) &&
        Objects.equals(this.id, resourceCandidateDeleteEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, resourceCandidateDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, resourceCandidateDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, resourceCandidateDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, resourceCandidateDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, resourceCandidateDeleteEvent.analyticCharacteristic) &&
