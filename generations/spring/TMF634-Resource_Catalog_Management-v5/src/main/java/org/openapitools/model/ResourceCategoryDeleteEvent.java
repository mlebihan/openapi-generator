...
import org.openapitools.model.ResourceCategoryDeleteEventPayload;
...
public class ResourceCategoryDeleteEvent {
  ...
  private @Nullable ResourceCategoryDeleteEventPayload event;

  public ResourceCategoryDeleteEvent() {
    super();
  }
   ...
   */
  public ResourceCategoryDeleteEvent(String atType) {
    this.atType = atType;
  }

  public ResourceCategoryDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ResourceCategoryDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceCategoryDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceCategoryDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceCategoryDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ResourceCategoryDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public ResourceCategoryDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ResourceCategoryDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ResourceCategoryDeleteEvent description(@Nullable String description) {
  ...
  public ResourceCategoryDeleteEvent priority(@Nullable String priority) {
  ...
  public ResourceCategoryDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ResourceCategoryDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ResourceCategoryDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ResourceCategoryDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ResourceCategoryDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ResourceCategoryDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ResourceCategoryDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ResourceCategoryDeleteEvent eventId(@Nullable String eventId) {
  ...
  public ResourceCategoryDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ResourceCategoryDeleteEvent eventType(@Nullable String eventType) {
  ...
  public ResourceCategoryDeleteEvent event(@Nullable ResourceCategoryDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ResourceCategoryDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ResourceCategoryDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResourceCategoryDeleteEvent resourceCategoryDeleteEvent = (ResourceCategoryDeleteEvent) o;
    return Objects.equals(this.atType, resourceCategoryDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, resourceCategoryDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceCategoryDeleteEvent.atSchemaLocation) &&
        Objects.equals(this.href, resourceCategoryDeleteEvent.href) &&
        Objects.equals(this.id, resourceCategoryDeleteEvent.id) &&
        Objects.equals(this.correlationId, resourceCategoryDeleteEvent.correlationId) &&
        Objects.equals(this.domain, resourceCategoryDeleteEvent.domain) &&
        Objects.equals(this.title, resourceCategoryDeleteEvent.title) &&
        Objects.equals(this.description, resourceCategoryDeleteEvent.description) &&
        Objects.equals(this.priority, resourceCategoryDeleteEvent.priority) &&
        Objects.equals(this.timeOccurred, resourceCategoryDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, resourceCategoryDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, resourceCategoryDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, resourceCategoryDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, resourceCategoryDeleteEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, resourceCategoryDeleteEvent.eventId) &&
        Objects.equals(this.eventTime, resourceCategoryDeleteEvent.eventTime) &&
        Objects.equals(this.eventType, resourceCategoryDeleteEvent.eventType) &&
        Objects.equals(this.event, resourceCategoryDeleteEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceCategoryDeleteEvent {\n");
