...
import org.openapitools.model.ResourceCatalogDeleteEventPayload;
...
public class ResourceCatalogDeleteEvent {
  ...
  private @Nullable ResourceCatalogDeleteEventPayload event;

  public ResourceCatalogDeleteEvent() {
    super();
  }
   ...
   */
  public ResourceCatalogDeleteEvent(String atType) {
    this.atType = atType;
  }

  public ResourceCatalogDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ResourceCatalogDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceCatalogDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceCatalogDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceCatalogDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ResourceCatalogDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public ResourceCatalogDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ResourceCatalogDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ResourceCatalogDeleteEvent description(@Nullable String description) {
  ...
  public ResourceCatalogDeleteEvent priority(@Nullable String priority) {
  ...
  public ResourceCatalogDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ResourceCatalogDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ResourceCatalogDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ResourceCatalogDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ResourceCatalogDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ResourceCatalogDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ResourceCatalogDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ResourceCatalogDeleteEvent eventId(@Nullable String eventId) {
  ...
  public ResourceCatalogDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ResourceCatalogDeleteEvent eventType(@Nullable String eventType) {
  ...
  public ResourceCatalogDeleteEvent event(@Nullable ResourceCatalogDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ResourceCatalogDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ResourceCatalogDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResourceCatalogDeleteEvent resourceCatalogDeleteEvent = (ResourceCatalogDeleteEvent) o;
    return Objects.equals(this.atType, resourceCatalogDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, resourceCatalogDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceCatalogDeleteEvent.atSchemaLocation) &&
        Objects.equals(this.href, resourceCatalogDeleteEvent.href) &&
        Objects.equals(this.id, resourceCatalogDeleteEvent.id) &&
        Objects.equals(this.correlationId, resourceCatalogDeleteEvent.correlationId) &&
        Objects.equals(this.domain, resourceCatalogDeleteEvent.domain) &&
        Objects.equals(this.title, resourceCatalogDeleteEvent.title) &&
        Objects.equals(this.description, resourceCatalogDeleteEvent.description) &&
        Objects.equals(this.priority, resourceCatalogDeleteEvent.priority) &&
        Objects.equals(this.timeOccurred, resourceCatalogDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, resourceCatalogDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, resourceCatalogDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, resourceCatalogDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, resourceCatalogDeleteEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, resourceCatalogDeleteEvent.eventId) &&
        Objects.equals(this.eventTime, resourceCatalogDeleteEvent.eventTime) &&
        Objects.equals(this.eventType, resourceCatalogDeleteEvent.eventType) &&
        Objects.equals(this.event, resourceCatalogDeleteEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceCatalogDeleteEvent {\n");
