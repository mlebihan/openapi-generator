...
public class CharacteristicValueSpecificationMVO {
  ...
  public CharacteristicValueSpecificationMVO() {
    super();
  }
   ...
   */
  public CharacteristicValueSpecificationMVO(String atType) {
    this.atType = atType;
  }

  public CharacteristicValueSpecificationMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public CharacteristicValueSpecificationMVO atBaseType(@Nullable String atBaseType) {
  ...
  public CharacteristicValueSpecificationMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public CharacteristicValueSpecificationMVO valueType(@Nullable String valueType) {
  ...
  public CharacteristicValueSpecificationMVO isDefault(@Nullable Boolean isDefault) {
  ...
  public CharacteristicValueSpecificationMVO unitOfMeasure(@Nullable String unitOfMeasure) {
  ...
  public CharacteristicValueSpecificationMVO validFor(@Nullable TimePeriod validFor) {
  ...
  public CharacteristicValueSpecificationMVO valueFrom(@Nullable Integer valueFrom) {
  ...
  public CharacteristicValueSpecificationMVO valueTo(@Nullable Integer valueTo) {
  ...
  public CharacteristicValueSpecificationMVO rangeInterval(@Nullable String rangeInterval) {
  ...
  public CharacteristicValueSpecificationMVO regex(@Nullable String regex) {
    this.regex = regex;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CharacteristicValueSpecificationMVO characteristicValueSpecificationMVO = (CharacteristicValueSpecificationMVO) o;
    return Objects.equals(this.atType, characteristicValueSpecificationMVO.atType) &&
        Objects.equals(this.atBaseType, characteristicValueSpecificationMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, characteristicValueSpecificationMVO.atSchemaLocation) &&
        Objects.equals(this.valueType, characteristicValueSpecificationMVO.valueType) &&
        Objects.equals(this.isDefault, characteristicValueSpecificationMVO.isDefault) &&
        Objects.equals(this.unitOfMeasure, characteristicValueSpecificationMVO.unitOfMeasure) &&
        Objects.equals(this.validFor, characteristicValueSpecificationMVO.validFor) &&
        Objects.equals(this.valueFrom, characteristicValueSpecificationMVO.valueFrom) &&
        Objects.equals(this.valueTo, characteristicValueSpecificationMVO.valueTo) &&
        Objects.equals(this.rangeInterval, characteristicValueSpecificationMVO.rangeInterval) &&
        Objects.equals(this.regex, characteristicValueSpecificationMVO.regex);
  }
  ...
  public String toString() {
    ...
    sb.append("class CharacteristicValueSpecificationMVO {\n");
