...
public class PartyRoleRefFVO implements PartyRefOrPartyRoleRefFVO {
   ...
   */
  public PartyRoleRefFVO(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }
  ...
  public PartyRoleRefFVO atBaseType(@Nullable String atBaseType) {
  ...
  public PartyRoleRefFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public PartyRoleRefFVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PartyRoleRefFVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PartyRoleRefFVO atReferredType(@Nullable String atReferredType) {
  ...
  public PartyRoleRefFVO partyId(@Nullable String partyId) {
  ...
  public PartyRoleRefFVO partyName(@Nullable String partyName) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, id, href, name, atReferredType, partyId, partyName);
  }
