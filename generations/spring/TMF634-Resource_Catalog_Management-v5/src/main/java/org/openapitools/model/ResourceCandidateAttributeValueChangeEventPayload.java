...
@Schema(name = "ResourceCandidateAttributeValueChangeEventPayload", description = "ResourceCandidateAttributeValueChangeEventPayload generic structure")
...
public class ResourceCandidateAttributeValueChangeEventPayload {
  ...
  public ResourceCandidateAttributeValueChangeEventPayload resourceCandidate(@Nullable ResourceCandidate resourceCandidate) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceCandidateAttributeValueChangeEventPayload resourceCandidateAttributeValueChangeEventPayload = (ResourceCandidateAttributeValueChangeEventPayload) o;
    return Objects.equals(this.resourceCandidate, resourceCandidateAttributeValueChangeEventPayload.resourceCandidate);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceCandidateAttributeValueChangeEventPayload {\n");
