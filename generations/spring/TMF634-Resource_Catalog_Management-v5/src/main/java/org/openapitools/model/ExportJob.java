...
public class ExportJob implements InlineObject1 {
   ...
   */
  public ExportJob(String atType) {
    this.atType = atType;
  }
  ...
  public ExportJob atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ExportJob url(@Nullable URI url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, exportJob.atType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, href, id, completionDate, contentType, creationDate, errorLog, path, query, status, url);
  }
