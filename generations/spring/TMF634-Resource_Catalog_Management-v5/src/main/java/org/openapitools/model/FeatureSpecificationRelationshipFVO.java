...
public class FeatureSpecificationRelationshipFVO {
  ...
  public FeatureSpecificationRelationshipFVO() {
    super();
  }
   ...
   */
  public FeatureSpecificationRelationshipFVO(String atType, RelationshipTypeEnum relationshipType, String name) {
    this.atType = atType;
    this.relationshipType = relationshipType;
    this.name = name;
  }

  public FeatureSpecificationRelationshipFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public FeatureSpecificationRelationshipFVO atBaseType(@Nullable String atBaseType) {
  ...
  public FeatureSpecificationRelationshipFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public FeatureSpecificationRelationshipFVO relationshipType(RelationshipTypeEnum relationshipType) {
    this.relationshipType = relationshipType;
    return this;
  }
  ...
  public FeatureSpecificationRelationshipFVO featureId(@Nullable String featureId) {
  ...
  public FeatureSpecificationRelationshipFVO parentSpecificationId(@Nullable String parentSpecificationId) {
  ...
  public FeatureSpecificationRelationshipFVO parentSpecificationHref(@Nullable URI parentSpecificationHref) {
  ...
  public FeatureSpecificationRelationshipFVO name(String name) {
    this.name = name;
    return this;
  }
  ...
  public FeatureSpecificationRelationshipFVO validFor(@Nullable TimePeriod validFor) {
  ...
  public boolean equals(Object o) {
    ...
    FeatureSpecificationRelationshipFVO featureSpecificationRelationshipFVO = (FeatureSpecificationRelationshipFVO) o;
    return Objects.equals(this.atType, featureSpecificationRelationshipFVO.atType) &&
        Objects.equals(this.atBaseType, featureSpecificationRelationshipFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, featureSpecificationRelationshipFVO.atSchemaLocation) &&
        Objects.equals(this.relationshipType, featureSpecificationRelationshipFVO.relationshipType) &&
        Objects.equals(this.featureId, featureSpecificationRelationshipFVO.featureId) &&
        Objects.equals(this.parentSpecificationId, featureSpecificationRelationshipFVO.parentSpecificationId) &&
        Objects.equals(this.parentSpecificationHref, featureSpecificationRelationshipFVO.parentSpecificationHref) &&
        Objects.equals(this.name, featureSpecificationRelationshipFVO.name) &&
        Objects.equals(this.validFor, featureSpecificationRelationshipFVO.validFor);
  }
  ...
  public String toString() {
    ...
    sb.append("class FeatureSpecificationRelationshipFVO {\n");
