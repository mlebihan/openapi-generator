...
import org.openapitools.model.ResourceCandidateCreateEventPayload;
...
public class ResourceCandidateCreateEvent {
  ...
  private @Nullable ResourceCandidateCreateEventPayload event;

  public ResourceCandidateCreateEvent() {
    super();
  }
   ...
   */
  public ResourceCandidateCreateEvent(String atType) {
    this.atType = atType;
  }

  public ResourceCandidateCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ResourceCandidateCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceCandidateCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceCandidateCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceCandidateCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ResourceCandidateCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public ResourceCandidateCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ResourceCandidateCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ResourceCandidateCreateEvent description(@Nullable String description) {
  ...
  public ResourceCandidateCreateEvent priority(@Nullable String priority) {
  ...
  public ResourceCandidateCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ResourceCandidateCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ResourceCandidateCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ResourceCandidateCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ResourceCandidateCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ResourceCandidateCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ResourceCandidateCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ResourceCandidateCreateEvent eventId(@Nullable String eventId) {
  ...
  public ResourceCandidateCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ResourceCandidateCreateEvent eventType(@Nullable String eventType) {
  ...
  public ResourceCandidateCreateEvent event(@Nullable ResourceCandidateCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ResourceCandidateCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ResourceCandidateCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, resourceCandidateCreateEvent.atType) &&
        Objects.equals(this.atBaseType, resourceCandidateCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceCandidateCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, resourceCandidateCreateEvent.href) &&
        Objects.equals(this.id, resourceCandidateCreateEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, resourceCandidateCreateEvent.timeOccurred) &&
        Objects.equals(this.source, resourceCandidateCreateEvent.source) &&
        Objects.equals(this.reportingSystem, resourceCandidateCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, resourceCandidateCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, resourceCandidateCreateEvent.analyticCharacteristic) &&
        ...
        Objects.equals(this.event, resourceCandidateCreateEvent.event);
  }
