...
public class AttachmentRefFVO implements AttachmentRefOrValueFVO {
   ...
   */
  public AttachmentRefFVO(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }

  public AttachmentRefFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public AttachmentRefFVO atBaseType(@Nullable String atBaseType) {
  ...
  public AttachmentRefFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public AttachmentRefFVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public AttachmentRefFVO name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AttachmentRefFVO atReferredType(@Nullable String atReferredType) {
  ...
  public AttachmentRefFVO description(@Nullable String description) {
  ...
  public AttachmentRefFVO url(@Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, attachmentRefFVO.atType) &&
        Objects.equals(this.atBaseType, attachmentRefFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, attachmentRefFVO.atSchemaLocation) &&
        ...
        Objects.equals(this.atReferredType, attachmentRefFVO.atReferredType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, id, href, name, atReferredType, description, url);
  }
