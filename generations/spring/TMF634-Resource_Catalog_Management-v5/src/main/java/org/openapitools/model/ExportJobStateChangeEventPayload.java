...
@Schema(name = "ExportJobStateChangeEventPayload", description = "ExportJobStateChangeEventPayload generic structure")
...
public class ExportJobStateChangeEventPayload {
  ...
  public ExportJobStateChangeEventPayload exportJob(@Nullable ExportJob exportJob) {
