...
import org.openapitools.model.ExportJobDeleteEventPayload;
...
public class ExportJobDeleteEvent {
  ...
  private @Nullable ExportJobDeleteEventPayload event;

  public ExportJobDeleteEvent() {
    super();
  }
   ...
   */
  public ExportJobDeleteEvent(String atType) {
    this.atType = atType;
  }

  public ExportJobDeleteEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ExportJobDeleteEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ExportJobDeleteEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ExportJobDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ExportJobDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ExportJobDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public ExportJobDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ExportJobDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ExportJobDeleteEvent description(@Nullable String description) {
  ...
  public ExportJobDeleteEvent priority(@Nullable String priority) {
  ...
  public ExportJobDeleteEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ExportJobDeleteEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ExportJobDeleteEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ExportJobDeleteEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ExportJobDeleteEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ExportJobDeleteEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ExportJobDeleteEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ExportJobDeleteEvent eventId(@Nullable String eventId) {
  ...
  public ExportJobDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ExportJobDeleteEvent eventType(@Nullable String eventType) {
  ...
  public ExportJobDeleteEvent event(@Nullable ExportJobDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ExportJobDeleteEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ExportJobDeleteEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportJobDeleteEvent exportJobDeleteEvent = (ExportJobDeleteEvent) o;
    return Objects.equals(this.atType, exportJobDeleteEvent.atType) &&
        Objects.equals(this.atBaseType, exportJobDeleteEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, exportJobDeleteEvent.atSchemaLocation) &&
        Objects.equals(this.href, exportJobDeleteEvent.href) &&
        Objects.equals(this.id, exportJobDeleteEvent.id) &&
        Objects.equals(this.correlationId, exportJobDeleteEvent.correlationId) &&
        Objects.equals(this.domain, exportJobDeleteEvent.domain) &&
        Objects.equals(this.title, exportJobDeleteEvent.title) &&
        Objects.equals(this.description, exportJobDeleteEvent.description) &&
        Objects.equals(this.priority, exportJobDeleteEvent.priority) &&
        Objects.equals(this.timeOccurred, exportJobDeleteEvent.timeOccurred) &&
        Objects.equals(this.source, exportJobDeleteEvent.source) &&
        Objects.equals(this.reportingSystem, exportJobDeleteEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, exportJobDeleteEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, exportJobDeleteEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, exportJobDeleteEvent.eventId) &&
        Objects.equals(this.eventTime, exportJobDeleteEvent.eventTime) &&
        Objects.equals(this.eventType, exportJobDeleteEvent.eventType) &&
        Objects.equals(this.event, exportJobDeleteEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportJobDeleteEvent {\n");
