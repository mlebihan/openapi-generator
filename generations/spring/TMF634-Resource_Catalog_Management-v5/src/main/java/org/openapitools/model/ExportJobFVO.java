...
public class ExportJobFVO {
   ...
   */
  public ExportJobFVO(String atType, URI url) {
    this.atType = atType;
    this.url = url;
  }

  public ExportJobFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ExportJobFVO atBaseType(@Nullable String atBaseType) {
  ...
  public ExportJobFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ExportJobFVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ExportJobFVO completionDate(@Nullable OffsetDateTime completionDate) {
  ...
  public ExportJobFVO contentType(@Nullable String contentType) {
  ...
  public ExportJobFVO creationDate(@Nullable OffsetDateTime creationDate) {
  ...
  public ExportJobFVO errorLog(@Nullable String errorLog) {
  ...
  public ExportJobFVO path(@Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public ExportJobFVO query(@Nullable String query) {
    this.query = query;
    return this;
  }
  ...
  public ExportJobFVO status(@Nullable JobStateType status) {
    this.status = status;
    return this;
  }
  ...
  public ExportJobFVO url(URI url) {
    this.url = url;
    return this;
  }
   ...
   */
  @NotNull @Valid 
  @Schema(name = "url", description = "URL of the file containing the data to be exported", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("url")
  public URI getUrl() {
    return url;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportJobFVO exportJobFVO = (ExportJobFVO) o;
    return Objects.equals(this.atType, exportJobFVO.atType) &&
        Objects.equals(this.atBaseType, exportJobFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, exportJobFVO.atSchemaLocation) &&
        Objects.equals(this.id, exportJobFVO.id) &&
        Objects.equals(this.completionDate, exportJobFVO.completionDate) &&
        Objects.equals(this.contentType, exportJobFVO.contentType) &&
        Objects.equals(this.creationDate, exportJobFVO.creationDate) &&
        Objects.equals(this.errorLog, exportJobFVO.errorLog) &&
        Objects.equals(this.path, exportJobFVO.path) &&
        Objects.equals(this.query, exportJobFVO.query) &&
        Objects.equals(this.status, exportJobFVO.status) &&
        Objects.equals(this.url, exportJobFVO.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, id, completionDate, contentType, creationDate, errorLog, path, query, status, url);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExportJobFVO {\n");
