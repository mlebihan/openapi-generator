...
import org.openapitools.model.ExportJobStateChangeEventPayload;
...
public class ExportJobStateChangeEvent {
  ...
  private @Nullable ExportJobStateChangeEventPayload event;

  public ExportJobStateChangeEvent() {
    super();
  }
   ...
   */
  public ExportJobStateChangeEvent(String atType) {
    this.atType = atType;
  }

  public ExportJobStateChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ExportJobStateChangeEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ExportJobStateChangeEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ExportJobStateChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ExportJobStateChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ExportJobStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public ExportJobStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ExportJobStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ExportJobStateChangeEvent description(@Nullable String description) {
  ...
  public ExportJobStateChangeEvent priority(@Nullable String priority) {
  ...
  public ExportJobStateChangeEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ExportJobStateChangeEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ExportJobStateChangeEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ExportJobStateChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ExportJobStateChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ExportJobStateChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ExportJobStateChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ExportJobStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public ExportJobStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ExportJobStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public ExportJobStateChangeEvent event(@Nullable ExportJobStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ExportJobStateChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ExportJobStateChangeEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, exportJobStateChangeEvent.atType) &&
        Objects.equals(this.atBaseType, exportJobStateChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, exportJobStateChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, exportJobStateChangeEvent.href) &&
        Objects.equals(this.id, exportJobStateChangeEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, exportJobStateChangeEvent.timeOccurred) &&
        Objects.equals(this.source, exportJobStateChangeEvent.source) &&
        Objects.equals(this.reportingSystem, exportJobStateChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, exportJobStateChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, exportJobStateChangeEvent.analyticCharacteristic) &&
