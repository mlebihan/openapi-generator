...
public class Error {
  ...
  private @Nullable String referenceError;
  ...
  public Error atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public Error referenceError(@Nullable String referenceError) {
  ...
  public @Nullable String getReferenceError() {
    return referenceError;
  }

  public void setReferenceError(@Nullable String referenceError) {
    this.referenceError = referenceError;
  }
