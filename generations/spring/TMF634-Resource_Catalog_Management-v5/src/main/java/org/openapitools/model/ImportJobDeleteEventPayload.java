...
/**
 * ImportJobDeleteEventPayload generic structure
 */

@Schema(name = "ImportJobDeleteEventPayload", description = "ImportJobDeleteEventPayload generic structure")
...
public class ImportJobDeleteEventPayload {

  private @Nullable ImportJob importJob;

  public ImportJobDeleteEventPayload importJob(@Nullable ImportJob importJob) {
  ...
  public boolean equals(Object o) {
    ...
    ImportJobDeleteEventPayload importJobDeleteEventPayload = (ImportJobDeleteEventPayload) o;
    return Objects.equals(this.importJob, importJobDeleteEventPayload.importJob);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportJobDeleteEventPayload {\n");
