...
import org.openapitools.model.FeatureSpecificationRelationshipFVO;
...
public class FeatureSpecificationFVO {
  ...
  @Valid
  private List<FeatureSpecificationRelationshipFVO> featureSpecRelationship = new ArrayList<>();
  ...
  @Valid
  private List<CharacteristicSpecificationFVO> featureSpecCharacteristic = new ArrayList<>();

  private String name;

  public FeatureSpecificationFVO() {
    super();
  }
   ...
   */
  public FeatureSpecificationFVO(String atType, String name) {
    this.atType = atType;
    this.name = name;
  }
  ...
  public FeatureSpecificationFVO atBaseType(@Nullable String atBaseType) {
  ...
  public FeatureSpecificationFVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public FeatureSpecificationFVO version(@Nullable String version) {
  ...
  public FeatureSpecificationFVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public FeatureSpecificationFVO isBundle(@Nullable Boolean isBundle) {
  ...
  public FeatureSpecificationFVO validFor(@Nullable TimePeriod validFor) {
  ...
  public FeatureSpecificationFVO isEnabled(@Nullable Boolean isEnabled) {
