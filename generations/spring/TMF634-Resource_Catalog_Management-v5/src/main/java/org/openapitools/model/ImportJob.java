...
public class ImportJob implements InlineObject {
   ...
   */
  public ImportJob(String atType) {
    this.atType = atType;
  }
  ...
  public ImportJob atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ImportJob url(@Nullable URI url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, importJob.atType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, href, id, completionDate, contentType, creationDate, errorLog, path, status, url);
  }
