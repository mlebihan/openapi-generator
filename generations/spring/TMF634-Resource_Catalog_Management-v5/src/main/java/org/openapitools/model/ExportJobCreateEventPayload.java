...
@Schema(name = "ExportJobCreateEventPayload", description = "ExportJobCreateEventPayload generic structure")
...
public class ExportJobCreateEventPayload {

  private @Nullable ExportJob exportJob;

  public ExportJobCreateEventPayload exportJob(@Nullable ExportJob exportJob) {
  ...
  public boolean equals(Object o) {
    ...
    ExportJobCreateEventPayload exportJobCreateEventPayload = (ExportJobCreateEventPayload) o;
    return Objects.equals(this.exportJob, exportJobCreateEventPayload.exportJob);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportJobCreateEventPayload {\n");
