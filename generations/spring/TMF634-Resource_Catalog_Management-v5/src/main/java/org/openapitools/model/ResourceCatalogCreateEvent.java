...
import org.openapitools.model.ResourceCatalogCreateEventPayload;
...
public class ResourceCatalogCreateEvent {
  ...
  private @Nullable ResourceCatalogCreateEventPayload event;

  public ResourceCatalogCreateEvent() {
    super();
  }
   ...
   */
  public ResourceCatalogCreateEvent(String atType) {
    this.atType = atType;
  }

  public ResourceCatalogCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ResourceCatalogCreateEvent atBaseType(@Nullable String atBaseType) {
  ...
  public ResourceCatalogCreateEvent atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ResourceCatalogCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceCatalogCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ResourceCatalogCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public ResourceCatalogCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ResourceCatalogCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ResourceCatalogCreateEvent description(@Nullable String description) {
  ...
  public ResourceCatalogCreateEvent priority(@Nullable String priority) {
  ...
  public ResourceCatalogCreateEvent timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public ResourceCatalogCreateEvent source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ResourceCatalogCreateEvent reportingSystem(@Nullable EntityRef reportingSystem) {
  ...
  public ResourceCatalogCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ResourceCatalogCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ResourceCatalogCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ResourceCatalogCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ResourceCatalogCreateEvent eventId(@Nullable String eventId) {
  ...
  public ResourceCatalogCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ResourceCatalogCreateEvent eventType(@Nullable String eventType) {
  ...
  public ResourceCatalogCreateEvent event(@Nullable ResourceCatalogCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ResourceCatalogCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(@Nullable ResourceCatalogCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResourceCatalogCreateEvent resourceCatalogCreateEvent = (ResourceCatalogCreateEvent) o;
    return Objects.equals(this.atType, resourceCatalogCreateEvent.atType) &&
        Objects.equals(this.atBaseType, resourceCatalogCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceCatalogCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, resourceCatalogCreateEvent.href) &&
        Objects.equals(this.id, resourceCatalogCreateEvent.id) &&
        Objects.equals(this.correlationId, resourceCatalogCreateEvent.correlationId) &&
        Objects.equals(this.domain, resourceCatalogCreateEvent.domain) &&
        Objects.equals(this.title, resourceCatalogCreateEvent.title) &&
        Objects.equals(this.description, resourceCatalogCreateEvent.description) &&
        Objects.equals(this.priority, resourceCatalogCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, resourceCatalogCreateEvent.timeOccurred) &&
        Objects.equals(this.source, resourceCatalogCreateEvent.source) &&
        Objects.equals(this.reportingSystem, resourceCatalogCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, resourceCatalogCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, resourceCatalogCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, resourceCatalogCreateEvent.eventId) &&
        Objects.equals(this.eventTime, resourceCatalogCreateEvent.eventTime) &&
        Objects.equals(this.eventType, resourceCatalogCreateEvent.eventType) &&
        Objects.equals(this.event, resourceCatalogCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceCatalogCreateEvent {\n");
