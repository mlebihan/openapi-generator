...
public class EventMVO {
  ...
  public EventMVO atBaseType(@Nullable String atBaseType) {
  ...
  public EventMVO atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public EventMVO href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public EventMVO id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public EventMVO correlationId(@Nullable String correlationId) {
  ...
  public EventMVO domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public EventMVO title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public EventMVO description(@Nullable String description) {
  ...
  public EventMVO priority(@Nullable String priority) {
  ...
  public EventMVO timeOccurred(@Nullable OffsetDateTime timeOccurred) {
  ...
  public EventMVO source(@Nullable EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public EventMVO reportingSystem(@Nullable EntityRef reportingSystem) {
