...
public class TargetResourceSchema {
  ...
  public TargetResourceSchema atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  @Schema(name = "@type", description = "Class type of the target resource", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("@type")
  ...
  public TargetResourceSchema atSchemaLocation(@Nullable URI atSchemaLocation) {
   ...
   */
  @Valid 
  @Schema(name = "@schemaLocation", description = "This field provides a link to the schema describing the target resource", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, targetResourceSchema.atType) &&
        Objects.equals(this.atSchemaLocation, targetResourceSchema.atSchemaLocation);
  }
